...
var RadioGroupDescriptionBehavior = {
    ...
    items: function(items){ // string[]
        return this._propertyHandler("all items", items, HelperFuncs.stringJoin(";"), HelperFuncs.stringSplit(";"));
    },
    /**
     ...
     * @param {bool} [value] When provided, this method acts as a setter and sets the hasSelectedItem value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored hasSelectedItem value; 
     * otherwise it returns 'this' for use with the builder pattern.
     */
 ...
 * @mixes Web.RadioGroupTOBehavior
 */
function RadioGroupTO(session, description) {
    var radioGroupTO = new WebBase("WebRadioGroup", session, description);

    ObjUtils.extend(radioGroupTO, ClickBehavior);
    ObjUtils.extend(radioGroupTO, DragAndDropBehavior);
    ObjUtils.extend(radioGroupTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(radioGroupTO, RadioGroupTOBehavior);
...
var RadioGroupTOBehavior = {
    ...
    selectedIndex: function(){ // number
        return this._getROProperties(arguments, "checked", "selected item index").then(function(res) {
            var isChecked = res[0];
            var value = res[1];
            if(isChecked === 0)
                return -1;
     ...
     */
    selectedItem: function(){ // string
        return this._getROProperties(arguments, "checked", "value").then(function(res) {
            var isChecked = res[0];
            var value = res[1];
            if(isChecked === 0)
                return null;
    ...
    /**
     * Indicates whether a radio button is selected in the current group.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether a radio button is selected in the current group.
     */
    hasSelectedItem: function(){ // bool
        return this._getROProperty("checked", arguments).then(HelperFuncs.intToBool);
    },
     ...
     */
    select: function(value){ // string or number
...
// SIG // aucaMtlQQB4thEdYhc5b/qtv6MKl5h1Hc4reXzPijdyg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD2
// SIG // iHMMfpVbnWa3upTxo4op75HMgKr9De3dIK4F5MdTsjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBjcpAISkOIAMMahpHCCXXZ
// SIG // 9qvR4EnnBs2Dh+4m0gGlcM/tvWdwmOAy3wkwop3sxYv+
// SIG // dpfFTYDHkbKq3EtPHxUeAdMv4f9im8IzsY75PXGjOTws
// SIG // 02mp1B1K0H2GDMGpvSPM1rhJ3WlSEZ4zT4uyAtKUTdnE
// SIG // N+hLRgKYrvd4XL3tz5YPufT37iHe9gyh3RDkP+4Qhdx5
// SIG // WaoDcFjMvp0kJs3dW4bycQXbjVn4jlUIiIwUuB6RwGoH
// SIG // iwLOIKNoVTPizUqnvEkUHLumpE2U7x0gk6aGo0SCNb4t
// SIG // FLsZ4bhYV+hXcaVrFMEdkiw8n8k0WLmBT9epq2PaklmH
// SIG // Nz4MvojxPFaIoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjMyMlowIwYJKoZI
// SIG // hvcNAQkEMRYEFFDwFdpjkHxpnWS2CxswD8LPxhOSMA0G
// SIG // CSqGSIb3DQEBAQUABIIBACKcpEzBQM/8yKcBe/ROmIbf
// SIG // 3HtRqGQ1SO2ITBJOYd2hHG3QG56MRH38uDyhqPBG1F7u
// SIG // 18iE7ruLh9pEImTLoeN1fGVZFkoyBxfzrI+14MQ8zMVx
// SIG // +kLF+YuiWUd/971ruQn+6khQXoroLFuVDmh55fYCXpP9
// SIG // J0Yt7NV7Db8/QvNXPuylis/eZCcFbAdDMHbR5PelxS8I
// SIG // OBs9Ii6hrZueQO2ot0poa2Mknvqs/PNZ8miQQ+d4Tiuj
// SIG // EfpJFblssApVSjCd58adDwAh+DjZh9WxHBM1dXich5eY
// SIG // HlGXTZzROT8DYh+WiNLX4Zwg5qVJd0cF+gIHanMnQFP9
// SIG // fdFR51XU0dc=
