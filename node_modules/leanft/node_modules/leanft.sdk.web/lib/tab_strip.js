...
var TabStripDescriptionBehavior = {
     ...
     */
    tabs: function(tabs){
        return this._propertyHandler("all items", tabs, HelperFuncs.stringJoin(";"), HelperFuncs.stringSplit(";"));
    },
 ...
 * @mixes Web.TabStripTestObjectBehavior
 */
function TabStripTO(session, description) {

    var tabStripTO = new WebBase("WebTabStrip", session, description); // native class

    ObjUtils.extend(tabStripTO, ClickBehavior);
    ObjUtils.extend(tabStripTO, DragAndDropBehavior);
    ObjUtils.extend(tabStripTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(tabStripTO, TabStripTestObjectBehavior);
    return tabStripTO;
}
...
var TabStripTestObjectBehavior = {
    ...
    select: function(selectValue){
        ...
        return this._executeWithEvents(arguments, "Select", selectValue);
    }
};
...
// SIG // Z4qXJlmKnVjTOY0dvR5D6ruK1ATGzSFqyW71F5OA41+g
...
// SIG // KdTZYcP/N1KcxSVvrzz8wG3a3Jit3z+XaHBWST5MdjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQC18uy83zeXqBl5IGSMHucn
// SIG // vKc9EoiSust31wLcd0Dt9AaJjfCepEh3LhdX024IckRN
// SIG // nSBhGq6lRBaiR+IJH3Abi9GL6/1RR4dUzXcwyrzQjX6t
// SIG // N4m/fEr4no/FLEMPXy0v3t/tdH+XxZu4dmx/YlcPBVnI
// SIG // IzLYJ52VRbwiB8FLC5Wd+RtynziSn6lh1xkHhSqKd1HP
// SIG // 03a0SKnL4lnmTYcr5b0Su81vTA55Z2QzlJMmONTy4HjP
// SIG // 2KGxfJ5VA6MZ/orpv7aYdxVJffDUcAPhCNW9iZ5lEvGb
// SIG // q8YRA2EZEHDzQK7u1eKxI+t1j6eTV1Vw8Qf+NChJwfgy
// SIG // DRSks6IBLurdoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTQyMVowIwYJKoZI
// SIG // hvcNAQkEMRYEFF9hK2RMhVHJgRpm+hEiQZsjStL9MA0G
// SIG // CSqGSIb3DQEBAQUABIIBABvPVMfZCbduqDsrlUPXDt3I
// SIG // h0eyZeifoJtiqlkKTgkDp0CFfRPWlALotu20AnuebMZG
// SIG // 3gTe5VmX9e7e7Y3lM22LSsbhv0XwR1k/9lxleXPEqQqG
// SIG // xJAgde3u83QlxbizMtKXOeJ6gN0e7Pvn5oLWR0+qyyAX
// SIG // 3a7fmY9F0unaXtIVbuoXTumej3L3Xck1AsmMuG2ChrEQ
// SIG // /IcZI5iK8uw0GwzqakYxy5bDw7b8ztzJ7W7jK4Dd39XK
// SIG // LcoquPkS6KYL49HQ4LOXMGvBmLROtI1l2Vt1qwx3nWEW
// SIG // dju4LtHtbch0LodrdgTRGbqXQDlnTA/XxWIKBlKs7tW+
// SIG // bhM4WvQxEik=
