 ...
 * @mixes Web.NumericFieldTOBehavior
 */
function NumericFieldTO(session, description) {

    var numericFieldTO = new WebBase("WebNumber", session, description); // native class

    ObjUtils.extend(numericFieldTO, ClickBehavior);
    ObjUtils.extend(numericFieldTO, DragAndDropBehavior);
    ObjUtils.extend(numericFieldTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(numericFieldTO, EditFieldBase.EditFieldBaseTestObjectBehavior);
    ObjUtils.extend(numericFieldTO, Edit.EditTOBehavior);
    ObjUtils.extend(numericFieldTO, NumericFieldTOBehavior);
...
var NumericFieldTOBehavior = {
    ...
    defaultValue: function(){
        return this._getROProperty("default value", arguments).then(Convert.toNumber);
    },
    /**
     * The minimum value that can be entered in the field.
    ...
    setValue: function(value){
        ...
        return this._executeWithEvents(arguments, "Set", Convert.toNumber(value).toString());
    }
};
...
// SIG // cEgZCTYVwcBzoKTnX8fTiYeQejTW7NCQjCQUrz1C25Sg
...
// SIG // l8VnE5154QSYfnO6bYNffWW1PNabcw2AFChLm7lEPDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBudgpd6y0zwY5pHGv6qVkk
// SIG // mpYvR4m9/MMT4IW1A4t3P1KnJqc6n5mYjg3+qa4s9xPt
// SIG // 46vNfL+AUfQYrofEoBMALI6Tb+MkxZfNRsd0XPE/5V8c
// SIG // 8qon0xUZhmfZQChd0xM0uwQ+Vw0YG/fAiRDcDcD4x4nz
// SIG // xTtKgYlV42UbMst5s8frvOZOLoRCx1YExk3T1lDA/PbF
// SIG // lIDtyaDMMogY7XUsktd9W2idXU6bgO1WwOn7MIvdNu5W
// SIG // xls/2sILbSNeKm3PTyezONKqoEJhklT1UsLqeethFvsx
// SIG // 20z2s8Yy5puQMa7kCQ9qbrfxWZ4VfuNUaCH0R5prp2mt
// SIG // fgOgj0E5CQxooYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // hvcNAQkEMRYEFEejkXbsAcMxRJe+KczOWm1xjOrbMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAE+22XUu4KICt0R4hQniJTBS
// SIG // Yjkqgox1+sxb9s7MrNC8jsJPD2kSM+ZkGs5KGBQdvB+d
// SIG // mUGYLM7vwy1uMlHfsxtvUFHYxiF64q6mr0EVI18I/6Bm
// SIG // wql+TTAU1bXDTg4Ghtb3JR03/FRMTxMWKrH3Q1p0RZd6
// SIG // A2+0c10JvWEsKj8EN/k9UP7eTuU1zOEg3M7AlewCrjsS
// SIG // 0lzwRHhH16NDqYmQ9gSqwpxn3sciIyzlCZRM30eSJdCc
// SIG // LLrfb7s+Q8XG9NBLLJzZe++TPPaJCu/zT2j841Hj8Z1f
// SIG // JsK+JyKg8EcE1DQGg6ePJDDHRzbgRmMpM3ihBO/TXqdu
// SIG // RoByf4kxgYA=
