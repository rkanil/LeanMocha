...
var AreaDescriptionBehavior = {
    ...
    coords: function(coordsArr){ // int[]
        return this._propertyHandler("coords",coordsArr,HelperFuncs.stringJoin(","),function(valueToReturn){
 ...
 * @returns {AreaDescription} the description object that was initialized.
 * @constructor
 * @memberof Web
 ...
 * @mixes Web.AreaTOBehavior
 * @memberof Web
 */
function AreaTO(sesssion, description) {
    var areaTO = new WebBase("WebArea", sesssion, description);

    ObjUtils.extend(areaTO, ClickBehavior);
    ObjUtils.extend(areaTO, DragAndDropBehavior);
    ObjUtils.extend(areaTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(areaTO, LinkBase.LinkBaseTestObjectBehavior);
    ObjUtils.extend(areaTO, Image.ImageTOBehavior);
    ObjUtils.extend(areaTO, AreaTOBehavior);
...
var AreaTOBehavior = {
     ...
     */
    mapName: function(){
        return this._getROProperty("map name", arguments);
    },
    /**
...
// SIG // tvrFpsAFGYR8v+sH5qnvWUXDmpwQ0Ogs+8pz7b5UPUWg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCQ
// SIG // jfWbGV0GODkfqRtzAoTLwXdnQLOYuIsopUm7ctG1ojAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAqMIdFBbuz29AbMKeKz9IM
// SIG // K5fT8hsAuWjELdXQBZq+yRTQeT6i+FnHVJmRWpa7//vB
// SIG // 65AvfVgSZnLn7ZVBWdIaxLiaFemxRG+cqr8moP5p9ki7
// SIG // Ds0bX9sTTg00tn7O4OcXdt00KFB0NcLWmYRMR0DYYHQJ
// SIG // vvmMo9Q58ViZ1EqOm507WI0+T0s00oVdrKmLMizgUiEs
// SIG // kx2qd1hKZqChyTtIeBpAq58IjWFbKpYuyg7M9D7bR9DI
// SIG // 3EOC9ZdI2zRnbFQyOOsqk5Ivk83C7tqRdYSs5I/dvBcA
// SIG // 5w7Cs93eB/7iq3H6hhjVpgK++0tJ/5WVkJ5VsgY/qO4R
// SIG // qPxJcYewx8bIoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTQwMlowIwYJKoZI
// SIG // hvcNAQkEMRYEFHXZOSNxs3PGcA1j5CNMhQq7CFHLMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAICrb3X2mvsHhsVqC85XKmhd
// SIG // NzVfQWr0eVN/x8X3UAoyPLBjbjAMrS3DW8SLvHjwDEtC
// SIG // kfkIQdNaFbxptnzVr4Jrmh7qVADcPwPLHpLScKits/aC
// SIG // DUAWrosqmYk8OFjtEtDrXNX75t3dRwSGHRLzsq/+Rsjs
// SIG // YYgw78zP5QgEPLCGbl0ILpeOEP8JD/VoTpqWOmEAOibR
// SIG // KlKciP68dwSrtXNucFigdDSChLNh0xvKoVmcZAkg1jhg
// SIG // 98DPja/4Ek3XoS4+ClsdvOJFWWFvNLprkHDsKAfzGZjU
// SIG // Qr6VkMmDBMR72iNLMH3QzBDsR27+Wo8IiPz8husTWc88
// SIG // ceLeRm7iBC0=
