...
var CheckBoxDescriptionBehavior = {
     ...
     * @param {bool} [checked] When provided, this method acts as a setter and sets the isChecked value.
 ...
 * @mixes Web.CheckBoxTOBehavior
 */
function CheckBoxTO(session, description) {
    var checkBoxTO = new WebBase("WebCheckBox", session, description);

    ObjUtils.extend(checkBoxTO, ClickBehavior);
    ObjUtils.extend(checkBoxTO, DragAndDropBehavior);
    ObjUtils.extend(checkBoxTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(checkBoxTO, CheckBoxTOBehavior);
...
var CheckBoxTOBehavior = {
    ...
    /**
     * Indicates whether the check box is checked. Null if indeterminate.
     * @returns {Promise<bool>} a promise this is fulfilled with an indication of whether the check box is checked. Null if indeterminate.
     */
    isChecked: function(){
     ...
     * @returns {Promise<bool>} a promise this is fulfilled with an indication of whether this object is enabled.
     */
    isEnabled: function(){
     ...
     * @param {bool} state Indicates whether this check box is checked.
     * @returns {Promise<void>} a promise this is fulfilled when the operation was performed.
     */
    set: function(state){ // bool
        state = Convert.toBool(state) ? "On" : "Off";

        return this._executeWithEvents(arguments, "Set", state);
    }
...
// SIG // evWlRyvVekOZrE2b9bgkZ+y34ojW+6qwfjFzVrKDotKg
...
// SIG // XTGe3TuIbkjCyBxgLCEabiip3lrwYSxlTLAUBqwC8jAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCu7lw54ASH0goq2TLuJBAF
// SIG // gUsJVnZhe3lX+rdsCQCiHX1lzDydNmybnN4/Ml5/mexe
// SIG // NKbxwpBm1utTKzqJ+JOkbfXc1ngwbfEDuQmtEfWRJ6cZ
// SIG // BhjJPlQCS78IHNYZbI6Wq24hSTxrhb22q3bc7jijmzM2
// SIG // AkE6TaadzgPJWZAN20TAJ+UcBNJG/TZ9Zv31+N9uS70d
// SIG // nQNkUsXCvPeQqzDqyvKVzNTPQo0/vLNQSqvy+mDnPBMn
// SIG // eKKg3jNqBvFDDRjWYw1cxXiEGNJ1ZniwazFttXS3iZXJ
// SIG // agprHnO8gFcRNlIopEEWa/3k0NLHwfFqlYYBFX1OC1wD
// SIG // wnfz/e+KJJIooYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjYyM1owIwYJKoZI
// SIG // hvcNAQkEMRYEFAxMMuKAhjOexia4WArWL+OORn13MA0G
// SIG // CSqGSIb3DQEBAQUABIIBABeFw0qccblaAnM786UamC9/
// SIG // BrG0i2+CIbyuP5TXwHJ2xzn+OIahLtNo+BC54piwhNKf
// SIG // mjoNJNcwJAzGuQczi0T8z2sD98kS+i0poWhonlXT4C42
// SIG // FUNthKmZtVXA3fhMc9wFSorICsh+bbHOspFsjvnD8igM
// SIG // UZO50K7Hl9tO/ea+ycZSwHMcdDClhcwlaDfBDwFAIhU7
// SIG // NpsK4HDbqeQdgHkGBa6eKhLeiLnnytSjNigJsMEX6BFm
// SIG // ViBIyswtuJsbqsfGSt2oLxZCpe751a+2gCx6DpADe9uv
// SIG // fNOSycktZB5/JVCwzgBUamn1hm297RbXoji5xf50SJiu
// SIG // 862d1MpGJsw=
