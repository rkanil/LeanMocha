...
var IsEnabledBehavior = {
     ...
     * @param {bool} [enabled] When provided, this method acts as a setter and sets the isEnabled value.
 ...
 * @type {{boolToInt: boolToInt, intToBool: intToBool, boolToOppositeInt: boolToOppositeInt, intToOppositeBool: intToOppositeBool, arrayToString: arrayToString, stringToArray: stringToArray}}
 */
var HelperFuncs = {
    ...
    /**
     * Helper function that performs Array.join and can be passed as a continuation.
     * @param delimiter The delimiter that should be used for join.
    ...
    /**
     * Helper function that performs string.split and can be passed as a continuation.
     * @param delimiter The delimiter that should be used for splitting the string to tokens.
     * @returns {Function} the continuation function that will perform the desired split.
     */
    stringSplit: function(delimiter){
        return function(str){
...
// SIG // nbz1AZUwYkPPTveffm3NeT/tITIZJ109xQD5hK4Z1tqg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAp
// SIG // cqjgwOqT5pRcUNKFdmbZRNnv5HzKihuUwNVX298PtTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCpc/ApSBh1C+KRH61JB7Sk
// SIG // AiESg5EXrkw5GZRNmbuQW5hMHPxX2wtOTuHEbBA1swvo
// SIG // q1B8N0Nz1XzGhiIgOVmylIJJtFXVh3GGwqXrpPlP5E85
// SIG // LSvd/TBIGk6MWvG56YQYarFhIu6hbUdQkloiOgSTz0lG
// SIG // BQPbTJ5g3kTBHpXxnGfiVoaLOBC/ZLgroK81VlavgSip
// SIG // 989+UTFnsJJ+RtbLb90CN+xIbUc/+N1yMrAx+MNq3vB0
// SIG // xJDpJ2GUaFPJBtF+pcV3GSJ0muXcupqP1sC8dai7zO4t
// SIG // tyfknRoUBbzQRVfb+A+yI6/5qAK74DE6eXVIwUgO6ZBl
// SIG // sv/ondgnXSBqoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTQ1NVowIwYJKoZI
// SIG // hvcNAQkEMRYEFC9f8b+aNzv3y1s2aF3QtrPmKNhyMA0G
// SIG // CSqGSIb3DQEBAQUABIIBADTGfgHSxva7UZKwtk/FalQE
// SIG // 7lVLg+kQ3bBu27EPrWUR7+H2GUl3SAed1y88Ubl4A/JM
// SIG // UUiddMhTdJCGjtHjasrLnB0IjhPXf0tj4gpsZi0H1VwF
// SIG // +CDipB6YPu2R/XD/RNvQ3sUQiNeOxeVxC4IvQNcVGnyp
// SIG // SETO3UI8XuwuDMmH3Uq+n2Ism9otpmsycshTU3L1Vr7W
// SIG // u9vVX8h8kHzwqluc5suUduR60ACJiK8jIVUbaOKe0Aj/
// SIG // RhqzIx4hdnsA2XzFNdDYdqSuTjKaiPJpejCTQRrAYv4n
// SIG // J90f0849Ps3R5wjBf8FAfhEnlJPcb3aXcuhp8zkJsD0D
// SIG // 1Pkgr4vvLec=
