 ...
 * @mixes Web.LinkTOBehavior
 */
function LinkTO(session, description) {
    var linkTO = new WebBase("Link", session, description);

    ObjUtils.extend(linkTO, ClickBehavior);
    ObjUtils.extend(linkTO, DragAndDropBehavior);
    ObjUtils.extend(linkTO,WebElement.WebElementTOBehavior);
    ObjUtils.extend(linkTO,LinkBase.LinkBaseTestObjectBehavior);
    ObjUtils.extend(linkTO,LinkTOBehavior);
...
var LinkTOBehavior = {
     ...
     */
    fontName: function(){
        return this._getROProperty("font", arguments);
    },
    /**
    ...
    backgroundColor: function(){
        return this._getROProperty("background color", arguments);
    },
    /**
     ...
     */
    color: function(){
        return this._getROProperty("color", arguments);
    }
};
...
// SIG // faglhqU6sA92du+lIuRy2uzrQfiZufuAkZFw9WxNT5Gg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD1
// SIG // SLuv1N66y64XDXNmlk1MIIpbYS1fVOl2oAcBFpN2mzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBdk5vQ3sZTmYsnX3HFNMqa
// SIG // Dv912p3gdvgSP3xubnN4X9imx1494hgxNcLik4vzfEtc
// SIG // dUuCw8sUHHtf89DxKPnVburXz3OYEpOnhUhwxsxKCN9a
// SIG // 6h+cffOXPGPsxs6BpILnt7PiOKGSgCTS5srgUvg6Kteg
// SIG // So/eG+YBnGGznA/1IlBgAvY7m6wV83yLHKBtG47tv5qR
// SIG // HUjwD7RiUFF09vfxuwko/QSLtwkAsBRT8iydYzg8lGFR
// SIG // ysEhftHLLY3GcKAWlsXsjeQPPD59GcB+M9rxwdksa2lp
// SIG // iqQdUMXlLfwh2P3Zkj/YTpJFyPTQ+iJyOD1HSZpiD46U
// SIG // /lv3fJrgFFTOoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // hvcNAQkEMRYEFMYR2SO+FT9wALJp5mA0WE8jS7dIMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAEZMO4LNBvRq51vI/p7edqWq
// SIG // h7IzA5OimIehka7kahpDZsQVZFtjyuLOgftPU1XszbQO
// SIG // y+Ghqr6s9awHn9XxmbRBoopTIWxTbEvxoUcXAB9nLxXm
// SIG // zjUDQO31RjiTDK2XK0qerrAnwLX0TGy3VZXQePIlfsJw
// SIG // r+Q3aEK5BpL8nYGNp4efwQhV052oDhpakhrCPHby9y5K
// SIG // WrN82ZuXyhhdj0Ycb0Dsf8ox8WKtHJAZMS1AHntSSxGJ
// SIG // eWC01mXuztXhy4aTWyDrd340kW4QFnKXFE2vrPUebvPA
// SIG // 2iXzMskC0VoQvd6V3x36oesqkk+9O+yrhybO/+BUPFeq
// SIG // FuS3qCVKvFM=
