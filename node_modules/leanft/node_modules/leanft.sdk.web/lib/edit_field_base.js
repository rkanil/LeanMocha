...
var EditFieldBaseDescriptionBehavior = {
     ...
     * @param {bool} [readOnly] When provided, this method acts as a setter and sets the isReadOnly value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored isReadOnly value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
     ...
     * @param {bool} [isRequired] When provided, this method acts as a setter and sets the isRequired value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored isRequired value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
...
var EditFieldBaseTestObjectBehavior = {
    ...
    /**
     * Indicates whether this field is read-only.
     * @returns {Promise<bool>} a promise this is fulfilled with an indication of whether this field is read-only.
     */
    isReadOnly: function(){
        return this._getROProperty("readonly", arguments).then(HelperFuncs.intToBool);
    },
    /**
     * Indicates whether this field is mandatory.
     * @returns {Promise<bool>} a promise this is fulfilled with an indication of whether this field is mandatory.
     */
    isRequired: function(){
        return this._getROProperty("required", arguments);
    },
    /**
     ...
     */
    maxCharsInLine: function(){
        return this._getROProperty("width in characters", arguments);
    },
    /**
...
// SIG // qy0csXg40GrPzRq4UAaZrpIlU6n4TZhTMpSOMRWf2dag
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD4
// SIG // OlWW9UQ/9rLcPnivfk4NK56mXbUH4lRAV2vL7AnjzDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCnTaagZDLajoZxPj/o04kC
// SIG // /1TyrqjXarf5yv/lMuEMEXZ/uOUpVNhSW7y5uGO56GTO
// SIG // I0OzOG9Ptam3Sh6mDRLVHoCcdzePs6O+6teESLf4Sann
// SIG // HbHH+LRsKyc+2K5uaCA91DTnlxIN+uy7WRtRit3PlC9O
// SIG // pMsFcVV1UC1SXsrJMDbm5SETctdXYf96I6VzgCWQTUn5
// SIG // biv7NXoRHQzvA8uNU9sehkupHfJLYT0P5QNzgwD5tlaK
// SIG // 3gDf9eWJhpV5DDVhG6QsPsY/PQsh7QQj3bw6ob7TRWXG
// SIG // AloLhZQboChSEyQM99OLFKsRNuPz5blVvdTvA30qTiu4
// SIG // 2QSjlIP01cb0oYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTUxMlowIwYJKoZI
// SIG // hvcNAQkEMRYEFPVJIyX7pcP/rgCNgrGiRqBtL2M3MA0G
// SIG // CSqGSIb3DQEBAQUABIIBAEjOVzPhqjcuuiPXwb7KmrSM
// SIG // FjMjM1gIb6ewpj8ViUJF/yyJQSt/z7iGOCS0i809o9CT
// SIG // fNcsFRUdzVedRy+eFkyQ1XvNJ+mf8HWhxZdWrTVYhfIp
// SIG // Q+oRHoGbK1qSvsenZuTbM7N9xXOmVxlEgBTq/p8efGIf
// SIG // fpT3us+9eSk8Qn1bPnzp9tC+jMxeU8thCHeRU3uJy36s
// SIG // CralakhqvuJEC9JHJt4sddpRzOkcUQW832frXGh6yER/
// SIG // 1i4q3OcBvKmOsfvv8EK+90VyXtrNxNjzB6A5RGxukCtC
// SIG // Dd3HIkKsAxD6M4MHiSOQkzlYZuCTRwd2ifQ/hmVw5Awt
// SIG // pOBYjniWlAw=
