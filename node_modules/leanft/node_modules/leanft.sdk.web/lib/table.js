...
var TableDescriptionBehavior = {
    ...
    columnHeaders: function(colNamesArr){
        return this._propertyHandler("column names", colNamesArr, HelperFuncs.stringJoin(";"), HelperFuncs.stringSplit(";"));
    },
    /**
...
/**
 * A single cell in the {@link TableTO} Web object.
...
TableCell.prototype = {
     ...
     */
    text: function(){
        return this._ownerTable._executeWithEvents(arguments, "GetCellData",this._rowIndex,this._cellIndex);
    },
    /**
     ...
     */
    countOf: function(childType){
        childType = childType || this._ownerTable._genericDesc();
        var testObject = this._ownerTable._session.factory.create(childType.leanFTType, null);
        return this._ownerTable._executeWithEvents(arguments,"ChildItemCount",this._rowIndex,this._cellIndex,testObject._nativeClass);
    }
};
...
function TableTO(session, description) {
    ...
    ObjUtils.extend(tableTO, ClickBehavior);
    ObjUtils.extend(tableTO, DragAndDropBehavior);
    ObjUtils.extend(tableTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(tableTO, TableTestObjectBehavior);
    return tableTO;
}
...
var TableTestObjectBehavior = {
    ...
    columnHeaders: function(){
        return this._getROProperty("column names", arguments).then(HelperFuncs.stringSplit(";"));
    },

    /**
     * Rerurns either a specific cell or a promise of all cells in the table.
     ...
     * @returns {Promise<TableCell[][]> | TableCell} either a promise for all the cells in the table (when called without arguments), or for the specified cell.
     */
    cells: function(row,col){
        if(arguments.length < 2){
            return this._getROProperties("rows","cols").then(function(tableDimenssions) {
                return this._initTable.apply(this, tableDimenssions);
            }.bind(this));
        }
     ...
     */
    findRow: function(cellText,startFromCol,startFromRow){
        ...
        return this._executeWithEvents(arguments, "GetRowWithCellText",cellText,startFromCol,startFromRow)
            .then(function(rowNumber) {
                if (rowNumber === -1)
                    return null;
                rowNumber = rowNumber -1; //0 base index.

                return this._getROProperty("cols", arguments).then(this._initRowInTable.bind(this,rowNumber));
            }.bind(this));
    },
    /*jshint eqnull:false */
     ...
     * @param rows The number of rows in the requested table.
     * @param cols The number of cells in each row.
     ...
     * @returns {Array} the array of cells.
     * @private
     */
...
// SIG // e3f+N85P9xaNQInk1c4fgoKnTHJSXznirs0x+RdshnWg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDU
// SIG // /LT3p7hlpGBPBA0bYcGQeowm6eX7LW28BvlVz/YvvTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQA5jXH3QG1Lk7hwWZ1Y7G39
// SIG // TkkJKuc1F13mtd0VERk47yYQ13TVqfISfG9coo08rDkd
// SIG // KBQSpOxTjXve7LtyP1+HdK01v0YrJ9WOZTD7h341+FzY
// SIG // W8iSwd1LfLCUTSsFYZ69QShkhLYVUjwjLHxhw587Ttbe
// SIG // YUZVZ8Z5ExEhxSjqO0ZF25rr8jmxd4Kkv4FESWxttP3F
// SIG // yQLKUciOC9tG8BN+h76ZSDYSRy6+CgEuWvkKtH2iVDwO
// SIG // Di2W7dj4OmOqc07cn8G63wAYaH0TPDVSJCmFDUWX1mEQ
// SIG // HMwgpzGMcdcATpmSXxUmIpfLuP4xH75yZm2aW6FGUuDn
// SIG // pE2nvTsOIvAioYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjY0MlowIwYJKoZI
// SIG // hvcNAQkEMRYEFC5NeTCPjusEFA336s/ohXEw22aaMA0G
// SIG // CSqGSIb3DQEBAQUABIIBACzdXHgHZDhfS4DWG4Selb+0
// SIG // GV3rQYVtBbo6iEi0Qmh/yODRkq98aAlzJS1wm08ii6w5
// SIG // MBaEr7ETbfRqTL29VvS9vOTC8K0266DjJmMwNjnVlks/
// SIG // SVLwAsUNTcX+FBtr9VH6IoiOTae1Jta6JrAHQs7jV/y4
// SIG // 6FF+Jp0BXk0zq15lGcbBwybK+J5y2vM3XwqSn45AFStt
// SIG // UFiRdNAM4TtVw52w9cX/21p6d435Iyz14yrrW0cKvao7
// SIG // CAVsB755UAZT7NmcE3x4T7vU62tem0KVmK1z6XNOeENc
// SIG // Cec1eKaPWqbSGuwskwuOxgjtOGYYtz/btczbF1XqGS0I
// SIG // +uYxy0NpkoA=
