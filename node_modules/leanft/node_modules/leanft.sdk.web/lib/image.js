...
var ImageDescriptionBehavior = {
     ...
     * @param {ImageTypes} [imageType] When provided, this method acts as a setter and sets the image type value.
     * @returns {ImageTypes | Description} If no parameter is provided, the method acts as a getter and returns the current stored image type value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
 ...
 * @mixes Web.LinkBaseTestObjectBehavior
 * @mixes Web.ImageTOBehavior
 */
function ImageTO(session, description) {
    var imageTO = new WebBase("Image", session, description);

    ObjUtils.extend(imageTO, ClickBehavior);
    ObjUtils.extend(imageTO, DragAndDropBehavior);
    ObjUtils.extend(imageTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(imageTO, LinkBase.LinkBaseTestObjectBehavior);
    ObjUtils.extend(imageTO, ImageTOBehavior);
...
var ImageTOBehavior = {
     ...
     */
    alt: function(){
        return this._getROProperty("alt", arguments);
    },
    /**
     * The image source in URL format.
     ...
     */
    src: function(){
        return this._getROProperty("src", arguments);
    },
    /**
     ...
     */
    type: function(){
        return this._getROProperty("image type", arguments).then(nativeToImageType);
    }
};
...
// SIG // Jp9FTNvSM7n+KR/hTXKGPIgNNH1lyerO6O8gkvWqorag
...
// SIG // M5m/rWyTbmz9WPWSTsD7rDYNM4OZksKrfKGI2y+q5DAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCsG0hVLpgQIUtC2k9VgNeX
// SIG // eQ26hH23++evbZwuFxdqRDNUvw19Fc0FbVzyLU7RcwO2
// SIG // X/0kaZZ3dLIWrC/YD1CMEdH9OhBSfd8DyL/1TWzM7tXU
// SIG // cBBVhGG+TC+Gj7ILQQFDVwzG1d9wP5pI+0Ste0/IPJwr
// SIG // oyV8M34CHHo+GTAZ8Uzt5HSE6/2TyNN6MjOKZa0b0Vf9
// SIG // QKi6M7mDHesJConuhONxPfeP280Ug+brwP9gAU8eQEbE
// SIG // P+eLFMnm6iurvIwWiu+l36ChUN6mAZ9cVfTOFN0eoeIp
// SIG // XX5yt6xxYxubOqPTzlVKBwybF4DfGnTk83Ut6mleK034
// SIG // Ds1gFVAK9M9aoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTMwOVowIwYJKoZI
// SIG // hvcNAQkEMRYEFFgHR1EazIdi5feISxeXq7YpRUlFMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAG9CRkW9yIBaKIXz5cJiVaeM
// SIG // j8Xgc7fi8AK6reZIYPuGSB+WdAt/opIAzcGrkJW8S5Kd
// SIG // hPUBUe0MLl1qCVlWQCTerE5PH/0AENrBq66jTL414zwH
// SIG // 3HIi9/M32sSD8fwMCINjWzBmQbLNhCBWToNZsMfY8w5u
// SIG // 622Jxr8b9jDbT58/o8gN/SWHpYzN3I1QEm7XmI8auyh4
// SIG // AyxTQG0vu6f0/fYNVGYgo8uza1302bVwUH1j1KIb/oVk
// SIG // KMnsu+XAE2Ng3jFPQgPEKtJe8XQcE5i52pZDQz4OQLr+
// SIG // PubbA7D7OSfTxq0uHTsmsn5GRuk6ToU2drMFPNpcsANu
// SIG // VNcKjmwUgjI=
