...
var MediaControlDescriptionBehavior = {
     ...
     * @param {bool} [autoPlay] When provided, this method acts as a setter and sets the hasAutoPlay value.
     * @returns {bool | Description}  If no parameter is provided, the method acts as a getter and returns the current stored hasAutoPlay value;
     ...
     * @param {bool} [playbackControls] When provided, this method acts as a setter and sets the hasPlaybackControls value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored hasPlaybackControls value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
     ...
     * @param {bool} [playInLoop] When provided, this method acts as a setter and sets the isPlayInLoop value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored isPlayInLoop value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
     ...
     * @param {bool} [muted] When provided, this method acts as a setter and sets the isMuted value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored isMuted value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
     ...
     * @param {bool} [playing] When provided, this method acts as a setter and sets the isPlaying value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored isPlaying value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
    ...
    sources: function(sourcesArr){
        return this._propertyHandler("sources", sourcesArr, HelperFuncs.stringJoin(";"), HelperFuncs.stringSplit(";"));
    },
    /**
...
var MediaControlTestObjectBehavior = {
    /**
     * Indicates whether the media file should start playing as soon as it loads.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the media file should start playing as soon as it loads.
     */
    hasAutoPlay: function(){
        return this._getROProperty("autoplay", arguments);
    },
    /**
     * Indicates whether the media player should display playback controls.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the media player should display playback controls.
     */
    hasPlaybackControls: function() {
        return this._getROProperty("controls", arguments);
    },
    /**
     * The URL of the media file currently selected in the browser window.
    ...
    currentSource: function(){
        return this._getROProperty("current source", arguments);
    },
    /**
     * Indicates whether the media file should start playing again from the beginning as soon as it finishes playing.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the media file should start playing again from the beginning as soon as it finishes playing.
     */
    isPlayInLoop: function(){
        return this._getROProperty("loop", arguments);
    },
    /**
     * Indicates whether the media volume is muted.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the media volume is muted.
     */
    isMuted: function(){
        return this._getROProperty("muted", arguments);
    },
    /**
     * Indicates whether the media file is currently playing.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the media file is currently playing.
     */
    isPlaying: function(){
        return this._getROProperty("playing", arguments);
    },
    /**
    ...
    playbackTime: function(){
        return this._getROProperty("current time", arguments);
    },
    /**
     * The length of the currently selected media file (in milliseconds).
     ...
     */
    duration: function(){
        return this._getROProperty("duration", arguments);
    },
    /**
    ...
    playbackRate: function(){
        return this._getROProperty("playback rate", arguments).then(function(rate) {
     ...
     */
    reload: function(){
        return this._executeWithEvents(arguments, "Load");
    },
    /**
     ...
     */
    play: function(){
        return this._executeWithEvents(arguments, "Play");
    },
    /**
     ...
     */
    pause: function(){
        return this._executeWithEvents(arguments, "Pause");
    }
...
// SIG // m/HWpxzX88WjOglitgRsd/cxCYFdCVeAWL1HmocIBlag
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDs
// SIG // xNKGoVyOcKoqbkKDBjgluNjkaX3BpcHmBeWaTv8wvDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBT56KV3QI5ApvuRAsC0KnL
// SIG // ayHJ5gxCX26xA7UgiLfmk1wdGYRY5HaOn0PpW04wHcIv
// SIG // PVGVxZExDhLd3JAWVzzQiK8eq2UZ1mA/187CZwtR1M5v
// SIG // 3svh57TFJ6PGLgs8Y8RPbzv7H8IiZ5xfc4nsYXMhAzR1
// SIG // SKCvivxu641vKOTBYZU/fAlMYIx1QUbHazg7TTaA0gY/
// SIG // jQCMP6MpmiGMRzvhXJ3TYwznxu4ZBV/z5ukg6cPIQkhQ
// SIG // 9f+maJpdgQc4fyjKG0SzvIj6a90ghY6h3EGhweT5rCsl
// SIG // /kovslf+zV1U+0jqwzc2LSCA4YCEe6c+Md11gkSfdZ9X
// SIG // LEXesZD9POJFoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjUxMlowIwYJKoZI
// SIG // hvcNAQkEMRYEFGAICDartfgGvZlvpDlAETI3BX/QMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFLvCw0kcv0jzP1fcBr3A0NX
// SIG // ukKtLUL73jgkqZzyq1rdP2etqZUq6dJg8K+30PK3rhGm
// SIG // cffPkJVKGV6w87URB9UQ5BMFbFjcx+JXOyS4jCxdpaIJ
// SIG // MobbZgfGVJt8n7dFnic7eTfcEY5or/0DGfnrtv5xFmhN
// SIG // dxNUdMXmtTP9hfxxIhhY7O3h5GTLFLxb3TblOgo9kQt0
// SIG // w356Fa98wsXQ3xBuonbfLCedYzkjRB5+Ogz7Yq218pyd
// SIG // KINrYpOhb5IGvs24FRnmTICIkcK76k1ir89zqL9f+rhf
// SIG // mrw2m993SKCwFiGqSSJ7zRCkkDzZ4F/WLSYNgWcwC1lW
// SIG // jFVUcCm5czU=
