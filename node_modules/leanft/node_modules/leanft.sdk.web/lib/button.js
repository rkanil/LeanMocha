...
function ButtonTO(session, description) {
    ...
    ObjUtils.extend(buttonTO, WebElement.WebElementTOBehavior);
    ObjUtils.extend(buttonTO, ClickBehavior);
    ObjUtils.extend(buttonTO, DragAndDropBehavior);
    ObjUtils.extend(buttonTO, ButtonTOBehavior);
...
var ButtonTOBehavior = {
     ...
     * @return {Promise<string>} fulfilled with the button type.
     */
    buttonType: function () {
     ...
     * @returns {Promise<bool>} fulfilled with the state of the 'disabled' attribute of the button.
     */
    isEnabled: function(){
     ...
     * @return {Promise<string>} fulfilled with the text of the button.
     */
    text: function () {
...
// SIG // aUwLdLXtRqMMq82Q31jYF3c1K7JC1pRMKHvoN1dlfnag
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCI
// SIG // nFrlxVMa+fTb2P8eDVydyQDP29pNsjVFwvaR7x7ujzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCw5lr8v1Itw3RclVUu8/Ff
// SIG // gMvtJZSTZLte2k3Ghr2aHhdEQ2pUjAthGj4an7Ad9oAg
// SIG // bicsxuqgfDtbIGsY3aKoOzAXqS5Ot75SqqVx9q7fsB06
// SIG // PyLa6dYBCMDs1pQPWKRVQMv+ds+0dttPEM3Z/GmcNryp
// SIG // TWNXMIFyTV0PWxk4iqe1Ytk/QN9nc/reYBoyd678etKF
// SIG // z5gOucuA2V+8M7qekGZjKgvZntQvpVtBJnq1ehviV21E
// SIG // feddAK+sTwg77Dn8lmNsfHVAWjkwHsG+otq1cx0jFTr9
// SIG // by2afttgfM8ywSG15soCUKLeq3e/zuEuRboaOcWz7vf/
// SIG // 4j2t12luRUahoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTUzMVowIwYJKoZI
// SIG // hvcNAQkEMRYEFMnNxJ2OjcM65HdwNHS8o8WNREsEMA0G
// SIG // CSqGSIb3DQEBAQUABIIBABfGWHixe2H+iYusQIGv0/YD
// SIG // hhAibLFLEHKgRFFCQgY3DuRZvnYTMs1x7eVdl7LqLDKQ
// SIG // 0CcgfdKSOR1yCDxqlO+D3SJqFSBaKhDWDYpM1Wsf8/8K
// SIG // 3J/femA0+GZDuTHFHcTIxia5OfUcWVT5S6cFOXEuVx8N
// SIG // BEQwz8kdu2JdNxSdDuyMiOnojE8YaT8aZ/oMhsLiveKN
// SIG // vw0qjJIw13TN1gjMmhdTqGP8rkLXx4hWldwjcqAqdZGS
// SIG // UDHxt5n24zsdg/PC/7vEoBeYfi56zZvMC8Z/FPMvZ+xw
// SIG // bvztN3Qig5EJEF6bS35LE7S9BhTgPG9Fuvb3LKiJ5HpM
// SIG // 8NhruNJYZbM=
