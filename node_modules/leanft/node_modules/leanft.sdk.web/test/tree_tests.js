...
describe("TreeView Test Object",function() {
    ...
    describe("select",function(){
        it("should call execute command with 'select' and pass the given arguments",function(){
            treeTestObjUnderTest.select("path","selectorPath", "expanderPath");
            assert(treeTestObjUnderTest._executeCommand.calledOnce);
            assert.deepEqual(treeTestObjUnderTest._executeCommand.firstCall.args.slice(0,4),["Select","path","selectorPath","expanderPath"]);
        });
        ...
        it("should execute command 'Select' with selector and expander as null in case not provided",function(){
            ...
            assert(treeTestObjUnderTest._executeCommand.calledOnce);
            assert.deepEqual(treeTestObjUnderTest._executeCommand.firstCall.args.slice(0,4),["Select","path",null, null]);
        });
    });

    describe("collapse",function(){
        it("should call execute command with 'Collapse' and pass the given arguments",function(){
            treeTestObjUnderTest.collapse("path","xpath");
            assert(treeTestObjUnderTest._executeCommand.calledOnce);
            assert.deepEqual(treeTestObjUnderTest._executeCommand.firstCall.args.slice(0,3),["Collapse","path","xpath"]);
        });

        it("should execute command 'Select' with xpath as null in case not provided",function(){
            treeTestObjUnderTest.collapse("path");
            assert(treeTestObjUnderTest._executeCommand.calledOnce);
            assert.deepEqual(treeTestObjUnderTest._executeCommand.firstCall.args.slice(0,3),["Collapse","path",null]);
        });
    });

    describe("expand",function(){
        it("should call execute command with 'Expand' and pass the given arguments",function(){
            treeTestObjUnderTest.expand("path","xpath");
            assert(treeTestObjUnderTest._executeCommand.calledOnce);
            assert.deepEqual(treeTestObjUnderTest._executeCommand.firstCall.args.slice(0,3),["Expand","path","xpath"]);
        });

        it("should execute command 'Expand' with xpath as null in case not provided",function(){
            treeTestObjUnderTest.expand("path");
            assert(treeTestObjUnderTest._executeCommand.calledOnce);
            assert.deepEqual(treeTestObjUnderTest._executeCommand.firstCall.args.slice(0,3),["Expand","path",null]);
        });
    });
...
// SIG // RueiwEa2Lpx2Yk1kT3IJ+YDrzRnHDhNIGP3Cj/w5k2qg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCB5
// SIG // 5vHGW7AxIk9p9ovpNvbiQnGqWN7RBouJkoGuiR4OezAN
// SIG // BgkqhkiG9w0BAQEFAASCAQA+Q6KpeTm5elN/vB0KO7Ru
// SIG // z/KNA84KQVefN0YOvtlKZyrolTVHJTZnGvLm+VMTMhkU
// SIG // 1+M5dvHgm4KaqrTqKC5kbz0a+Vqdr9AeKabr7Iu6TI3I
// SIG // +P/3vebdKCxuvGx+Bp0snMz5T2CdqQOb58tq9RCPLQUh
// SIG // 4HcXbwKedKEusu6G7hx038hvJONpGSfPnIVswuwKwwsK
// SIG // q6KsKjuPIiX0Ju55aUkvNhHOK2eS+0H1A8v+extyGOEX
// SIG // XmMG9zhJ/vcDEBJvchHbRcQwanw66unx+JMpU18P2Zxl
// SIG // nL3pf4ydRyFB/HFrn5ARynYzh5SwMLhfuYMGS2WewS3+
// SIG // M7qYwjusgcPMoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjExNVowIwYJKoZI
// SIG // hvcNAQkEMRYEFPEviPAHjw57hHX0e+9eaVQLSFf7MA0G
// SIG // CSqGSIb3DQEBAQUABIIBACN/g1kYXGtW+AT94zJ9p01O
// SIG // TyJStkADw0Rrwu3tmf+/O6NQV2bqceV/J4Buo2yin6YM
// SIG // CguAZ34YQ4CcgexAgmh7XiH3e0S57qtrrxzSpE87pIiF
// SIG // i7jG2UkUQ8aKOGMzt8QXm0Dg8t10WUdjcFYsvcAGqeba
// SIG // Bz4iKFk66DRBYzseQIVL5Q0JMt6dsaGsCuriya1luWuz
// SIG // FOlBUgduaZcrzaGWzXFjs9Jux9YllOkl5hplxqn/4TFM
// SIG // YIgx+BUbHc/XngmS91cYPjBs54WCU7D9K70KQWRTPERO
// SIG // mjRYoW1Q3fzIBpqYgcPFHwZLz93RSf82bvAlHcun4ZAJ
// SIG // wM0UNoFfWsU=
