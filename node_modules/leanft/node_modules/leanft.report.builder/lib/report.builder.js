...
var iconsFolder = __dirname  + "\\..\\icons\\";
var extensionsFolder = __dirname  + "\\..\\report_extensions\\";
...
function processConsoleRequest(reqeust) {
    ...
    if (status === false) {
        var msg = util.format("XML report file %s could not be found", xmlPath);
        process.exit(-2);
    }
...
function getEmbeddedIconStyle(iconKey) {
    ...
    var iconBase64Str = base64_encode(iconsFolder + iconKey + '.png');
...
function generateHtmlFile(jsonFile,cssFile,resultFile) {
    ...
    // styles - style.css
    htmlContent += fs.readFileSync(scriptsFolder + 'style.min-dyn.css', 'utf8');
    ...
    var resDyncFile = fs.readFileSync(directoryName + "\\res.min-dyn.js", 'utf8');
...
function appendAllFiles(directory){
    ...
    for(var i=0; i<files.length; i++){
        ...
        file = fs.readFileSync(directory + "\\" + file, 'utf8');
...
function getIconFromJson(obj, array)
{
    for (var k in obj) {
        ...
        if (typeof obj[k] == "object" && obj[k] !== null) {
            ...
            if (obj[k].Extension && obj[k].Extension && obj[k].Extension.Any.IconKey){
                var icon = obj[k].Extension.Any.IconKey;
...
// SIG // GCDX0b9XyD1c6/zfNtQzQvjWJjgZ7H5CS4rdcp/I7kKg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBG
// SIG // 2LoiBnwz9Fq6LudyWVCAiBemIdfiHk7KnVjZLGGmPjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQB5Bl/aCBAL6CfJeK4wnALi
// SIG // oOM9xj7iFv9JKv55Y2X6tUXQYTnIK6fb2dA0cR8BWEJv
// SIG // FJGPXimgzQgVTJsLmzQdcp8mMyOum9YNjXS8UiH2m4fa
// SIG // zq+d5nsckKRE2XCbe2OuGKpPjiIqy3NzLa3c+/WSdVEb
// SIG // iFGuhjmm2bQWf5sBTJTsEeTu5L2zH1ia2N9NvEjO4MAQ
// SIG // da3kgjMNZUxoYXB/+9IFnTrVyzNIh9HVfs+pOdhXQo/2
// SIG // oI5Wha1C6D/uOq4v4m2IpGNA7wCxhbAkkC2IMs01kRFh
// SIG // mWpUuDxtGXS6yOCrhHObEU6I2ug/E/6OX6cle7liJHBz
// SIG // DxJu+XXTHO+HoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTIzN1owIwYJKoZI
// SIG // hvcNAQkEMRYEFDRn95oJPJZgDv/p71qqhJyECeoPMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAAWvusKobDAEb+KKm9oe3b6L
// SIG // WXuUX7W5GnUyk40hNJtut9Wyu5A42mFn+NtZR8+FJphj
// SIG // FVG91Fh/VeaY/ui4vrecQK81UVETR3MvwjDgZ0KHLYil
// SIG // HZ3jDcZt7+J9X8N+zo+jdSQ2HVsP8/Qfr9oW/zc22UF6
// SIG // 1KJNZntOD2qQj6gcHosvVSVKgtEcWTnyUHAvSqsKsk4z
// SIG // a2QiMbyoYEJdkyQ6X1MzV2nKy6hVGdWOfd7h0f6EroKf
// SIG // 71WaRe2nqlZ0ZlTQddhlSHaQbrfKj7tLWga2MvSEUEPD
// SIG // +jdXdv5C3W2AaoeJnLxLTJhCjIY4XiJ5XcF1OX0RJRQ6
// SIG // uvueIWgzJDo=
