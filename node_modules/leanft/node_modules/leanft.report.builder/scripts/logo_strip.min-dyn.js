function LogoStrip(a){this._cssNames={stripWrapper:"logo-strip-wrapper",strip:"logo-strip",logoIcon:"logo-icon",iconBg:"bgicon-logo32",logoText:"logo-text",languageBar:"language-bar",firstLanguage:"first-lang"};this._dataModel=a;this._stripWrapper=__uiElements.create_div().addClassNames(this._cssNames.stripWrapper);this._strip=__uiElements.create_div().addClassNames(this._cssNames.strip).appendTo(this._stripWrapper);}LogoStrip.prototype.show=function(c){if(c&&this._strip&&this._stripWrapper&&this._dataModel){if(__res.preferredLangId!=__res.neutralLangId){var d=__res.getLangDisplayName(__res.preferredLangId);var b=__res.getLangDisplayName(__res.neutralLangId);if(d&&b){var a=__uiElements.create_div().addClassNames(this._cssNames.languageBar).appendTo(this._strip);__uiElements.create_link('javascript:location.search="'+this._getNewLocationSearch(__res.preferredLangId)+'"',"_self").addClassNames(this._cssNames.firstLanguage).setInnerHTML(d).appendTo(a);__uiElements.create_link('javascript:location.search="'+this._getNewLocationSearch(__res.neutralLangId)+'"',"_self").setInnerHTML(b).appendTo(a);}}__uiElements.create_div().addClassNames(this._cssNames.logoIcon,this._cssNames.iconBg).appendTo(this._strip);__uiElements.create_div().addClassNames(this._cssNames.logoText).setInnerHTML(__commonUtils.general.getValue(this._dataModel.logo_text,this._dataModel)).appendTo(this._strip);__uiElements.create_cleardiv().appendTo(this._stripWrapper);this._stripWrapper.appendTo(c);}return this;};LogoStrip.prototype.getTotalHeight=function(){if(this._stripWrapper){return this._stripWrapper.getHeight();}};LogoStrip.prototype._getNewLocationSearch=function(d){if(d){var a=location.search;var h="";var f="langid";if(!a){h="?"+f+"="+d;}else{var e=false;var l=a.match(new RegExp("[?&][^?&]+=[^?&]*","g"));if(l&&l.length>0){for(var b=0;b<l.length;b++){var j=l[b];var k=j[0];var c=j.slice(1).split("=");if(c&&c.length>0){var g=c[0];if(g==f){h+=k+g+"="+d;e=true;}else{h+=j;}}}}if(!e){h+="&"+f+"="+d;}}return h;}};
// SIG // Begin signature block
// SIG // MIIdhgYJKoZIhvcNAQcCoIIddzCCHXMCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFLBLJuVRnYB7
// SIG // H0m5duJezAB0tHOWoIIYtjCCA+4wggNXoAMCAQICEH6T
...
// SIG // DQEJBDEWBBQ3a8A81AAVqea+lWLrb+mA7Sw38DANBgkq
// SIG // hkiG9w0BAQEFAASCAQByD767KsuGGdS6zVHlsJ8r/IUn
// SIG // 7002VzGou3UTYRstieoWnhqwzkI3Cro5HeFXlpjjlHEo
// SIG // zsPg16NzvjZGU8zsSUOqb+fpkUMx7sWdBMWRlbbVUqcw
// SIG // A1OQ9KiVKxm851M9GTgkB2r4zE2IVmxrFVbWLf8QQlns
// SIG // xhODfVF/b6qRH3BbEnHw0V8iFAXRQQRj+9mLBhzypq6F
// SIG // N9ZfekNxNuDgjoPUShHms+zqyRITp6UCNBWLb0SiYKPo
// SIG // XjAMF1vc743QlJEZF3y4hA/WxVxIX1ADjNgmiAtzJ939
// SIG // XgJrxN6acSRF8JnH6dTSShuBMbci+D9zNsuZgY8UCmkb
// SIG // Ay4iKEvuoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0
...
// SIG // hvcNAQkFMQ8XDTE2MDUyMDIyMTgxM1owIwYJKoZIhvcN
// SIG // AQkEMRYEFEvcnijkIyVrd1L7MMJeNLaYmDAbMA0GCSqG
// SIG // SIb3DQEBAQUABIIBAJbXPhBsTJBccEddgbY7+iXNw88w
// SIG // eUWPMsqdzSXrF4HB0KgdgfVJw1UQvZrAxu1DuMwFBV0B
// SIG // a4Zc0i6kfnQ14tstJnTfTURIbmAWp+lPr9oyNxfMlr3o
// SIG // x4c6zMcp3U1KJQh5I7ohFMcc+EnIDAg+PrOFRUfFsLk1
// SIG // KpSbbCR5G2Ac8V2MpI1v5nvDFuWMBwdBpZOPQLKRUehz
// SIG // ft26sNVQtIaSXipphY3BOTyikrDU8hlZpIzAU7B6mWrk
// SIG // TwSf+sFg6X0dKyAqC99NZ8xlyU9Je505lERmlNDMqyr3
// SIG // lDBdo2r9YeTOKGnhcrfchD2YoSr77Rz2vjyAxHd5UnD2
// SIG // a124nkw=
