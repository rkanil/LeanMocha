function PageRender(a,b){this._cssNames={pageWrapper:"page-wrapper",reportDataArea:"report-data-area",leftPaneWrapper:"left-pane-wrapper",leftPane:"left-pane",rightPaneWrapper:"right-pane-wrapper",rightPane:"right-pane"};this._dataModel=a;this._pageMinWidth=b;if(!this._pageMinWidth){this._pageMinWidth=600;}this._pageWrapper=__uiElements.create_div().addClassNames(this._cssNames.pageWrapper);this._pageWrapper.setMinWidth(this._pageMinWidth);__callbackCenter.registerCallback("window_onresize",this,this.layout);this._widgetsStrip=new WidgetsStrip(this._dataModel);this._infoStrip=new InfoStrip(this._dataModel);this._reportDataArea=new ReportDataArea(this._pageMinWidth,this._dataModel);this._logoStrip=new LogoStrip(this._dataModel);__callbackCenter.registerCallback("layout_infostrip_showmore",this,this.layout);__callbackCenter.registerCallback("layout_infostrip_showmore_async",this,this.layout);__callbackCenter.registerCallback("layout_infostrip_showless",this,this.layout);}PageRender.prototype.show=function(){this._widgetsStrip.addReportCaptionWidget().addStepsCounterWidget(true).show(this._pageWrapper);this._infoStrip.show(this._pageWrapper);this._reportDataArea.show(this._pageWrapper);this._logoStrip.show(this._pageWrapper);this._pageWrapper.appendTo(document.body);this.layout();return this;};PageRender.prototype.layout=function(){if(this._widgetsStrip&&this._widgetsStrip.updateLayout){this._widgetsStrip.updateLayout();}if(this._infoStrip&&this._infoStrip.updateLayout){this._infoStrip.updateLayout();}if(this._reportDataArea&&this._reportDataArea.updateLayout){this._reportDataArea.updateLayout(this._calcReportDataAreaHeight());}return this;};PageRender.prototype._calcReportDataAreaHeight=function(){var c=document.body.clientHeight;var d=0;if(this._widgetsStrip&&this._widgetsStrip.getTotalHeight){d=this._widgetsStrip.getTotalHeight();}var a=0;if(this._infoStrip&&this._infoStrip.getTotalHeight){a=this._infoStrip.getTotalHeight();}var b=0;if(this._logoStrip&&this._logoStrip.getTotalHeight){b=this._logoStrip.getTotalHeight();}return c-d-a-b;};
// SIG // Begin signature block
// SIG // MIIdhgYJKoZIhvcNAQcCoIIddzCCHXMCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFJzTvBvRTrMm
// SIG // 4b/HL67BsdN4KLDnoIIYtjCCA+4wggNXoAMCAQICEH6T
...
// SIG // DQEJBDEWBBTBACVhuQxOYsQxki7ZgBvEqNM7bjANBgkq
// SIG // hkiG9w0BAQEFAASCAQAmMWNb+D7havdtp7kTVIwylEQp
// SIG // 9flAj7c3TmXze7sF7me1gFkGBGqA/GNxG3q+5z2qJXLg
// SIG // iE+PSoG988DFWGZ/u+qYJrXWbpBBDn8JTwGAPW2fno/7
// SIG // tTGpHebe9uvfu3wpPlp/vLdhX28uT0HBVzOBpXrUNZsQ
// SIG // Kl/OuPIvw76Y+QjDV29O2H5jj+sWlqRFd3O+t4yiVgKw
// SIG // PUw9G3s4KZGT2lwqsFLxdouW1CGHntXmtklnfv77hpIU
// SIG // qPYFLB4A8yC9GqfVxWRaeW9VE+vegZIi3CyDdn+F3mrc
// SIG // lEvRAp09lxtRfEiUsdEhP0+3QQvdg+F7qu9UrXH3AfZl
// SIG // EDc19FvpoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0
...
// SIG // hvcNAQkFMQ8XDTE2MDUyMDIyMTkxNlowIwYJKoZIhvcN
// SIG // AQkEMRYEFEdsF7x4mQFelySK5G6HdkDmzBh7MA0GCSqG
// SIG // SIb3DQEBAQUABIIBAD0M7OtXcb9tHF5SGkWblTEzD75L
// SIG // c18049i1+UpiuTBGZS1PU8jC/+jQEXHPvVYKgZ6vfzNo
// SIG // Im/DE72SZgNdq6Ynv9ktSgJYzqyMn0rakCz+9zChcUj2
// SIG // WhaGu8hsLnW2bEfn/oKz7lsjGCjwK0canjqQbNtKem5F
// SIG // XfpWroR/t10eDq7EaNiC8Gq9b40+hd330d2vra9mWu90
// SIG // nuYm3KPtCPL6tbJ5hqsNDdyDCY2/mZCA2DnWlbzj88Tk
// SIG // lTTf8zwrSFb+YX+8RHTj7gGK32Nfj0eqdprEbhsoGEsN
// SIG // gw6jm+Pw289YySISpcJSIcloUwt+5wsWtEgzQrdZyT9a
// SIG // Pm0VObc=
