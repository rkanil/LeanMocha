...
var testDone;// = require("../lib/promise_wrapper.js").testDone;
var failTest;// = require("../lib/promise_wrapper.js").failTest;
...
describe("PromiseWrapper unit tests", function() {
    ...
    describe("then method", function() {
        ...
        beforeEach(function(){
            ...
            testDone = promiseManager.whenDone.bind(promiseManager);
            failTest = promiseManager.failTest.bind(promiseManager);
            promiseManager.init();
            ...
            promiseToWrap.then = sinon.stub().returns(promiseToWrap2);
        });
        ...
        it("should return a PromiseWrapper of the returned promise", function() {
            ...
            assert.strictEqual(result._wrapped, promiseToWrap2);
        });
    });
    ...
    describe("testing with real promise", function() {
        ...
        describe("then method", function() {
            ...
            it("should call rejected callback if fulfilled throws error", function(done) {
                promiseWrapperUnderTest.then(function() {
                    ...
                    done("Fullfilled called instead of rejected.")
                }, function() {
                    done();
                });
            });
        ...
        describe("catch method", function() {
            ...
            it("should propogate the exception to the first reject callback that is provided and not call catch", function() {
                var error = new Error("someError");
                return promiseWrapperUnderTest.then(function() {
                    throw error;
                }).then(function(){
            ...
            it("should not execute other branches if an exception which is not caught is thrown", function(done) {
                var error = new Error("someError");
        ...
        describe("testDone method", function() {
            ...
            describe("should allow chaining new promise after a done statement", function() {
                ...
                it("part 2", function(done2) {
                    return promiseManager.rootBranchThen(
                        function() {
            ...
            describe("should allow chaining new promise after a done statement of a failed promise", function() {
                ...
                it("part 2", function(done2) {
                    promiseManager.rootBranchThen(function() {
                            assert(testDoneCalled);
                            done2();
                        }, function() {
                            done2(new Error("rejected called"));
        ...
        describe("failTest method", function() {
            it("should call done with error in testDone if failTest is called", function(done) {
                var error = new Error("someError");
                var doneMock = function(e) {
                    assert.strictEqual(e, error);
                    done();
                ...
                promiseWrapperUnderTest.then(function() {}).then(function(){});
            ...
            it("should call done with error in testDone if failTest is called even if no promises are used in the test", function(done) {
                var error = new Error("someError");
                var doneMock = function(e) {
                    assert.strictEqual(e, error);
                    done();
            ...
            describe("should allow chaining new promise after a done statement of a failed test by failTest", function() {
                var error = new Error("someError");
                var promise;
                ...
                it("part 2", function(done2) {
                    promiseManager.rootBranchThen(done2, function() {
                            done2(new Error("rejected called"));
                        }
                    );
                });
...
// SIG // NATZE7c4DseySCfFJijKus003eHJ6to3TbCPk6tPucWg
...
// SIG // IQ/blEJ1wk45O18wbNEF8TB8KL6rBtom3UcGOOdHRTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBgdr/+NrtYHa7XYEDWH9zN
// SIG // VCcsifVIjgdH0F1VYJqOUuZohwj2K0bGqAIV6+vci2K6
// SIG // TE89AZVxhLtRQDwj+xkkBKXHUanA6sXS1oZ0voS5OCKI
// SIG // VnSrQD6+FK6slzkrq2IK0vmvHx0zVapXMOUqTbKWE90B
// SIG // fKlZliOJLjv0va4FHtTezWLV3cK3Hc6Jaofwu9X/Fr3q
// SIG // bxO/asgWOxrcqEtcYLr4uSmy2Ok0klXmNVJ1Rx3xRmjD
// SIG // kX7g01o9AxnQUBiyl/EINxeTxSVnObn4XmE66iXpLrCH
// SIG // K2E0f5NeHErKfmY6lVFNOFeQIlgcA0VChCCrtkK9IDhT
// SIG // rNfTwA2N0pcyoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTUwOFowIwYJKoZI
// SIG // hvcNAQkEMRYEFJwPuGhSp6CMQXCrYBq2HpAU110MMA0G
// SIG // CSqGSIb3DQEBAQUABIIBACfWPOCNviI+BMSRWi50yrWS
// SIG // MDvxS4AYpwJHyCilCzkINrp8xs6t0wObU251yKFjL9Bp
// SIG // 3Nrfkh1MMiq900jkJhMxhHjd+d52QXbQcdTt2Thw6GOV
// SIG // 8OHLSt49/JVjxwNYAb+l3y5sdOxkUFXYF+8hAC5s6BJs
// SIG // lcUF0Omw4gwWkBYulw9Mh4CmvH4hKC85+YQVHBKkCyjl
// SIG // Sj067PKb0ZCjVfefSBc6iaTb2Pus5FgiTsaF0B4VCKgz
// SIG // nTzfOSNLclPTZmxoxBMaFhBNqRh7jE3ur8xk3u8mt+Rf
// SIG // mF/EIHMRMZtM4TwuDQZl/VDZtPkECgoVctj1amYzOmfl
// SIG // w0571Sv7pjU=
