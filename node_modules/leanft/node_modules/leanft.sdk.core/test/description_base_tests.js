...
describe("DescriptionBase",function(){
    ...
    describe("index method should be called and except a value", function() {
        ...
        it("when index is given using property bag, should initialize _index",function(){
            var EditDesc = require("../../leanft.sdk.web/lib/edit.js").Edit
            var editDescUnderTest = EditDesc({
                index: 1
            });
            assert.strictEqual(editDescUnderTest._index, 1);
        });
...
// SIG // xHm0wnJxmIG67y/isy5Ri7paNA/PLUGEbLxPhhv9CP+g
...
// SIG // HGIExoM36Xixsqjhh0a1e+g3vK+dhgbnxCrQwrjJfDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCtAy4EvwO0rYLiMBY7wBZQ
// SIG // GtrR7J4YFZLsVK8nRgfyjSrDrwiXxARTaIayxKGgnZze
// SIG // BhUIuAzQ0Ecz8+FgH68Gh8O+wBdlNnKSA1FYGzHtKd3X
// SIG // HiG/rdNasm7JzMyedz4P9iTOxTA5/fEG2trCkW7cDUsQ
// SIG // oN8QGh7ZCVntRZtT4qQqEaoF8jF4cvDpWZBAeiqQCHSw
// SIG // cyccqXqsOZnmIaRiQ7EWD+r5qk+ACTXrwTM4uuJOBE97
// SIG // eg/qtH4tKt2Nd9eO5hFs15vh9a0bffLNz8/191ZaCdER
// SIG // GWsj/f4eqaCz9C33QXxwnw9e3fO5XGiAn3zpUUTGT9r5
// SIG // UM1GY9k9DRXQoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTM0M1owIwYJKoZI
// SIG // hvcNAQkEMRYEFNcDstrU+hFG6H3s+nLRd7dtxqQ8MA0G
// SIG // CSqGSIb3DQEBAQUABIIBADlcOGl65NnxmtLLSeXO4Zog
// SIG // VGXQHLuXzRYRp9/BG1SwOJy5Dr1SjWiF/O2X3GHlyhs0
// SIG // x4ge5ZHSQmjn7zvcMN37h84zQQQFGrT+Psm9sMNQQgqe
// SIG // C3cDdDsDhU5tOCgIio/JIAGtpOSSsDSv0r4VdSgVBgGh
// SIG // W1o9Odnsn+cg/me1Uzw7doBwjO1mT7xsUcHT5uPcv44E
// SIG // H8gdtNC7NAISbfeVhLsLtjK99K9AYyR5J/pGUDVMPv2C
// SIG // AMD0JMdOMJSzzKHqPI4J/L3Ekknpfe0dEpLWruK2wR93
// SIG // SPXDeiF4vNbbCQTP0FZQ4QOhXac+lQgeigLJVJfhSe5u
// SIG // rumi0LQULTs=
