...
var DragAndDropBehavior = require("../lib/drag_drop_behaviour.js");
...
describe("DragAndDropBehavior ",function(){
    ...
    it("should throw an exception in case target does not support drag & drop",function(){
        delete targetDropTO.dragAndDropOn;
        assert.throws(function(){
    ...
    it("should use left button as the default button to drag with",function(){
        ...
        assert(sourceDragTO._executeCommand.calledOnce);
        assert.deepEqual(sourceDragTO._executeCommand.firstCall.args,["Drag", Location(null), MouseButton._convert(MouseButton.left)]);
    });
    ...
    it("should use the given button to drag with",function(){
        ...
        assert(sourceDragTO._executeCommand.calledOnce);
        assert.deepEqual(sourceDragTO._executeCommand.firstCall.args,["Drag", Location(null), MouseButton._convert(MouseButton.right)]);
    });
    ...
    it("should use the given drag location",function(){
        ...
        assert(sourceDragTO._executeCommand.calledOnce);
        assert.deepEqual(sourceDragTO._executeCommand.firstCall.args,["Drag", Location(dragLocation), MouseButton._convert(MouseButton.left)]);
    });
    ...
    it("should call drop on target with default location in case not provided",function(){
        ...
        assert(targetDropTO._executeCommand.calledOnce);
        assert.deepEqual(targetDropTO._executeCommand.firstCall.args.slice(0,2),["Drop", Location(null)]);
    });
    ...
    it("should call drop on target with the given drop location",function(){
        ...
        assert(targetDropTO._executeCommand.calledOnce);
        assert.deepEqual(targetDropTO._executeCommand.firstCall.args.slice(0,2),["Drop", Location(dropLocation)]);
    });
...
// SIG // v7rhS1VrYi/9TWEzyjUrH7B1naYiPd7GyrZ3lGivG5mg
...
// SIG // hu+hO6UAk637pUUJJbuJnRSoJRNZR1E/SumVe+M1qDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAeODTLXhLwQ88OelXAeXiC
// SIG // aVMnfYH2rFvRcy2+bmlXgeX+VJ8ivSHQ+UhvTcl/hTXF
// SIG // ggwdwrELHTD+64GbwYFvbD3miIrUVrVg6YCHDWyjDBMn
// SIG // lzNzSB7FzJgP1xXoBsXCVzGZfQTxNaGnW7q2NUXgnhsj
// SIG // wZ7P9nfFZZPswcAToPzSP7wg45VYmpeg6RGGfLn8vddQ
// SIG // pn2PX4tD9eCx/ptM4JjkDTpVbO1XQ8Z74NNbJAdCckOl
// SIG // nb9rRHwBnWhPvbPWNqrWPeaBShUhHirpWNJBaX6vR8OT
// SIG // bLL43vu3Bbwq1XsrvoaKS4ORQSbu6g1cxq3LkOTSyI+7
// SIG // B4dDQlWSoQoWoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTQzM1owIwYJKoZI
// SIG // hvcNAQkEMRYEFCoaQ1/TcYkciXiTW+c+1vfLNjSJMA0G
// SIG // CSqGSIb3DQEBAQUABIIBADmI5UeYeioYHwFZJ3hcq/6Q
// SIG // Xzx3QkMANsgwypErYN0ShS4KijY9bLXiRNRESTr4BUCd
// SIG // xjhTRbfYblkoeHOXjvizv0c16r0OXP+koTIBW364x4za
// SIG // c0lhq9OCvSmekQeb7a4vJmBZi0kTmr2/UvHkcSaGfDIu
// SIG // qxF2JV2QWK/b2xxbDGTzLswwW+NT3dU5C0OfO/pCBgGk
// SIG // h2rKl50On6FOr63rIjo/UnkUYHqQoGlO+/2OZDV/hf9v
// SIG // OjxerFHV+SejFPQzPAZGe+Q7jdl4ZhcFIcWPRSm4vx07
// SIG // 4Cz6oVAMFeDuCHeWmoMtnruDYonuhrl+uWPkxlY4ss2y
// SIG // LIUknjAkzZ0=
