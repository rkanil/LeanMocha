...
describe("CommunicationClient unit tests", function() {
    ...
    beforeEach(function() {
        communicationClientUnderTest = new CommunicationClient(undefined, promiseManager);
    });
    ...
    describe("Construction",function(){
        ...
        it("should construct a web socket channel with the given address",function(){
            communicationClientUnderTest = new CommunicationClient("address");
    ...
    describe("connect",function(){
        ...
        it("should connect to the channel",function(){
           communicationClientUnderTest.connect();
            assert(channelMock.connect.calledOnce);
        });

        it("should send the new session message type after it was connected",function(){
            communicationClientUnderTest.connect().then(function(){
                assert(communicationClientUnderTest.send.calledOnce);
                assert.strictEqual(communicationClientUnderTest.send.firstCall.args[0],"NEW_SESSION");
            });
            assert(communicationClientUnderTest.send.notCalled);
        ...
        describe("handle response",function(){
            ...
            it("should use general run error exception type in case the error code is unknown",function(){
                ...
                return communicationClientUnderTest.send(null,null).then(function(){
                    ...
                    assert.strictEqual(e.message,"GeneralServerErrorException: SomeMessage");
                });
            });
            ...
            it("should add the error code in case error message is not present in the result",function(){
                ...
                return communicationClientUnderTest.send(null,null).then(function(){
                    ...
                    assert.strictEqual(e.message,"GeneralServerErrorException:"+" with code " + 42);
                });
            });
        });
    });
...
// SIG // lPhBCzl3Xs2IeZbHOa0BygW12vJRPP35OLOHHuL0kOKg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBQ
// SIG // STeZKKDhN/eq3/odG6BHFLW0LbhIUgaBJXw2XY1CajAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCz/EUO//7/JU6esLFbNcyb
// SIG // /IIpqodfKjgIcticC06fP5jk6JlLed/fqm/r5/6FsC84
// SIG // NqI8IWHkV7+/H0tX7xCMP+Tnclq3jkXVGUXFBEZt2r5j
// SIG // lm1vVG9cGlHQ54NohM3487MxWQqD8Cjkune5jtYq9R34
// SIG // vtCTrqtyCJym/F+7j4gqZrUFu6n8L2BjASbJ70/Yl4zE
// SIG // Fcc6n2hwY8raetZZdNLlVjngJRKvSumG6tNMUcdIrO1y
// SIG // la3/rx4i87LokxLaBBrW3c673K3Jr3E0CXm/jYBTqSuZ
// SIG // Sx4BPHqrfJKNtK2zR31bjjD52U305ZhGu/8bZgonrcHc
// SIG // VtaKqwm1FzgioYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // hvcNAQkEMRYEFF7Yox3owb8nDc75VUP4Gzr//9ziMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAB/VcxXxhT3o25EWuHUByzgz
// SIG // u4ajW7eTRozxbNc1agiHWl1NtW7wXpeZxz0M4ukC9Jrd
// SIG // CWZsO99cIPqNOx9YWfyTxaL6rbavs3VFPMgxkgdity5w
// SIG // ZXEghdIcsjRANx2/B6h79M1jB3r8CcuBdIg6ud4ciRlZ
// SIG // vD1Hu8mVwTPNdRfmH5dmaRn1M3buFSoZX7GlnYd6I5PT
// SIG // 61yMtVt5ckdv3dAsaH1E/lmonJjNf90BWlNBepY56ag9
// SIG // dlaP1KFscGgb9E07kbyjva/8P9hqEF12b1kvx7pahPQ6
// SIG // +VD+wGjz2FXUMlqLX/zq+BzKb2wC88iqTVkC+y72NNU5
// SIG // XCSb2nz4ycY=
