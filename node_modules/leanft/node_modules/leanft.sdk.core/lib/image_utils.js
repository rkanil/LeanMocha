...
ImageUtils.prototype = {
     ...
     * @param {String} maskAreaImage A Base64 string representation of the image to compare to the expected image.
     ...
     * @returns {Promise<Boolean>} a Boolean indicating if the images match.
     */
    compareImages: function(firstImage, secondImage, maskAreaImage, pixelTolerance, rgbTolerance){
        if (firstImage == null)
            throw new Error("firstImage parameter must be supplied");
        if (secondImage == null)
            throw new Error("secondImage parameter must be supplied");
...
// SIG // HS6LXQQnufxqpziGGqC4m2xxBC9njP4OvNjG7hZyT1yg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAd
// SIG // quQtxN9W+VE86euLxVkebLjh7OmS5zxKe15gPGW09zAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAD+BnayAOuYp21UUiWVMt4
// SIG // CtyxVUZFPVDZQ03HVKKM0AMhKQyN0tXqjx4ruJm8yAO+
// SIG // zF9uGYU5WNElFXird+afIsOaw2u7uLLjQ3FoOGWme+L/
// SIG // 0z7vG40zdErIq15SdiJB4Of7GM4c2CQOp6DoxMNXI/bk
// SIG // UzFDP2qnVtjHXkuVNJE3WxUYQMgnt+GD0qFJdNlM7bnZ
// SIG // LzKIwIEnioYJG7GXp/RYSvaYswFIaAUghG8kgP/y+W8G
// SIG // 9ojZMTb9AOT5fvqHdodSRbgqHbWWQLEPq2AuBal4TGqY
// SIG // jRapOG3e4J19FxWsw4/tVYts0BwIJsOnL6DF+WN8jfgg
// SIG // nWDVn/i5esXXoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjM0MFowIwYJKoZI
// SIG // hvcNAQkEMRYEFGUXbQQK5Y9s9m7LQXrS/EqdSIM4MA0G
// SIG // CSqGSIb3DQEBAQUABIIBAEHDp3Yovo+CXECtCsuxOc4M
// SIG // UwvZ6F4TT7YfhbhGtoWYEhpz/ztxvAQAXikfN7ICOpAd
// SIG // YOt6y9gkBRWHQOWsLPFSljtSwAuGxPRmedxXqW8iTLVc
// SIG // AXaaLqoNB6ta43aQGK+qdRbazf7pybW8eg6+KW07UO17
// SIG // jlQGQo6zt+TU5K+L/Zy7LLII/kcT9sqNbkpPMIrmrZxt
// SIG // XaHWbIFLW6Q+LXCuSlSvej4gglHUMe8/LxI1RKU9CUXF
// SIG // uMSnp8R4Q09x+9+I3RryA1h0oFU+l4L/ktbsg4sI2g4y
// SIG // AaXwWPCMYym/6fzJhjwJN0UDN0P+w4NnhwCrdJ6g/AVT
// SIG // +lP/PFnRtWw=
