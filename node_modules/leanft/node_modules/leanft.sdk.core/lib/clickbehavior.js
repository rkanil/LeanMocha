...
var ClickBehavior = {
     ...
     */
	 click: function(args) {
        if(!args) {
            return this._executeWithEvents(arguments, "Click", -9999, -9999, MouseButton._convert(MouseButton.left));
        } else {
            var button = args.button || MouseButton.left;
            return this._executeWithEvents(arguments, "Click", Location(args), MouseButton._convert(button));
        }
    }
};
...
var DoubleClickBehavior = {
    ...
    doubleClick: function(args) {
        ...
        return this._executeWithEvents(arguments, "DoubleClick", new Location(args), MouseButton._convert(button));
    }
};
...
// SIG // Hs2a8PPQSnjTyQhbaj/j+bzQzCh8VqeR6bsw9I5H56Kg
...
// SIG // eQoN9VfsxLit35BYJRPBzEwJPU2dNJyXY2GpdwA5BjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQApcvKHq2uFMZEtCTnrgkY4
// SIG // Ppz+CryFO9Z58XUJrQ/HpMWtmW9E2yHxDC1iZ82tmOPe
// SIG // 9Z3RAo5QUEjKdHe0hGHXVqoJSapcZZ+ilgLvzZ/tGhzw
// SIG // 4ih7gXeMwvuFKorKz//PpPnR+XuYl2lgfwsGN1txKOxu
// SIG // N6Oo1nKdIT7gNd1bGedhJlRaewh7yCKi91JDHWcKcyAJ
// SIG // T5j6c5VwDimemnyga7unNtqN4FJloPmk/7yqgGuBFNJf
// SIG // kY5sgVcYaqRFd9kYV0XS6YI1EgD6VqJF/oT3P8yX05Dw
// SIG // N8AY0lJ0Q3JBY45Sg7meV1jH/Qy7n26c6BfbsS+uPL/E
// SIG // bDhpNcqAwiCJoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTg1NlowIwYJKoZI
// SIG // hvcNAQkEMRYEFPtv/b9XjN0SQsMxDS/c08IgPp4gMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAIbAMZD9TDVAI8DTb/25LHjv
// SIG // 2bQs1ifo258ti7jTSuy5kv5HUXXfr5PzxZR61yVBaMjR
// SIG // QOj+IhyNbZg6kcIdVaTn3vB5yrsf6n8rQPWVe7T0M4hi
// SIG // 1buu06eSMTvR27D8Ms694OCLfIa2gwKXdAUDtzmXs+Wa
// SIG // euGRgSj6025NqNcwVnSuPT5bMc+5OK4hnQLQgDJuTGDq
// SIG // PBEuWfHsFXMtFFa+lApSc6Bwm44lACpr4tI0Lak6vI9w
// SIG // rd/0HDFEGwr6mLm/C27iNSZFM8Vxd0XkvGN5+8SEe/51
// SIG // 7WBegYV5Dz0d67yrUV85GYaTCm4qj+gX2uBrsOzSXQys
// SIG // ScB3SDQ9Yfs=
