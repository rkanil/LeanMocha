...
WSCommunicationChannel.prototype = {
	...
	*/
    ...
    send: function(msgToSend,callback){
        ...
        var requestID = ++WSCommunicationChannel.prototype._nextMessageID;
        var msg = {
            requestId: requestID,
            type: "request",
            data: {
        ...
        this._pendingRequests[msg.requestId] = callback;
    ...
    _handleResponse: function(msg){
      this._logger.trace("_handleResponse: Got the following response \n" + JSON.stringify(msg));

      if(!this._pendingRequests[msg.requestId]){
          this._logger.error("_handleResponse: The response is for a message that was not sent " + msg.requestId + ", ignoring it!");
          return;
      }

      this._pendingRequests[msg.requestId].call(this,msg.data.data);
    },
...
// SIG // Tp8ZgJmFHNzaBsObjCJG+A1xLDrqpqIWhjCFh166FOug
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDk
// SIG // 3v+Wg4y4JtY4gNrkRFeTD0jTD1W6xAljARjJukk14TAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCeGe4iOdE8/RXGRTKwN5nm
// SIG // xa0Ebb8NhcTfx34nsZLaOsJr6YFXykhsZsHOSrHtZU43
// SIG // qwiVKFvqTA+suaGxSIEDTWtHtlhxlQAr/uMwXe25UyvE
// SIG // AfEd38fWck8HkFCVvjx/Fm/JdbsIS3ZRXy/cmvd3W6zm
// SIG // 7HJc+Rf/oILMJoFEtThP1tbk5EsNjl8MG0bI8cujK6YP
// SIG // LQguWzEBhjS8ngAQxNQU2snxUTlOJWOZ58k18XzqnM8t
// SIG // Is1Pl1ecIJODg8vpICraB5y+MZDyC9cHe3spFyscWkRe
// SIG // G9qvDXnpOba+6u+Qx8d3N2GyVqr+RI4nYqFSjDCQcBoo
// SIG // s1+g9cpmZzCjoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjExM1owIwYJKoZI
// SIG // hvcNAQkEMRYEFJ15EeS7bou3RiBjrrZD3EB66b3TMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAD/1xIkw0aiQCteJL9uCvScs
// SIG // uKCDFvfsEkUAsbAxO2NWLYMDz/ph+B0PNgNEz5ibcAuL
// SIG // ieoKNHDT6BYHBmyTB/Qo7wZDXHol98pZNWF+Ucr1J/NC
// SIG // yNKCBROCEWhKEC/IXGyC8kkdlv7PShODTaHCr9sb0vls
// SIG // iGI2WXWGN+zOlqDQ2EE69WFcNH1hIVYsBmK/OifZnO0w
// SIG // trBCY8kHieP+ZvZ8DpAxj4CZSpXFfp4ZMCwxUCf7Ai2p
// SIG // qYdkudBn2rrO7qwFCtxZKM5/nG4nA/G1ccWnuAttQc1I
// SIG // hoQtG3rUCMZYmcPw33E9n596d2xd+EgIEvjfNM2p1jNB
// SIG // kpq+CbOeso8=
