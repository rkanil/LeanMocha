...
var DragAndDropBehavior = {
     ...
     * @param {TestObject} target The target object on which this object is dropped.
    ...
    dragAndDropOn: function(target,dragOptions) {
        var func = function (id) {
            ...
            if (!target.dragAndDropOn)
                throw new Error("Object does not support drag & drop operations, and cannot be used as target");

            this._executeCommand("Drag", Location(dragOptions.dragLocation), MouseButton._convert(button));
            return target._executeCommand.call(target, "Drop", Location(dragOptions.dropLocation), this._notifyAdditionalData.bind(this, id));
        };
...
// SIG // 1EaTZs/3AQfYmpEvgQySOp+vXqJMbfg1RJf0m2XBuUSg
...
// SIG // lEOz+CTGqn6sZWoEtoQqaGZpimO8r2QGYzQg7LT+mjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCOHAbh8F4Eql3GpY8WLT95
// SIG // DY8M4ZZkli6PwRugrKQcn9YTNKiTcO9ncc+gvxkeWCOM
// SIG // GpM0kr54kDMOuyDXlSrtShmcZQM0JF/T0XGwq4Xn6ztk
// SIG // 1YSq3A5rj/RWEOx72luYOWHKeR1XHNQ4Ekj4LxWakU8Q
// SIG // AEQVarQEc7X/IUu77YxoKVuW47ImTimgiMXywOGhRjB9
// SIG // ahhSgrFvtmDGDy1iElsN1Ypp6OwRznF2S3BU64ESTRiS
// SIG // tbC2ZAj+1x72vBimuOsp7QhNEVOKibb+0YHdWJEQPhp/
// SIG // iBU0Eu+6+wDiQ5eq2OjM3i8aPVxvXguM1OA3/d/58qHO
// SIG // Lhz3mNpnOehnoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // hvcNAQkEMRYEFAf3nab3h+UrSTc/qEE0Om+tsWPWMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAIWMtPAgaUjHVuMrhD0rLWmr
// SIG // 0JElynk6GaViwXu8sZ+D0n6r2Hs7zzA10RPymVk8xoxx
// SIG // VQtj8bBMWJHLlaJFanJsNuv8DbYON6zqZApTb9gxm3EB
// SIG // NVVmma3k9781EGoUI6wcoRd5OyawR4LakiAD0p/FiqBc
// SIG // B0GQ2+e4KZN7bYpGHU6muz4Ls0747HrSP8jGV7DxCgL2
// SIG // ydBwTT7gilR/70xRQSD2QGsw4zuFUDcOJGLz9EosyqqW
// SIG // 5RFenYV233TgiwZ4x5auGG2fwBCGPfNlospNnlReB8JR
// SIG // TKrR8Vs7Rcz5yY+RVPJf/Oju20vBLfWt0Z0sTug08o2H
// SIG // G+500mIoexg=
