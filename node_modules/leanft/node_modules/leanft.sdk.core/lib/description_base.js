...
DescriptionBase.prototype = {
    ...
    _transformSpecialValues: function(props){
        ...
        Object.keys(props).forEach(function(key) {
            ...
            if(value._flat) { //grouped property
                ObjectUtils.extend(transformedProperties, value._flat());
                return;
            }
    ...
    _defineByPropertyBag: function(supportedProps){
        ...
        for(var key in supportedProps){
            if (this[key] == null)
                throw "ERROR: Property '" + key + "' is unsupported.";
    ...
    _propertyHandler: function(propName, value, beforeSet, afterGet, convertBeforeSet) {
        ...
        if(value === undefined) {
            //then it's a property getter
            var propValue = this._properties[propName];
            if(propValue != null) {
...
// SIG // uf3iYkXzhOYkmeeJlxCis7ErNKGlkfEhlXfVxUKn7Pqg
...
// SIG // YVwc8FzbNAbPD8EmthqrzZiT6IIBI3vvSuuHuNiYXzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBfw8OsKR58boln0pFVomAF
// SIG // koRdqEqMF+mgB/HA8uh54EKEFSb3f6Ow2mVw/PLNNEwC
// SIG // RkjFVHv5L209G68jtSELXrKxc0eR1KKnPET4ZkFS6C/h
// SIG // tRB6u/lbztGUjO+Try436B5hJKEfOYmQhOWjJL4DQqpf
// SIG // tqkpLeJfs9EmQCtMzxIvr7YlrRKPZElNzw2dquoTSrSB
// SIG // kun+qIRB74+1P5b52FfOz3lsnF/jWR8glWc9rWmerYy2
// SIG // 02//x3NhCcVK++LrTzsJ3lokDgf/ny90siqTkof7iugN
// SIG // xrcfGopEQWk4R/0MZSoYS5iZ8bTYYTBaWoXx4y7M3KvY
// SIG // ze4H3FQc3JkNoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // hvcNAQkEMRYEFB4LZBhtIvBq72VGpy7cxyMaGExLMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFVKrluDTGw5RMT0cro+qpuE
// SIG // fT7rTM2q9q/zli4RgD/w0QkZhgowk6APCo6Mvw63F/GQ
// SIG // b3sQ29H4iSV+o3sbfJQ4ty1e9e6RoVJSKgCSyFz7KQlG
// SIG // dKGDR/DXR8I/KKpFmWVou3HmULjJzFHkp46Hbo2XEvr6
// SIG // 0dU/9weZFrSGIqDfd4BOxJ0UmUQlW9A40mwG9s1Fh5hU
// SIG // S6bi72UNGfEM08/EKP97cGoLRr8nAJs28zxJp0Y8zTZT
// SIG // Zj5f0+0uKvfImaEmI+ELJejyEy71KHY0k0nu0J/KcgF+
// SIG // tcjs5dwQSJx/fzp2KnPLGjROdsub6Ju0XuPhKJAw6Hpt
// SIG // HOQMgfRyWXw=
