...
var ObjectUtils = {
     ...
     * @param obj The object that receives the new properties.
     * @param properties The properties that are added to the object.
     ...
     * @param child The constructor function of the child.
     * @param base The constructor function of the base.
     * @param childPrototypeObj The definition of the child.
	 * @function
     */
     ...
     * @param originalMap The original mapping of key value to transform.
     * @param keyTransformFunc The callback to transform the keys (Function).
     * @param valueTransformFunc The callback to transform the values.
...
var ArrayUtils = {
     ...
     * @param predicate The predicate to test the elements on. This function takes the following arguments:<br />
     *  element - The element to test.<br />
     *  index - The index of the element in the array<br />
     *  array - The instance of the array
     * @param thisArg The predicate's 'this' object.
     ...
     * @returns {*|Array} the array after conversion.
     */
...
// SIG // amh1QTYXshk+0berhmq0mcoQCS8xCrDjAC+UIzypROyg
...
// SIG // +HYbXmvTOd/Ez+A0bkxUu3hL+EV2Ct9qrRlvIqfRYDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCD0Yu8vNs1zf8ADlGH3xaM
// SIG // nnld+UAaw2ZaJkfazBFyYt5H3BcZaElCXC1brErh9M9K
// SIG // 1isl5Q07wfz0SpTAGjSkJvNcZOOQ0i5jryqHmBlyw4XL
// SIG // D5wPlBhS8my9Iu5iVCr+K6a1zsSdRv93/xP6IhRh6eLr
// SIG // DWxC+ebsVMZJZIJNLxw4tdT+YkShLbKBiAhquQ9Kc5T/
// SIG // tetra4SLQjPlMlowYgEw4PoUStVq7YAHEioValSSgY3y
// SIG // GZnmR+sUs+na6Kl4VGh7W3In5bVLbS1QZuCCIYWeldNQ
// SIG // iy2NB2hMuQTM39VNPpdUJgKas/ktLvcyUdYmv3czdP97
// SIG // kV9MzNKunsbNoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjAxMFowIwYJKoZI
// SIG // hvcNAQkEMRYEFC7CreefBXj7ZwrmDq1Cb2WZnH8cMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAHGFxSyypa6ZSkYcGsUog/Od
// SIG // L1sgVi1jWIXN5ZdjR7QWsyK7K136XYWdqzT/MrejE7YC
// SIG // ib2NmoiWy8sfMsk3mFkqZGl+06j3YtbWJLg+4MFWMcUY
// SIG // OGjhe4zr9dzwPvnB/zHJSbcJFYoJmStpiHzI5DC59LkA
// SIG // XYVSNRcNss6TztcDHYQkbyzWYBTRnuIU+I8CT3f0BVBF
// SIG // BqkUW/kmkdlGW1CbLea/HlHlP8KGrniGKnJFK5YrTrzU
// SIG // No8fyl2etWTj0fnoFlFZWGLUZsmYBz7XecvTQHgFkUJs
// SIG // TPceS05qKhYz9Xg43sevT8RTHdCPUMnkE0VIw7JdHYCY
// SIG // amsaoC8L42M=
