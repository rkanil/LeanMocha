...
PropertyKeyPrefixFlatter.prototype = {
    ...
    _flat: function() {
        ...
        Object.keys(this).filter(function (key) {
            ...
            var resolvedVal = "" + this[userKey] + "";

            var slash = resolvedVal.match(/\//g);
            if(slash && slash.length > 0){
                resolvedVal = { Type: "Regexp", Regexp: resolvedVal.replace(/\//g, '') };
            }

            nativeMap[nativeKey] = resolvedVal;
        }, this);
...
// SIG // ogRhU/kl74qzyCBg7gIa1oka4i0kha/4t92HynY5SGCg
...
// SIG // 1aSoaTPQdkGIhfA9/umLx5ZVdmFHHvkU5e63mUDetjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCQLZXL4ETPfIKLqPchLt74
// SIG // B5Rpg+UePdv8qdUX3BE3unTl8FNyjhc2H0qUDUFw3kNC
// SIG // MbQgMcxhAmGKWNZe6Yn9uqYVi5qzMbA1DkfUz1WzMiua
// SIG // 0flZAyzbg76y5O+zqgQrH3ypg+jDXtdxTWOuwNhqfTCh
// SIG // XVW44A4yMlLkiQHRhXXIoQrMI4e5zLHjq1AHcANycID7
// SIG // Kf6j4o3/lN5S0JRTxlnsD5UPxK9BctjEYbLzXuSMFwWb
// SIG // vm9P6kHw5bCbS9432YCRFl856QDiKyX87bmp/DUefBkz
// SIG // XHVB0sVWEltTKAYTpvgCJpEE9OLxX2OtrsRHOJy1nbd/
// SIG // ftGLTticMxmxoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjE0OVowIwYJKoZI
// SIG // hvcNAQkEMRYEFLE2nkYziav1SclsNZ3oFuSkLv2FMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFOZnt6IsItTcIhPg+W5pH77
// SIG // jYKeN739ZqIIW/0M31erN4TkSV++HPnyP5VkSeyx1H8h
// SIG // hbIT8DDzJc7PBt7FdYcyamDUktJxmMOPcZtgKTYqLFFL
// SIG // 7oHyuA0nb1Fac7cPasNZGjzxT+2xaAT3rztpxvsaTtyR
// SIG // Z4bv7ukPSu8ZpPXN5mt3aWPjnS71U6cFHN32a9MPwbYw
// SIG // 37TqU5BhH0WbBXIFW9Q/IOBAoWSM5C296l+B9B0gIGYz
// SIG // sFRpzh7fUaciFdUf7qI57rn7ccPjwsryG8ySZvwwgjp0
// SIG // F7oOoyhSmDXM0y8WDPGtaC+r0wcZq+dA3Dq+FF03mv4t
// SIG // cjozoGhGfiQ=
