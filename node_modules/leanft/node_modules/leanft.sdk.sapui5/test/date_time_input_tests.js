...
describe("DateTimeInput Test Object Behavior",function(){
    ...
    beforeEach(function(){
        ...
        dateTimeInputTOBehaviorUnderTest._session._promiseManager = {rootBranchThen :sinon.stub() };
    });

    describe("setDateTime",function(){
        it("should call the _executeCommand method and pass it the correct arguments",function(){
            dateTimeInputTOBehaviorUnderTest.setDateTime(new Date("2016-02-01,12:30:55"));
            assert(dateTimeInputTOBehaviorUnderTest._executeCommand.calledOnce);
            assert.deepEqual(dateTimeInputTOBehaviorUnderTest._executeCommand.firstCall.args.slice(0, 2), ["SetDateTime","20160201,12:30:55"]);
        });
        it("should return the same promise that was returned from _executeCommand",function(){
            ...
            var res = dateTimeInputTOBehaviorUnderTest.setDateTime(new Date("2016-02-01,12:30:55"));
            assert.strictEqual(res,getROPromise);
        });
        it("should throw exception if parameter is not Date object",function(){
            assert.throws(function() {
                dateTimeInputTOBehaviorUnderTest.setDateTime("2016-02-01");
            });
        });
    });

    describe("value",function(){
        var promiseMock = {then: function(cb) {return cb("20160207,12:30:55");}};
        it("should call the _executeCommand method and pass it the correct arguments",function(){
        ...
        it("should return the same promise that was returned from _executeCommand",function(){
            ...
            assert.strictEqual(res.toLocaleString(),new Date('2016-02-07,12:30:55').toLocaleString());
        });
    });
...
// SIG // XCBKP8P3jbJcn8jtAuka2qgXD+nTa8ni7/x5EhMsnmyg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC6
// SIG // NYSufMTubXdVqa2zE3TopZqK5bVjZxzyvaItvts8CzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQB8gQ2pIqv2OTeO2QwYuoBa
// SIG // b2n3CHeAxJiEFnjlqIMaeqdx7qjLqd+X1rTOCQyfNpzn
// SIG // rLsWJ4fuEDkxhZ7wdNMgRY/pwJ7CF4Scqfj+1K6vQHv2
// SIG // bouxAOb/0CEYF2phtLD3r0250F2OKnyFZvuot3TlPBei
// SIG // 4t8gS2bWKQJUdiSCSOR0cRgfgwYm4BGhr7VACMC87i2V
// SIG // 0H9AQS+FurvkD5/4yjCQT71Yu/YEvhgBKt0NaOjGGUYS
// SIG // r5t56YtTCeJgGhbVb4CldUjsa6XaBbrC+/UqOF0i8AZE
// SIG // FsFukNeG21KeyUE/fRN6O8T0UAOuEWb4e6bDecYj2CVQ
// SIG // KTiTRBU/J2WKoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTIyMVowIwYJKoZI
// SIG // hvcNAQkEMRYEFJHQURNqpKxrybS5etvcVWB3BRwIMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFagO7UAjPP5t6ctJrb4T5RD
// SIG // ZWCD0sKV6msLPvwhWkGoy93XnduyRkGHOpG+cx1j9QBQ
// SIG // PpopyUJLRYXtYpW0YKHcZie77twIMGhNYB7MbfeWJ06p
// SIG // 4vLf5ncqSTMW2JTI/hhDtciDt/zAOG0dTY1Qshpn/76k
// SIG // 3x+g8zfabYFZ8lhlWCrp00K5myhWRd4+uDzd8/+2Qdtu
// SIG // 7AmeLpLej+7/vIixVM2Ppq4bQg5Thldvgwj9p/hybsO1
// SIG // V33yaX//GQzp8FnUYCsZCb2AiJK+tq26tfoup0MtKqjL
// SIG // Ro1zeYde5o1h0VOYD15Cr0fbmtWJ8XZP+iJ6mfaKmq79
// SIG // vahYEGViq2Y=
