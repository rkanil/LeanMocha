...
describe("Calendar Description unit tests", function() {
    ...
    describe("date method",function() {
        ...
        it("should return this - builder pattern when value is given",function(){
            var result = calendarDescUnderTest.date(new Date('2016-02-01'));
        ...
        it("should remove 'date_yyyymmdd' from _properties when value is null",function(){
            calendarDescUnderTest._properties["date_yyyymmdd"] = '20160201';
        ...
        it("should return the value of 'date_yyyymmdd' from _properties when value is not given",function(){
            ...
            assert.strictEqual(dateValue.toDateString(), new Date('2016-02-01').toDateString());
        });
        it("should throw exception if parameter is not Date object",function(){
            assert.throws(function() {
                calendarDescUnderTest.date("2016-02-01");
            });
        });
    });
...
describe("Calendar Test Object Behavior",function(){
    ...
    beforeEach(function(){
        ...
        calendarTOBehaviorUnderTest._session._promiseManager = {rootBranchThen :sinon.stub() };
    });

    describe("date",function(){
        var promiseMock = {then: function(cb) {return cb("20160201");}};
        ...
        it("should return the same promise that was returned from _getROProperty",function(){
            ...
            assert.strictEqual(res.toDateString(),new Date('2016-02-01').toDateString());
        });
    });
...
// SIG // JgyWs2MsXVkgUI5y95nqIchLcNlz699nYp+XmBH1Iaeg
...
// SIG // 4RZGdcWIWotKd0Yv69c4zwPRxI1UHFFZLuGCRZcs0jAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCGUsdaXjeaxUr/372XTgYJ
// SIG // pPmgcpP3F/4yDRBJg9hi2DE7a7lPyviCxuzQQ7EIZCy0
// SIG // +h7a/96MgK3YF//OQ2Ru79GbCi7+1tUZLjOpSNwh25AK
// SIG // 2N39C1kMLOqwJYBw3/pGPztYdsCUqwkU02pvu+h/ksY3
// SIG // VVAlRmZ/YIbp1iftJbN3HCGDmlJXKfCc1oQ0N3AClCx/
// SIG // A6xEM4h22tPC8nTziXBIJHFUq8Q9MUGJfzGY6gw0htaQ
// SIG // fGbXJetzd8rkWV4UgzfiHJfGPGwBAslecEpjEiALBmPX
// SIG // 5e3nfcao/Fj0D70PxOOs2YFWgMiRIPrqmsYQUQmwGbap
// SIG // Q+H8fax2LKBaoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjQwMVowIwYJKoZI
// SIG // hvcNAQkEMRYEFG4bRFXAEYFhea5U9yxYEehm/bjlMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAI4T2uQ8xCa6f0Cvh+Tm6xms
// SIG // iKa42ijpUbuuUgLe6Kc8gafrlCNY00WdCFoLhOoIfQr7
// SIG // bWo8IPZzmzakJaULj6WWMY36Jdo4AFc+exzwDA6IyKBq
// SIG // xPoewihbK66Y66RNaaUU9AoRAcFjbHj+EOfF1LiOenIz
// SIG // 13It4NqryPqjVVxJCddxm3yPeVlGCNdYPD98gOvc7rDl
// SIG // y1a1UsbiQQZU+qPFliQbkTKoEiTBCRHfBwqHJNhq6BfM
// SIG // sR4AjJHxT8RLfBM+Ap6G/ow94OF7SFiNMvfwkhyhpOKo
// SIG // k9Fx/JsqoNA4Wd3zUMNn8BKp6G6TO3q5X96osccc+q4m
// SIG // e/1W0gr0zvM=
