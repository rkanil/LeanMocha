...
describe("RadioButton Description unit tests", function() {
    ...
    it("should have all keys of Web.Button", function() {
        var WebButtonDesc = require("leanft.sdk.web").Button;
...
describe("RadioButton Test Object Behavior",function(){
    ...
    beforeEach(function(){
        ...
        radioButtonTOBehaviorUnderTest._session._promiseManager = {rootBranchThen :sinon.stub() };
    });

    it("should have all keys of Web.Button", function() {
        var WebButtonTO = require("../../leanft.sdk.web/lib/button.js").ButtonTO;
...
// SIG // kI8Rh7YKx5cLmSU3IuCgSrn8WkghIJwcFhULf18q0YSg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD6
// SIG // tp2xc6dHp7r55cauNsMeJBDRzC7AHZo6LPAbXN0QJjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBaI/nqPS00s65nAmb9SO0Q
// SIG // QgYGqfORGhKaz3ahuRDe9qP/eCq9knSU7IwmKPii9+PO
// SIG // JSkBoHf4ThYRNl7UrpGsHVWl03TJ3uixqyLiNg+WJcPe
// SIG // wfyZ/LCkpeVfqPI+S8JQmPFCw2tnKZkrmpHJE9d8njsU
// SIG // ojeGvw1A8/+lQKf4WRoiUFOmNmld0SB7/TZV3TO0PI4v
// SIG // dRxlciJHvk2kXVTFAC/temw/uFhqQ8QWaUkuo316e2Ml
// SIG // xIIU7DApn1PfpPIwwceQA5WfKp4BXxWh2nXs+6baTNhG
// SIG // w0xgfXQzvm2UBuR6Z+Zior18+xMd0r/Zotb6NjKdBse6
// SIG // 3h/F2TFiHcEioYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTQxNVowIwYJKoZI
// SIG // hvcNAQkEMRYEFK7n1chJEbjbwC+ZQKPu1qAiCcMNMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFJT42wSoFCtpcXPaf1d107x
// SIG // nUT3NL/FAXrauS8JTsN9DgW1+ERrsDa2Iq3x96KkhxS+
// SIG // aDTdR/si4fIHaaRf6WkqarQ5SlYFhL3BZDto0u8s4STO
// SIG // S4ejM+79GNprqsrkkvSlxyzdO9W5WtnmgobLP6VvbTB6
// SIG // +LWXbivEM11aZJRBIKebSSpiUV9QStpL9QE7rKTwN6id
// SIG // iJQjwimNwLM4COw70MMRmZcN6qrhgKezI7vNx1V8nApH
// SIG // STDWMbNmKIPZdDGT13RKkwUccjNPK7DUgk93HpA57vWq
// SIG // odxQZHvtGK6QJEHsiGHJgp8poN/TfUFIZA0fD84l+uQH
// SIG // VKnTu70r05I=
