...
/**
 * Used for conversions of Date type.
 * Supported Date type.
 * @memberof SAPUI5
 * @enum
 */
...
var DateTimeInputDescriptionBehavior = {
     ...
     * @param {DateType} type The type of date displayed in the object.
     * @returns {DateType | Description} If no parameter is provided, the method acts as a getter and returns the current stored date type;
     * otherwise it returns 'this' for use with the builder pattern.
     */
 ...
 * @mixes SAPUI5.DateTimeInputTOBehavior
 */
function DateTimeInputTO(session, description) {
    ...
    ObjectUtils.extend(dateTimeInputTO, HelperBehaviors.EnabledTOBehavior);
    ObjectUtils.extend(dateTimeInputTO, DateTimeInputTOBehavior);
...
var DateTimeInputTOBehavior = {
    ...
    placeholder: function(){
        return this._getROProperty("placeholder", arguments);
    },
    ...
    displayFormat: function(){
        return this._getROProperty("display format", arguments);
    },

    /**
     * The type of date displayed in the object.
     * @returns {Promise<DateType>} a promise that is fulfilled with the type of date displayed.
     */
    dateType: function(){
        return this._getROProperty("date type", arguments);
    },
     ...
     */
    value: function(){
        return this._executeWithEvents(arguments, "GetDateTime").then(HelperBehaviors.DateBehavior.formatStrToDate);
    },
    ...
    setDateTime: function(date){
        return this._executeWithEvents(arguments, "SetDateTime", HelperBehaviors.DateBehavior.dateToFormatStr(date));
    }
};
...
// SIG // Kmb7g6l3CIjKxx6uIjeul0GnAjxdXErDKceCQxzG5S+g
...
// SIG // sd0tTodnTvLgQcB6yIwdAd/0nMFpoaptsK7dA/I5kTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCwjq5s8Xefa60JKqin7Wzv
// SIG // SExcnZqZ0nMzt5q1yOHKby3waQ0nfnQh6tsvv/iHWyKZ
// SIG // l3ND8ghFDwj0gCke8m5XAJwBJQzHZ/uIwfzzlgUwnP9K
// SIG // ClXsaMT1KiX9dX5+2mldX9ZH/Cb1jiKfuKiUBWMiF2pA
// SIG // RvHsCDo71HAKOVNOxl+w5J3HK4Op043T1W4eHePR11Hj
// SIG // vuZFfE/G3A9GAUSakBVoilq6gXdG5PpCFkyj2/QciKfd
// SIG // 0bKPWLsgZHbd68M9QSVc1GwP/nG907WFCnd494T8FOuG
// SIG // TbHOXAXFLJSKw/jF3j5PzBQK6u0yO5V8IaYOu7dUmt8k
// SIG // Z9j/l6E+W+NKoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTkwMVowIwYJKoZI
// SIG // hvcNAQkEMRYEFF6rYy1FaHhkWYcOa41kYhjw7rKIMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAG/i/eyVmtd2Tr2ycS25PNTa
// SIG // n+1ddXb0k1rdJFuvxMWUkzlgtqdvd/EcrQovSUEybBup
// SIG // Z3pUfqM/6tlO9gxF8Rxv2Ej9byB6zDl5rRdRgEBjVY62
// SIG // RDG8MAlVsSeFOzAfZvjEw5r92JXwx7UguyES/D/XyJtX
// SIG // 0zCiVaW7rRgnFE1Wtc4Q70HWTVwOC7SvPImHyLYo8vZq
// SIG // Y6vtV/S/MF646YT+JURj+D6t9QmClEjiRZvnayWUq6+k
// SIG // s0NvorFCybg+N+x1kZzQClJ2/KQEOKrd215FDS/TXjCJ
// SIG // 1lYSOcBK9aWR+HfpI3CB9/mL6PkhPFTyXdi6O9gCB1wJ
// SIG // 5vwHR9IBVO8=
