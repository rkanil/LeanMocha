 ...
 * @mixes SAPUI5.OrientationTOBehavior
 * @mixes SAPUI5.RatingIndicatorTOBehavior
 */
function RatingIndicatorTO(session, description) {
    ...
    ObjectUtils.extend(ratingIndicatorTO, HelperBehaviors.EnabledTOBehavior);
    ObjectUtils.extend(ratingIndicatorTO, HelperBehaviors.OrientationTOBehavior);
    ObjectUtils.extend(ratingIndicatorTO, RatingIndicatorTOBehavior);
...
var RatingIndicatorTOBehavior = {
     ...
     */
    maxRating: function(){
        return this._getROProperty("maximum rating", arguments).then(Convert.toNumber);
    },
    ...
    setRating: function(rating){
        return this._executeWithEvents(arguments, "SetLevel", Convert.toNumber(rating));
    }
};
...
// SIG // VEqjbdJLKtJtlFfTTs/D/9dHa/UV+obNGccZ3kGUypKg
...
// SIG // Gd8WGCrBA5DaEL1Lfj7qHn5uUtgKwYtYnExdNumS1zAN
// SIG // BgkqhkiG9w0BAQEFAASCAQA4yvp8rMB5gTKBchjDuyIx
// SIG // yH3SYhdAe//Kws64YBj33jvjsSr2vlJADdAWiQbZCdt/
// SIG // g1p/qPuNeLDk/m5TjgVqwvwBa40vYL+gIrSpTIxqfdSN
// SIG // ciRV96OCjR2BQKkxjpYxb5QMdLS7VNo5Fvlgvj3VM2QK
// SIG // 4+75RVrb6HWHE8+KmAskZKb9DybjBxMhTtAex9/YPzrZ
// SIG // VGGq2aH0ojt5aoszq4TYtzsNfCANNarP01giz7PVbytq
// SIG // XxXtLj/TqexQ3T0H7bTSDQWaAqNm21LIzZtfydsmI8vi
// SIG // IYbfo9tpY7OaDXPg1Ey0UL+g2DcoaxWk4UFx9rHZpYKu
// SIG // 5Nl45RnC3BYpoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTk1N1owIwYJKoZI
// SIG // hvcNAQkEMRYEFMz4qLw5VqalR8Hu4m0/axDV1/wjMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAF48UAuguGuJVn0BlCMvpVRH
// SIG // SkqZIR9zmEY9YEZm17D6szvoNED8lyQdFvrcz7m+X8Tp
// SIG // Bfm5ohqZ3BJJ8pSob+HsL5kWHUO4N06R6BFDp13kYDZm
// SIG // p0UoFiVWvgm92fOooWgJ1Memx6LTDdgW1shsSG4HYaXX
// SIG // OX51ooYnYhVCG04x0iLu15ym4nV9VcUM0TJDT0qopakx
// SIG // MSXPZyoQcb6a6XNITRz6sgs8UU+ndeKhK4OEz01xLEb8
// SIG // 6kJ4tSoy1PjbF8ve7yg66VgQDbKQIYqLJZOt7OlzlcUp
// SIG // yzkLiuOsg7ei8H3ZYWRorjl1i0Qpp9pyyPddd103Gy3c
// SIG // V2bRigJUM4Y=
