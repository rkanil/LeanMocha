 ...
 * @mixes SAPUI5.MenuTOBehavior
 */
function MenuTO(session, description) {
    var menuTO = new SAPUI5BaseTestObject("SAPUIMenu", session, description);

    Core.ObjectUtils.extend(menuTO, HelperBehaviors.EnabledTOBehavior);
    Core.ObjectUtils.extend(menuTO, MenuTOBehavior);
...
var MenuTOBehavior = {
    ...
    select: function(path){
        return this._executeWithEvents(arguments, "Select", Core.Convert.toString(path)).then(function(res){
            if(false === res)
     ...
     * @returns {Promise<void>} a promise that is fulfilled after the select operation has occurred.
     */
    setItemValue: function(itemPath, value){
        return this._executeWithEvents(arguments, "Select", Core.Convert.toString(itemPath), Core.Convert.toString(value));
    },
    /**
...
// SIG // iWx4S7e4qB9vUS6SOxvLNfs8FJonDj14EpffvEsMPJGg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCY
// SIG // A0G37uN1Wuo3QrilziQTfv2BLeBZ3SltMQ2HLcH2ozAN
// SIG // BgkqhkiG9w0BAQEFAASCAQARA7Zqz8LUP32OJQu7wwuA
// SIG // jtB8DTKauk+AmMWVQ5iPb+YtzMNUh8qrkWAJkBt4Fiev
// SIG // CePQYXcqZqrtorRyDQvFIP2j3kkr/+yKL8gClPJWYcAL
// SIG // Bp3FX9KtLx72zKFI18ucFDV/nxv5du2dReRmrVmUrarG
// SIG // beTt6jEEVzNGS8FJmISMalvV9/VZZ2WNY4GI4zwmkLiz
// SIG // g+cqyewwor62wcchN95xo8c4TI6vk6/zMfbcuvw6td/X
// SIG // hF6JDta2G2GTAi43uZAiUxfmfsQG9367Ho7fX5hbWnqm
// SIG // xE15IX4DkM4kln+1J96xft+nFsmd1mATQru6icFKerHF
// SIG // saZuLV3cBbTroYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTcyM1owIwYJKoZI
// SIG // hvcNAQkEMRYEFDgFiETKoT6MFUzoJvxuk7E2+mb0MA0G
// SIG // CSqGSIb3DQEBAQUABIIBAGip6UvWtPG1uuMnFhqdOb33
// SIG // CKpRHQebQT+VYrWhhA04JTvdak+Y2iL0W0ohFjFZ96FU
// SIG // PCPZlFE8j7WFOrHDvviJtz2Gn/t288lOe5tlw0ewBVGp
// SIG // WSvgk1PmkhUPSlDoJC6AVuXiCvoIYgNMk4EEf/siKnvy
// SIG // 635x39NTs2Nw7xeowEyMg4ohzCpNLU03+AyifqI0O/es
// SIG // VQzWcgzCJ8Z069iRF0Km5ZJMrOeMEuJt/7cNZf/lL1Ym
// SIG // DLZojllCS6KKEYOCioLJ+K773joqs/zXX2bUM1XceXbI
// SIG // LuxjbSrgZBUBjPEh9+z6pG5BbaZFR3Fh13hKjOYqMoKT
// SIG // wLI246AuKsM=
