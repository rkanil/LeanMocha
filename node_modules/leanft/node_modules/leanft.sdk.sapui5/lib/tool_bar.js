...
/**
 * Used for conversions of ToolBar design style.
 * Supported ToolBar design style.
 * @memberof SAPUI5
 * @enum
 */
var ToolBarDesign = {
...
var ToolBarDescriptionBehavior = {
     ...
     * @param {ToolBarDesign} design The visual design of the toolbar.
     * @returns {ToolBarDesign | Description} If no parameter is provided, the method acts as a getter and returns the current stored design status;
     * otherwise it returns 'this' for use with the builder pattern.
     */
...
var ToolBarTOBehavior = {
    ...
    isStandalone: function(){
        return this._getROProperty("standalone", arguments);
    },
    ...
    leftItemsCount: function(){
        return this._getROProperty("left items count", arguments);
    },
     ...
     */
    middleItemsCount: function(){
        return this._getROProperty("middle items count", arguments);
    },
     ...
     */
    rightItemsCount: function(){
        return this._getROProperty("right items count", arguments);
    },
    ...
    openOverflow: function(){
        return this._executeWithEvents(arguments, "OpenOverflow");
    }
};
...
// SIG // /5462dbLX80itA0ejPhWuI2X/x6d1AER26IXVW2/an2g
...
// SIG // IbmvjSVdlCsdtd6XKziu8pesGBrG6WiiVfXFM1jc/DAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAiVQwuLeWhrMhZYe+Yr8sW
// SIG // we0A7peK652SmtOF40PBW/mJD5KjisAECX+Ww3Q3VUHw
// SIG // z3mIHgTqvOgXvGQGHjwVcEWaWRyb7ApHKOgkav/O/gCb
// SIG // lNzJ8XsDKH0YTnd3Sg/0A5Bf7Hs0UC5kIKJemHREj7EM
// SIG // OTHWCRZwq8MqKPzx3Zw8UnvGQyRcG3vRs6rTJHOMCSzp
// SIG // /V1wmg22koXLtQHiw7PksyeEPzl1h2+Qe5BHZRWPZqEW
// SIG // H5lTnYVUIKOEItyaNOy53NI8vn+ym5aXwbus/lHAmivZ
// SIG // puUiQ85OAlajnCqhTc3DOznUp9BN6hUoS+XpA5avDo2w
// SIG // qaHeMd0oVh+yoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjI0OVowIwYJKoZI
// SIG // hvcNAQkEMRYEFBPgkypWpvez5PBcg6QwlkVKEFJFMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAEzsuLIbtRYD86g7aVgqOp3q
// SIG // +ZiSqBKcyQ9cqH6RyhYzUIsKyR9dewU/PFJQta6VLS0h
// SIG // 5h/sCH26pHTF9soo8i37v+XWsdKqziOjqdfg2VNvUEPP
// SIG // ynEL9OrDIVsMsdUEheaVSLOWoiUtXLKH4WMOwSFvGei0
// SIG // lMqLOZZbB3CWu8CS0zO106/Kfc9VVxv1FcaPrmO+YR+I
// SIG // Ox7T8uiMLcBOAvmsRlEhnC0ywkhKb+CDoivggI5Omz54
// SIG // 9APfFd7g9YLQDRz0k5qM//Ev8uGJYaLggAUc7cekt+OQ
// SIG // r+SY/lPQtM+YYe5ke7aqBS9lO01Xi/5DZbZrmanEMBXY
// SIG // zqbbPXXVAdQ=
