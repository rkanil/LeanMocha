...
var WebHelperFuncs = require("../../leanft.sdk.web/lib/helper_behaviors.js").HelperFuncs;
var SapUI5HelperFuncs = HelperBehaviors.HelperFuncs;
var ArrayUtils = require("leanft.sdk.core").ArrayUtils;

/**
 * Used for conversions of FacetFilter mode.
 * Supported FacetFilter mode.
 * @memberof SAPUI5
 * @enum
 */
var FacetFilterMode = {
...
var FacetFilterDescriptionBehavior = {
     ...
     * @param {FacetFilterMode} facetFilterMode The visual mode of the facet filter.
     * @returns {FacetFilterMode | Description} If no parameter is provided, the method acts as a getter and returns the current stored value of mode;
     ...
     * @param filters {String[]} An array of all the titles of the filter lists.
 ...
 * @mixes SAPUI5.EnabledTOBehavior
 * @mixes SAPUI5.NavigationTOBehavior
 * @mixes SAPUI5.MobileFacetFilterBehavior
 * @mixes SAPUI5.DesktopFacetFilterBehavior
 * @mixes SAPUI5.FacetFilterTOBehavior
 */
function FacetFilterTO(session, description) {
    ...
    Core.ObjectUtils.extend(facetFilterTO, HelperBehaviors.EnabledTOBehavior);
    Core.ObjectUtils.extend(facetFilterTO, HelperBehaviors.NavigationTOBehavior);
    Core.ObjectUtils.extend(facetFilterTO, MobileFacetFilterBehavior);
    Core.ObjectUtils.extend(facetFilterTO, DesktopFacetFilterBehavior);
    Core.ObjectUtils.extend(facetFilterTO, FacetFilterTOBehavior);
...
var FacetFilterTOBehavior = {
     ...
     */
    filters: function() {
        return this._getROProperty("all lists", arguments).then(WebHelperFuncs.stringSplit(";"));
    },

    /**
     * The visual mode of the object.
     * @returns {Promise<FacetFilterMode>} a promise that is fulfilled with the visual mode of the object.
     */
    mode: function(){
        return this._getROProperty("mode", arguments);
    },
     ...
     */
    getSelectedKeysFor: function(filter) {
        return this._executeWithEvents(arguments, "SelectedKeys", SapUI5HelperFuncs.itemTransform(filter))
            .then(WebHelperFuncs.stringSplit(";"));
    },
     ...
     */
    getSelectedKeysCountFor: function(filter) {
        return this._executeWithEvents(arguments, "SelectedKeysCount", SapUI5HelperFuncs.itemTransform(filter));
    }
};
...
var MobileFacetFilterBehavior = {
    ...
    open: function(filter) {
        return this._executeWithEvents(arguments, "Open", SapUI5HelperFuncs.itemTransform(filter));
    },
    ...
    remove: function(filter) {
        return this._executeWithEvents(arguments, "Remove", SapUI5HelperFuncs.itemTransform(filter));
    },
...
var DesktopFacetFilterBehavior = {
    ...
    filterBy: function() {
        ...
        return this._executeOnItemsCollection(arguments, "FilterBy", "ExtendFilterBy", keys, SapUI5HelperFuncs.itemTransform, SapUI5HelperFuncs.itemTransform(filter));
    }
};
...
// SIG // EKK5XhcPEbxdlTpDCx8AE8xX6OAJIVohwEJzNVV07Eyg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDl
// SIG // UedEnTCfAwwbUhW4/9BGEO5nTp0kCBr8cL9JLXxcQjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAB5D93YRivJmfm6gLu3mMc
// SIG // VqmiFUQRtEMdxi3eBYNA5XB5KkuYExApgtESddS9v6SJ
// SIG // lbpHiaADu10GpHRVdfqyspWL0b+KTui9JGjz3naG7Xy6
// SIG // mwIXE9gBL6RWtFS9rkm+j+KrTRkrqLR+WOi/91xzaVtA
// SIG // SzfARycTWFfcP7WNv7Ct3U7E1udRNU3qyNjyo+muV9eq
// SIG // rANs6AeysXa7kNtcdEttXvUCFObebzH42k/wv8egWjmV
// SIG // +4HDv/FRawx9/FD9O3XMLOEs6WA7T0KhUKXspeCzxuo4
// SIG // TJweh11QHiEtP7nC8AsIv+NsIhs1gSeM/C5Z0VxwrYZ0
// SIG // 2wlJemHbqy/SoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjIzMFowIwYJKoZI
// SIG // hvcNAQkEMRYEFBdkm1/tOtWf0r3MiizgGqYqY0vCMA0G
// SIG // CSqGSIb3DQEBAQUABIIBABQ80s4VEiwd5+svJOFsXm2I
// SIG // hCVQqjB7MS+Uc1pnTn2IT3KlOKLOrOukDk9jpj7yk7DG
// SIG // I5JwaSmRyac+0DFU/iyANvMsSpNqrirDy+4AowpyUlDA
// SIG // DNMF3h+T0dYtfVi9ZvJRWEAwHR8VngAwial18DEhm5B9
// SIG // +QMo/GPhCcxy+fo/NtxDqKeQHL84oA/ZgghttxObQ/D0
// SIG // lzlbulX708ZiPyKQqOlcFL1nS/3ssaQdk05PVSvfQb24
// SIG // K7l/IAaagAIJ6GrdTdxoe011N5U8d3MjWa5dqWIeTM3R
// SIG // uR1uaVDDYFDefB+itAsdfNs7YuJcA3wrNQTDQ+Gb4MO2
// SIG // +792pmtpRzw=
