...
var TabStripDescriptionBehavior = {
     ...
     */
    tabs: function(items){
        return this._propertyHandler("all items", items, WebHelperFuncs.stringJoin(";"), WebHelperFuncs.stringSplit(";"));
    },
    /**
 ...
 * @mixes SAPUI5.TabStripTOBehavior
 */
function TabStripTO(session, description) {
    var tabStripTO = new SAPUI5BaseTestObject("SAPUITabStrip", session, description);

    Core.ObjectUtils.extend(tabStripTO, HelperBehaviors.EnabledTOBehavior);
    Core.ObjectUtils.extend(tabStripTO, TabStripTOBehavior);
...
var TabStripTOBehavior = {
    ...
    select: function(tab){
        ...
        return this._executeWithEvents(arguments, "Select",  SAPUI5HelperFuncs.itemTransform(tab)).then(function(res){
            if(false === res)
    ...
    remove: function(tab){
        ...
        return this._executeWithEvents(arguments, "Remove",  SAPUI5HelperFuncs.itemTransform(tab)).then(function(res){
            if(false === res)
    ...
    deselect: function(tab){
        ...
        return this._executeWithEvents(arguments, "Deselect",  SAPUI5HelperFuncs.itemTransform(tab)).then(function(res){
            if(false === res)
...
// SIG // m5luANMeS2wIVHhHqlgWrtePFgRPAhy64BJYpWO6rrWg
...
// SIG // r6EZ8V3LARMacEJ3VMxr4eY0ZIQfX04PwgVAtQ/f8zAN
// SIG // BgkqhkiG9w0BAQEFAASCAQC0tewWCNqtAifUU+Co1GiZ
// SIG // QZmbcUonTSQZElVTO6XgEpHhHoFQvToOHVugK55hJM9z
// SIG // ijKe7c28E4gJewbqusgbl2DSnre/HXVjYaEa1fx2gPdV
// SIG // gORJoWTI1EtONDF5t0Yd5hu0H2C1+B06AbfQWK/5usAO
// SIG // +YVNcEYs1dOEyi/b98QG95l2NhLKAaZ3nyMb1PG4tFo+
// SIG // 8tuRX6gSw2XupVyeelwBU1ZzXpDTsVt3PNixZgOWXflN
// SIG // v/NwRoQt5he1GtO3B2u2FS488OQ3vsvxGJwZ/U21Ff3T
// SIG // 6M1KrHhtHJ7216i7lPixtFQBd8HSMo/aMLIeq6yVoB6C
// SIG // 5O5BPsJgbVNpoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjQ0MFowIwYJKoZI
// SIG // hvcNAQkEMRYEFFqiWI1vJFxY0wdLJSWy4rEQlw3tMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAEa9LTzTDzNbpBKVv6CsvpUD
// SIG // VX/Hf1DVgg58tNE/ov5I43s0LIfIn9VZCe32zVahWrtI
// SIG // DEwAuagacKxJkHxiMUta4MzYi0w6Nlz0xMk3xFH8rOny
// SIG // 2pC2eCmdW+/wn+8qKZDlB2KSyGiADdwCfjzEvMLRC22l
// SIG // 8vx1eiSPuhTvMeM4CCe46TZz57AS+TbkpkrgSsyuGo6g
// SIG // CZFwY8YqNajEsvBs+CvDsQNcS0W56ruqSxFkum9j7za/
// SIG // LExLqde9s3B3FHKHCDA/7WJ8cSMe00YLJj2ObO3Yj0hR
// SIG // n7+TxJZhmLic/2EKPY91OTqpgOeobHonv6bALREZhfY7
// SIG // ek2SLtfnDb4=
