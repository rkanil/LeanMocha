 ...
 * @mixes Web.EditFieldBaseTestObjectBehavior
 * @mixes Web.EditTOBehavior
 * @mixes SAPUI5.EnabledTOBehavior
 * @mixes SAPUI5.ReadOnlyTOBehavior
 * @mixes SAPUI5.EditFieldTOBehavior
 */
function EditFieldTO(session, description) {
    var editFieldTO = new SAPUI5BaseTestObject("SAPUITextEdit", session, description);

    ObjectUtils.extend(editFieldTO, Web.EditFieldBaseTestObjectBehavior);
    ObjectUtils.extend(editFieldTO, Web.EditTOBehavior);
    ObjectUtils.extend(editFieldTO, HelperBehaviors.EnabledTOBehavior);
    ObjectUtils.extend(editFieldTO, HelperBehaviors.ReadOnlyTOBehavior);
    ObjectUtils.extend(editFieldTO, EditFieldTOBehavior);
...
var EditFieldTOBehavior = {
    ...
    search: function(text){
        return this._executeWithEvents(arguments, "Search", Core.Convert.toString(text));
    },
    /**
...
// SIG // XWtrALhazjAKzBfUG7qV3mn2dX9g/TANtjhhCGO3qUmg
...
// SIG // ZEi6kAFWZcQbavVMmWqx3hMYU8pHCNuFPAysCwtWjzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAGXFTYQ7Gdj2I/u1TMwM9B
// SIG // czjUVQO3W82+qiVfJQgDLxo9GZL/m8SL4/Hg2Ot1Ensw
// SIG // 5diubqbpp6T7XhbP275xcPfHhDX/Wza+kPj+DLoosSHU
// SIG // NBeEhdlmXQ6q8VfE/Y85RgikzPXA8+jgkY1tQ49wBV1J
// SIG // zAzAUJmc/DYBTwlil2E8lmnvMVSAxwgOeF3LinnEi9i8
// SIG // 83rpWzb8/u1u/GL9eb6dF+Gghl+3vHdYZ5wbnVuhfbW3
// SIG // smasvk/RTwaVcswWyuTyUTHlK0tfpQ+Em8x3i/D6cY5f
// SIG // 0ugFmPjXTz100Z+FLIuU2KHd1ibbiqArDjF8rTe30g4m
// SIG // Gjb0sn+LjHTmoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTcwM1owIwYJKoZI
// SIG // hvcNAQkEMRYEFNsupCy84qFcPzVPUnYGpzPS1aAdMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFQjlJR0X+scCnmYJLnZiivm
// SIG // qOlAgbAz1UElC3Y+xKEW/JOy91PsigrIYY+R+E69APqj
// SIG // Hk11a8O875VbImb6sfNiZ/6rOIYVRl9gVRECAAC65iHk
// SIG // 7Im20t2S697r/cSXVTv+8nW+72c3fVthac5C/s9nFBu7
// SIG // 2uV6nDzrRntEVoli6yI9cmL4VGLRfE1QyoA7LFmzH1DL
// SIG // 4RLHnm3ZgsJWfLA3lsmep/UEGhgEjqGFwFDb93FnKDKi
// SIG // ydKNuVE86yLpAfHJAFNWNwFrr81CcFV0eFOSmDte1f/i
// SIG // uVLTdK90UcqpREfLF5PrUiPo/BrEEMNHMJ52LrPFu2gu
// SIG // z9280E7t9qE=
