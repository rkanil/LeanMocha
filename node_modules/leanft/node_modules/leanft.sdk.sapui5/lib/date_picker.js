...
/**
 * Used for conversions of DatePicker display mode.
 * Supported DatePicker display mode.
 * @memberof SAPUI5
 * @enum
 */
...
var DatePickerDescriptionBehavior = {
     ...
     * @param {DisplayMode} The mode for displaying the date picker object.
     * @returns {DisplayMode | Description} If no parameter is provided, the method acts as a getter and returns the current stored display mode;
 ...
 * @mixes SAPUI5.DatePickerTOBehavior
 */
function DatePickerTO(session, description) {
    var datePickerTO = new SAPUI5BaseTestObject("SAPUIDatePicker", session, description);
    ObjectUtils.extend(datePickerTO, HelperBehaviors.NavigationTOBehavior);
    ObjectUtils.extend(datePickerTO, DatePickerTOBehavior);
    return datePickerTO;
}
...
var DatePickerTOBehavior = {
     ...
     * @returns {Promise<DisplayMode>} a promise that is fulfilled with the mode for displaying the date picker object.
     */
    displayMode: function(){
        return this._getROProperty("display mode", arguments).then(DatePickerDisplayMode._convertToDisplayMode);
    },
    ...
    selectedDates: function(){
        return this._getROProperty("selected dates", arguments).then(function(value){
            return value === '' ? [] : value.split(';').map(function(dateStr) { return new Date(dateStr); });
        });
    },
     ...
     */
    months: function(){
        return this._getROProperty("months list", arguments).then(Web.HelperFuncs.stringSplit(";"));
    },
    ...
    select: function(date){
        return this._executeWithEvents(arguments, "SelectDate", HelperBehaviors.DateBehavior.dateToFormatStr(date,'yyyyMMdd'));
    },
    ...
    deselect: function(date){
        return this._executeWithEvents(arguments, "DeselectDate", HelperBehaviors.DateBehavior.dateToFormatStr(date,'yyyyMMdd'));
    }
};
...
// SIG // iTjE4dRveJsxdoLulAJKq3A7x2EfgSbXC1jsW3nszCyg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBC
// SIG // G25IwpsbsArSTyxVpM/Qv2o8CV+FVJYkMfddySDESTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAWZuiv7ZwQe2uhphwFmABu
// SIG // q3qd7qGTDNMuqlWlg83SZqe2dHPQTzAz5LNG+4Opds8X
// SIG // UKWZyHfBXO7PV5sx9S+UhBqG1+YUjNGNaIEbvfJPO7kl
// SIG // tpb4Yf/t/eCSQlSWrdWIAjlMXxQEaknL2fh6+GFnMw/8
// SIG // FnMDUVmCc88jeKb0g0UJrSv8o2NFnJM6scdNRvfA62pK
// SIG // NmC91rtFIC6vC2XO14en2fIt6lkekJ5c5wpFmbcX+RuA
// SIG // aCBfzHB7KWW2960N4Aj1csxhzZWK7wxC2Q5A+TqUdeKY
// SIG // YmxIext0XM37bG6JVicsCe0CHptrv8BvWlgjalc6xuIS
// SIG // aNmSpW58YENpoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjU1NFowIwYJKoZI
// SIG // hvcNAQkEMRYEFHwgkGVs/IqxPLhwNlMBqUByqrfIMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAAkrzJ5cBv9V+xwkHkhuRbjw
// SIG // yfCU3Q0ma5agfdGMdZJd6kbIab83wu6poLqmErk6l3OJ
// SIG // E+UJpGMlvMxTs653+uE1sFNjsYt9Yn7WtA2JtkjPZ4Yv
// SIG // 2EP+mLtxSeIhRKP7s+BFhKw3orz1i5HWlaWxrFmi2nbz
// SIG // pUR+wPhvoNmh1Ar0aEH63SNXl0ZOpsk/6eNYGvZCuWbw
// SIG // KGGl3Xm/6znFbhUReV/JCgxzt19eouDViDNbIbbcqSid
// SIG // CdCfmaO/Cbd6fw/CIKEFAebgRq4PB/urWpvETe4ljLeH
// SIG // V0FXB8bN5kNFyf/OrFovxTnbas1TwqdijJsvzF1gEv31
// SIG // 2cIA3nrucXo=
