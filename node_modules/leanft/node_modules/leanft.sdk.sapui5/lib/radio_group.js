 ...
 * @mixes SAPUI5.RadioGroupTOBehavior
 */
function RadioGroupTO(session, description) {
    var radioGroupTO = new SAPUI5BaseTestObject("SAPUIRadioGroup", session, description);

    Core.ObjectUtils.extend(radioGroupTO, HelperBehaviors.EnabledTOBehavior);
    Core.ObjectUtils.extend(radioGroupTO, RadioGroupTOBehavior);
...
var RadioGroupTOBehavior = {
    ...
    select: function(item){
        ...
        return this._executeWithEvents(arguments, "Select",  SapUI5HelperFuncs.itemTransform(item));
    }
};
...
// SIG // 0q8wLSycr/AiuotoWrTpiVPHl0pKFk4Iw6LLNjr8BOeg
...
// SIG // RwdgH2SKPem9B03ykw8qDrm5YvNVgiQl2xIie52vGzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBJhU5Y/CQKrl0MQTTYhEqK
// SIG // P1uhAgA39H7IC1i+bAGhMJrdKIG5A5Urb0whtSxaGZ2g
// SIG // jeDH8iAR0UbrU3+N0gedWotHoVBQ9OkWy3+4BHcM66qR
// SIG // pK9fayFPIKgMq0HkX182x10C++g5MOpTEMLTU+gV7hC4
// SIG // o2Ol+TDq1KT8Oouaz3vkhAYQ20dQrLD91sFkTrR8DSLq
// SIG // Tad52yw/dISdWnLcPvLI2+5lsSHuGy9yaCRMz7TmlHGi
// SIG // UlTA/Iz0/GNR+0gWFZ8yOQgd8pO+NWacJlpCkvgIpNsZ
// SIG // 1yuexMhkBWqHyax3WDKXIyn+QYPSkFXB3psk8a+ElR5J
// SIG // X0bISlU96oBroYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTgwNFowIwYJKoZI
// SIG // hvcNAQkEMRYEFIQFxq2glR9bIvR+AYVPuA9whwOtMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAJfFVEr2Yt9NKK63KyNidbPz
// SIG // 1+Xes8Ozvz1GgBIxKhWLI53QIhcoBJMgetel+w8RtTPn
// SIG // NzwLK5VSzGQYEl8lji+5jSxidwPFKjSz8esWWeYPRg5p
// SIG // sR2rIFq9E3FYMg8iJqsOQLZRbEVhsDO6t6tffSN4KzbH
// SIG // JTfNrOfAe0MWxN4zNp2KOR0p/V+oiczjFZ4HxJKBN+++
// SIG // Uc3LrfhRPieFmj436emzrt6Y4A23uiSjDxo2fy+GJK7g
// SIG // vEwqeX1PXN7mFSvwAGY/ueJNbPoqgDR3iJNCz6UQt9mU
// SIG // 7JaI9k4hwNHobsnpsM1DTwNjPjW7jHl3hSTQ1aG05V7X
// SIG // RlrrvmYbNtM=
