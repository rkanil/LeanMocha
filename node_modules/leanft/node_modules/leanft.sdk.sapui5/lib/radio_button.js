 ...
 * @mixes Web.ButtonTOBehavior
 * @mixes SAPUI5.EnabledTOBehavior
 * @mixes SAPUI5.ReadOnlyTOBehavior
 * @mixes SAPUI5.CheckedTOBehavior
 * @mixes SAPUI5.RadioButtonTOBehavior
 */
function RadioButtonTO(session, description) {
    ...
    ObjectUtils.extend(radioButtonTO, Web.ButtonTOBehavior);
    ObjectUtils.extend(radioButtonTO, HelperBehaviors.EnabledTOBehavior);
    ObjectUtils.extend(radioButtonTO, HelperBehaviors.ReadOnlyTOBehavior);
    ObjectUtils.extend(radioButtonTO, HelperBehaviors.CheckedTOBehavior);
    ObjectUtils.extend(radioButtonTO, RadioButtonTOBehavior);
...
// SIG // LOKcy7XkzpGioFZuRow6ih7MnQJX9/f4PENI4OUJ8Pag
...
// SIG // nbDo2JtgdSTtaOnnov1HE43CoAGG8HtZyTDkMmkwoDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQAC2cqQqz2fUQqBxj1fnAQ5
// SIG // IxFPasMMH3/A37MfKlsxYCZT6G5UbFVisSZ0gXZePpLm
// SIG // veVedx3xvLFydckIelUSSajjMCEU75jGymTzI+/E8CQb
// SIG // soTRixqkLW3GKshIhUkiL5AbSiro2I3pUnEIEpKJaNo9
// SIG // cQ3ub1eGDSO0X/6K7VHAaXttjZoJWvYkfF0JoNgMhfuu
// SIG // ++D5y9cTD2XAyOT90xYlUFZIrABTjdNXSuwUtbP93arP
// SIG // c+oQAzKupnb/RcW4Ty2s/k8rlqxfNc85Ca3wDgt/O4bY
// SIG // P53ssLGvDofUZM3xgLCV+5pI+n6OUu6KFsMig/gumsJQ
// SIG // lYJEYq30nf7noYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjQ1OVowIwYJKoZI
// SIG // hvcNAQkEMRYEFLoDlldqnySt7FBs2qavz7z4nzBDMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAHW+4dsE5AgaveMlEJtHdPKD
// SIG // Sgjpqj4HdZFMVAMc8sslAB5WIPGKHvJvAmjeNT0ANhkK
// SIG // Fik8XTXOiKjHf84Bta+Xe1A9HM/Hj9eQ7EpRYgi0dFX6
// SIG // LQaLZgoKzCLyo60UgG30auaJJXCWalm753ebIci/C4c7
// SIG // Ay6ZokQqgoZwvLjYzAG5NjfJGb20+998h1UflmaqQrpO
// SIG // vxKmHnTCm2ZgzMuFuKLLe2wq8/jkWvP3VC6Ojm2Be2Y+
// SIG // +c/msKRWsKURd/wnvsJaW4KNxnvQR/yRSOgttp8gprV9
// SIG // qm4avlqXb0aN5+qWupMg3evDJkkvuCdNPYFCF4aASXVO
// SIG // c1N60Vjplws=
