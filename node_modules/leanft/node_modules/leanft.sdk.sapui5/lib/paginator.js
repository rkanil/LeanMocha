...
var PaginatorTOBehavior = {
    ...
    visiblePagesCount: function(){
        return this._getROProperty("visible pages", arguments);
    },
    /**
    ...
    navigateTo: function(pageNum){
        return this._executeWithEvents(arguments, "SetPage", Convert.toNumber(pageNum)).then(function(res){
            if(!res)
     ...
     */
    firstPage: function(){
        return this._executeWithEvents(arguments, "FirstPage").then(function(res){
            if(!res)
     ...
     */
    lastPage: function(){
        return this._executeWithEvents(arguments, "LastPage").then(function(res){
            if(!res)
    ...
    previousPage: function(){
        return this._executeWithEvents(arguments, "PreviousPage").then(function(res){
            if(!res)
     ...
     */
    nextPage: function(){
        return this._executeWithEvents(arguments, "NextPage").then(function(res){
            if(!res)
...
// SIG // fQ1J4bJ/7VEqjPB9zMF43twE1DPBjpUyLEW1fjGsGjSg
...
// SIG // Z2+PdvIsGZi7o/gZUqVySqCSOBNi5eXiyCtTOzAXqjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCP/G1uPXZEUyuFGzP9dqQn
// SIG // 8/l/Itu+gCZEqpjimRCdZ0RJI5Ia3Z06VWaWUdekCEBr
// SIG // eN6aTwvRdciXvuRhPMCBwhCLxCkARuBFIWB8WeZNNHaT
// SIG // 0sQLF2RCRJZX7FrbvQVRNVcSKt3qnez5wQjyQX8sB/p9
// SIG // vlzxn8VbkakIbPJuROafkUWAp4L5yX/cnwyGMjXUp2sV
// SIG // OHomXQYZ3qrfF1TV9VosxmNZGkFDd/pg1EBXvYs8W9WL
// SIG // 4k3Pha9md68O3dtHEtWMfDS0i722jQOl4WS0EdkEywkU
// SIG // dG49KARJVf6+QjYnC24rBA1L9Vj6vdJRnb8sJe2uv8Pj
// SIG // XUXJzW9yhQPcoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjE1NFowIwYJKoZI
// SIG // hvcNAQkEMRYEFEO2gkt0usG2831YfNyQvX8/qgk2MA0G
// SIG // CSqGSIb3DQEBAQUABIIBAAR9DKHwFLQwXUmvm1NJbZg0
// SIG // QwSCNaVdJHkqV5vBvCMgvV0HxhKy35gPlGAhXc8wnTla
// SIG // HTg6UrjaX88fxDN+imG1NE1/8xBKJHss/DQYwA5TcKnh
// SIG // USbsBPgXuUPAyJIBOrjcm4SXop7oGxg9rB4xU2atvy30
// SIG // PWp1Mc+d2ZyheOrAotJ3DgYg44wQgMLrsB0qzMLai/BZ
// SIG // rx3Wy/LYVxwAnRg9oQfjU54I2Nb29K9uwbEJN2KE8EmA
// SIG // Y6PruJ4KJPUe6IbikQrFBNE4qsMK8HuakuXV/IAWVlVF
// SIG // +19TDqZ6vHAJmfTV9My6l6MekD+JRpLH1OmKKxvURWAY
// SIG // qE/uimTGDlU=
