...
var AccordionDescriptionBehavior = {
    ...
    items: function(items){
        return this._propertyHandler("all items", items, WebBehaviors.HelperFuncs.stringJoin(";"), WebBehaviors.HelperFuncs.stringSplit(";"));
    },
    /**
 ...
 * @mixes SAPUI5.AccordionTOBehavior
 */
function AccordionTO(session, description) {
    var accordionTO = new SAPUI5BaseTestObject("SAPUIAccordion", session, description);

    Core.ObjectUtils.extend(accordionTO, HelperBehaviors.ExpandCollapseItemTOBehavior);
    Core.ObjectUtils.extend(accordionTO, AccordionTOBehavior);
...
var AccordionTOBehavior = {
     ...
     */
    items: function(){
        return this._getROProperty("all items", arguments).then(WebBehaviors.HelperFuncs.stringSplit(";"));
    }
};
...
// SIG // L0pkA9VmsSL3EZ4nu1etGsD8iK2F4pIdrrhuozU8Voag
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBs
// SIG // B4ZATHbQei0VPDMTBiExiu424uwSiVJ+faqb+EbYPzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBu28XE4JI73nGT43TLBUti
// SIG // Opi0idovV54SqbFS7MAypVCUOznJmEY2UiqvsZTbIpWk
// SIG // WOiNh2wqUTp/Y+9CUoawcRqrS1cM7W+YisJoU3lFJvKV
// SIG // 6Pa37J0FSpMIZ5inIb3JUDhTxgO7J82jdlIrjvsJNpDy
// SIG // r1YQiBQ750pQpMdLahZYIg//paX+vtu6HRMjPcJSglz7
// SIG // jnMpf842E9qXsHSwAunhpeLe+Lrv++hpohw7Qyo8ooWa
// SIG // q6pmetdo2YNq1z+MU75owvkwS+QgI3my2QwUDax8ROIf
// SIG // gExIEaH5nyfF6/iAZJp00ANEZgmSmwkXRJNIMO6hkT0H
// SIG // TRxduZ4//RU0oYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTkzOVowIwYJKoZI
// SIG // hvcNAQkEMRYEFGzLDJGS+ovqn1pjPMR9L+vvBW9sMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAGbhDm3CgM/Wa1+2QLkCLQ+5
// SIG // BdQ6rEwvdAWS93mowTd9FiJoZQNyOjE9NXSu0CcPfkvT
// SIG // cXd4MMfPdlTgLc8jyAwRHhvdOC4fyAWRoohZWu8E+zVt
// SIG // ajC4bRoVcvHJZNrf4oTU7qV0lKOLPThlLMVbhGELQXKC
// SIG // QhJGo7xc9hWZVeRvpvn9bykE/6tIkEXugAw6Q+UJGyWm
// SIG // f9tkCW3476H03z5fPFvbEUVE1AOA2XT8eYheaZAKYwK4
// SIG // ZQtqPRN4souq/dwjl4Mcb5tHiOYznlKMNzEKM1bUJ+3s
// SIG // vwSGsKo3KAzMezxb4UFw+iDC/6qF6j+B1R10RWQMNEAd
// SIG // k6jTKAhEzJE=
