 ...
 * @mixes SAPUI5.CarouselTOBehavior
 */
function CarouselTO(session, description) {
    var carouselTO = new SAPUI5BaseTestObject("SAPUICarousel", session, description);

    Core.ObjectUtils.extend(carouselTO, HelperBehaviors.EnabledTOBehavior);
    Core.ObjectUtils.extend(carouselTO, HelperBehaviors.OrientationTOBehavior);
    Core.ObjectUtils.extend(carouselTO, HelperBehaviors.NavigationTOBehavior);
    Core.ObjectUtils.extend(carouselTO, CarouselTOBehavior);
...
var CarouselTOBehavior = {
     ...
     */
    itemsCount: function(){
        return this._getROProperty("items count", arguments);
    }
};
...
// SIG // EQwRev34j5fp7CFPLsrZfr8kgocXO0UApEH0veImS2Wg
...
// SIG // +ZC29YNY1rjoAu9nDzctPJxh70XpONwToyF04K58ojAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCbwD9fDoQl/NBIteyblPxs
// SIG // ItnaaE4CB24DpgFzetE2+S9rBeF9LUx/Hu7kMo66++tq
// SIG // tdDl0/Tbhb0aPrOBh6u8NtGjkKFuYADMxau3dwUQpt0x
// SIG // hc8KqbgkRrwwMejE4uh6cxaBhq6l0cCeObXA+JUysyTk
// SIG // q4rh5C798dSdvzhlMwstKC0OIg2OImeAEG2uGrStZbdS
// SIG // bvfX995IgUJ4JdbmVaaN4k18RM3/ljvXA6qF4rD2bf6k
// SIG // o38W4OQsSaOJy4CijovaN31XAMDOv2alR6SCI+U8cBDE
// SIG // 5RU/xbueJI1iM2W/HPU+PA2ZfFehE3bGZtKn3JXAQRBw
// SIG // LyrHPFjANjsgoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjQwM1owIwYJKoZI
// SIG // hvcNAQkEMRYEFAL2G/g45nCtbkPYZT8ebp7Z5IWJMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAJOswpnwfOAY2z1H5oJzAePn
// SIG // PzLye7CZFeo78D2JpVUoPUlG8H8ZbKs1abH/yQ1cwQYN
// SIG // RcH5j0Jywuh0eHsDuN+QY3Kq33FXzzufg+dzZ7wnyYhH
// SIG // p00EYJx9v50uElgB9M8z79NPlFoLeEcqLrWPS9Qy/Vbk
// SIG // FTChVvQKIn6MOj97CzAseNKupxvYrNcCxNUcXCFccOn5
// SIG // f8gasJitE5w4HaxfycJSL7KbOQLta2XHzHGsGNvCuIPK
// SIG // dVu6ZjobXhVD8vJPygK7kYoof0rRPMJNd4Gd1biGzkdq
// SIG // NChBAb6PAQpDpe0gxoBvdpxKu1qa7FdOzu7fvG2yUl41
// SIG // yp7wwu18g34=
