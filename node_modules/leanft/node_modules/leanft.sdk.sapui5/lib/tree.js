...
var TreeDescriptionBehaviour = {
     ...
     * @param nodes {String[]} An array of all visible nodes in the object.
 ...
 * @mixes SAPUI5.TreeBehavior
 */
function TreeTO(session,description) {
    var treeTO = new SAPUI5BaseTestObject("SAPUITree", session, description);

    Core.ObjectUtils.extend(treeTO, HelperBehaviors.EnabledTOBehavior);
    Core.ObjectUtils.extend(treeTO, HelperBehaviors.SelectPathTOBehavior);
    Core.ObjectUtils.extend(treeTO, HelperBehaviors.ExpandCollapseItemTOBehavior);
    Core.ObjectUtils.extend(treeTO, TreeBehaviour);
...
var TreeBehaviour = {
     ...
     * @param itemPath The path to the node in the object to activate. <br/>
    ...
    activate: function(itemPath){
        ...
        return this._executeWithEvents(arguments, "Activate", itemPath);
    },
};
...
// SIG // qldbiXZN1WOvsDAcB3pf/kU629z2z4Fm/M2JJo1Gq9Og
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDQ
// SIG // u5MdzoWoEk3Ds2/8HqSvp2tNOqju7lt6dK+JhuaTFTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCGpqvMUY9f911QtEj8fAM8
// SIG // YJu1S49qz0nHRiANiaJyKXECHu6Lb0jGX0niAR0HF8ks
// SIG // jcL/XLRFfZPxou55or0un64II0yTg2DauUmqnzsZEfqV
// SIG // prWZNFf2CjaBRSEu7ULV81jEuiB9EnDFhyCVxoINu+6Y
// SIG // jzbI2TcYfjvtlQoItKEmHXASOu9/+AVO95ltvMhMNtl7
// SIG // hpFnHOV4lS09r6Tbtbpl3dFNFMEo6QWrnnahZftnT58c
// SIG // MaF5Z0MUsXKGTWHVd0yOSv6cFmLp/UX6dzVUqzdH7gCD
// SIG // SwO9CVJRsCFotUOFu0q5sCfhck31oJkCl/k9tsw08Jz+
// SIG // iVmoPZ4wp1OgoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjAzN1owIwYJKoZI
// SIG // hvcNAQkEMRYEFFx4Nf6dzHKL0/hzX0sCV1FrBEEvMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAGcFmdwx2RRWW83IBkP97ysO
// SIG // vbMBeuQn6CwJV0ga6HpFvEu9FX/whviTH9s1qN3ngkGG
// SIG // TT2k85q1tvdwWEHsVZ/V/mKefWA4jy1DYhW+XfIozWA7
// SIG // 9m7fiM/YlYBiMrkKwKO3K5OgyCj5fd3tufK4AoOQQDaI
// SIG // mRBih56gWHahRXtt3D/2IwbhpfQ/LJvVl/aDOKcf/81J
// SIG // iwTvsrBlyEOxjij72YcdUTSNsmlujhPtpq930GwYgNqW
// SIG // CsB3en9jlBTaKDfK3438sWRsU6H7aVo9/10hLuRiwDHR
// SIG // ZaOuNgDDacctTr+fuBo11ElKqdn9+JGhngHIiyMWtVXN
// SIG // 2+tllF5qWzA=
