...
var HelperFuncs = require("../../leanft.sdk.web/lib/helper_behaviors.js").HelperFuncs;
...
var RoadMapDescriptionBehavior = {
     ...
     * @param steps {String[]} An array of all the top-level steps in the road map.
 ...
 * @mixes SAPUI5.ItemsTOBehavior
 * @mixes SAPUI5.SelectedItemTOBehavior
 * @mixes SAPUI5.NavigationTOBehavior
 * @mixes SAPUI5.SelectPathTOBehavior
 * @mixes SAPUI5.ExpandCollapseItemTOBehavior
 * @mixes SAPUI5.RoadMapTOBehavior
 */
function RoadMapTO(session, description) {
    var roadMapTO = new SAPUI5BaseTestObject("SAPUIRoadMap", session, description);

    Core.ObjectUtils.extend(roadMapTO, HelperBehaviors.ItemsTOBehavior);
    Core.ObjectUtils.extend(roadMapTO, HelperBehaviors.SelectedItemTOBehavior);
    Core.ObjectUtils.extend(roadMapTO, HelperBehaviors.NavigationTOBehavior);
    Core.ObjectUtils.extend(roadMapTO, HelperBehaviors.SelectPathTOBehavior);
    Core.ObjectUtils.extend(roadMapTO, HelperBehaviors.ExpandCollapseItemTOBehavior);
    Core.ObjectUtils.extend(roadMapTO, RoadMapTOBehavior);
...
var RoadMapTOBehavior = {
     ...
     */
    steps: function() {
        return this._getROProperty("all steps", arguments).then(HelperFuncs.stringSplit(";"));
    }
};
...
// SIG // fE9lmREEYXEh6j+tqyIRZ3wlHsijNHrfm+Lr3f7G2QKg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD3
// SIG // 51iswuU8h02S5HscXGWxDJ83pF5fV5caFtEAM0ulwTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBziINLVMTglqWQ+03LbMEY
// SIG // 00EU8Ac50/BuoNR/8pWg8Sv9X2lv5da8ozRtOuPJIjVN
// SIG // gqt4Laal1aYaOMrNvk7b/kX59ZqG/Nmon9Tstekw6Fu0
// SIG // 5rjNjMy29akQWUCCOk/prsM0laa2h8QZuM5ZpFXhwXKi
// SIG // aGxYe2maUlORixo9FpQkaODJZrKLc5GsII8Y3svZVLeV
// SIG // IMxG0NklurZh5DotQjHdZHD8t9j8ehYZa4qi02uNWsDs
// SIG // 1AbNyCOSQGcUch/NmwUxXmafTeZML5v3zatQnkRuvxTy
// SIG // 3kb29v3sIzWHDVb9mGedgqkAaOZwNK/rEUAAhUlcB5QV
// SIG // AoMpn71a+7I+oYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjMyOFowIwYJKoZI
// SIG // hvcNAQkEMRYEFOHmuqF45sv4o2BIwXCl29yvC3VKMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAETt9gGbwX8hCMjPjX67WgDz
// SIG // 076HwCtfeOuERunksEaO3fL1bu0fHEjGt8+y4LbAbKfD
// SIG // Acy4p3//9MXmxZ3pzd2xE5A17iLbyw8Jyo1RPq6mdaPg
// SIG // c94umWRRvnWa/59IkZhQYhOy0kyPNUPV5HxBfH2l2Gt+
// SIG // BPt+MNI42mEKxEiX54JwI9cTC0Vo6jNVklC0MbNvIYvn
// SIG // 2DmmRI8nHLz9rO6NyxER/BfRDZnkD4HVnoCB/un+Fkbj
// SIG // drXkdDAX+f0muKNYr5WSWIp6mb7p0hpr3ts6etZP1a6V
// SIG // 97eg15aWksLantujheG+nH5926eYjXEG2NwCpviAnIn/
// SIG // CqvBTgl0Egs=
