...
/**
 * Used for conversions of RowRepeater design style.
 * Supported RowRepeater design style.
 * @memberof SAPUI5
 * @enum
 */
...
var RowRepeaterDescriptionBehavior = {
    ...
    hasMoreSteps: function(hasMoreSteps){
        return this._propertyHandler("show more steps", hasMoreSteps, Core.Convert.toBool);
    },

    /**
     * Indicates the visual design of the row repeater.
     * @param {RowRepeaterDesign} design The visual design of the row repeater.
     * @returns {RowRepeaterDesign | Description} If no parameter is provided, the method acts as a getter and returns the current stored design status;
     * otherwise it returns 'this' for use with the builder pattern.
     */
    ...
    filters: function(filters){
        return this._propertyHandler("filters", filters, WebHelperFuncs.stringJoin(";"), WebHelperFuncs.stringSplit(";"));
    },
    ...
    sorters: function(sorters){
        return this._propertyHandler("sorters", sorters, WebHelperFuncs.stringJoin(";"), WebHelperFuncs.stringSplit(";"));
    }
};
 ...
 * @mixes SAPUI5.PageInfoTOBehavior
 * @mixes SAPUI5.RowRepeaterTOBehavior
 */
function RowRepeaterTO(session, description) {
    ...
    ObjectUtils.extend(rowRepeaterTO, HelperBehaviors.FirstPageAndLastPageTOBehavior);
    ObjectUtils.extend(rowRepeaterTO, HelperBehaviors.NextPageAndPreviousPageTOBehavior);
    ObjectUtils.extend(rowRepeaterTO, HelperBehaviors.PageInfoTOBehavior);
    ObjectUtils.extend(rowRepeaterTO, RowRepeaterTOBehavior);
...
var RowRepeaterTOBehavior = {
     ...
     */
    hasMoreSteps: function(){
        return this._getROProperty("show more steps", arguments).then(function(steps){
            return steps>0;
        });
    },
     ...
     * @returns {Promise<RowRepeaterDesign>} a promise that is fulfilled with the visual design of the row repeater.
     */
    design: function(){
        return this._getROProperty("design", arguments);
    },
     ...
     */
    rowsCount: function(){
        return this._getROProperty("rows count", arguments);
    },
     ...
     */
    filters: function(){
        return this._getROProperty("filters", arguments).then(WebHelperFuncs.stringSplit(";"));
    },
     ...
     */
    sorters: function(){
        return this._getROProperty("sorters", arguments).then(WebHelperFuncs.stringSplit(";"));
    },
     ...
     */
    more: function(){
        return this._executeWithEvents(arguments, "ShowMore");
    },
    ...
    filterBy: function(filter){
        return this._executeWithEvents(arguments, "FilterBy",filter);
    },
    ...
    sortBy: function(sorter){
        return this._executeWithEvents(arguments, "SortBy",sorter);
    },
    ...
    getCellData: function(row,column){
        row += 1;
        column += 1;
        return this._executeWithEvents(arguments, "GetCellData",row,column);
    },
     ...
     */
    findRowWithCellTextInColumn: function(text,columnNumber,startFromRow){
        columnNumber += 1;
        if(startFromRow !== undefined) {
            startFromRow += 1;
            return this._executeWithEvents(arguments, "GetRowWithCellText",text,columnNumber,startFromRow);
        }
        return this._executeWithEvents(arguments, "GetRowWithCellText",text,columnNumber);
    }
};
...
// SIG // fLeHr/hAcrhIk0fssCSHYIT6gAkB3z0C/QJJyj2lIKag
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAz
// SIG // 2kQfDR7JbodrnPN2amP98evi/MB5XDC97kSIgx6GQjAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCqcyhnA5TO35mrzcBuxb59
// SIG // HowgIlUfxMlAGrxumyX16z+Ij5YXUqVJ1+lKRnjGvcjU
// SIG // 5UYSNadGYGWNgr+yLpBOEn/y/zco65MmBuJXxcltULmX
// SIG // vtkcIMuIlLK80tmmTkHNn8MSczH3aez43sXKww8XsVaU
// SIG // JpuboKCBSDVOfvjZp2doLroK45wKwZoyJQe/0Pdz7Qda
// SIG // 2NliY502kuUwfLLHTKwojaDG8PrUJXbVirW+X/DThqBD
// SIG // AWCWF0N5MJ2sAsVhfHuoXOwm4PT/qAf/8N4aUiJYtWGG
// SIG // +sUnq0dLDOwliKfVc1ckwn0EfoSl91wmPQegNL1wmJSy
// SIG // UjwdkQCVezHyoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjExN1owIwYJKoZI
// SIG // hvcNAQkEMRYEFLpDF0MSNaq/1f5JzywENrdIGRTnMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAHSCrsmhJDVPnATHbPBBi5Lx
// SIG // KaVjxQxGO4SFnNfYKZwnb9zIqJlG9r08ybdynR4UuAFm
// SIG // NM7O3Jzh5ENuVbiWNfQLb4BrPrPE+QjmxjZ7+MG8V4W/
// SIG // sRoJj9IaVKhOznjrQPnCUE67Pk9gPteAzSFipYk+EL4c
// SIG // oPFyYNEM3XFRJ4/AHufw1H3vBa6oiHvDBtryQzHXiJTQ
// SIG // IDYesgq8zA8HjrsFCCdQI3omjWqQur2aRDDHrgXf3uEr
// SIG // HTJ12i9T11A9drpcVD9T6GggyCoAFpaZMeuEDEaZK37U
// SIG // NO07sm8mxwibxS0/T3+ZATrVe7q7wT40+tCiAm8v++Ag
// SIG // FMPL+6HNHrQ=
