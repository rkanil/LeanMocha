...
function RadioGroup(props) {
    var radioGroupDes = new UiObjectBaseDesc("RadioGroup");
 ...
 * @mixes Mobile.RadioGroupTOBehavior
 */
function RadioGroupTO(session, description) {
    var radioGroupTO = new UiObjectBase("MobileRadioGroup", session, description);
...
var RadioGroupTOBehavior = {
    /*jshint eqnull:true */
    /**
     * Selects the specified radio button in the group by index or by name.
     * @param {...string | number} item  Name or index. <br/>
     * index: the 0-based index of the radio button to select.<br/>
     * name: the name of the radio button to select.
     * @returns {Promise<void>} a promise that is fulfilled after the requested selection occurred.
     *
     */
    select: function(item){
        if(item == null)
            throw new Error("You must pass the name or the index of the radio group button to select() method");

        return this._executeWithEvents(arguments, "Select", item);
    }
};
...
// SIG // YDVjH0ChO4hd+OffgKP7W8OTUXzSRu7i2oNUO5YQ33Sg
...
// SIG // +TOi8YhH8T7S86CBbhlW7D7l3JN55IdVbn1TRvAo8jAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCWSWGiTI4KmXrB2nbtvOin
// SIG // 7ruf2qKA5rr6HJ46fUadBZ6I9B12HKtYZHyPsF5omX92
// SIG // FRNrV8rOO5ZmritKENwhObjREA/XvshRGlR/umnvVmYz
// SIG // YE/OVUcaWTFH1vy8zrxIBc93VQnkG8OVjNhUpb67bC0F
// SIG // rjPs+7WOxkMTsU3S8o6/Rohlzkog5Nd8FTZk5fAesdZg
// SIG // 5VDUC2sQGONdD+tWYuA9vUPrhtunJaDsjhXkYojLXU70
// SIG // KftQa1inJcS4tBVZydkHQ/ZvRg+ZE8OSV22l+jmkgx4o
// SIG // HTo0zd23+zVodZx4AkNFnyf0MFfk84tL9P6aLTQvsTCC
// SIG // RczbNUI5M1gKoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTcyMFowIwYJKoZI
// SIG // hvcNAQkEMRYEFInLdBx+2iWNC/CE/eRkqze6n320MA0G
// SIG // CSqGSIb3DQEBAQUABIIBACx10ue6tBTB5+ClYSJAMSxO
// SIG // P5+tV7nhn0AkFoTkp+vGazmVcJi4vedhsHbkW58z8ghB
// SIG // IJPkjS7xrRY603dor6hkQSXOp3LT1FD46/4Q9xnBuIgH
// SIG // MOXDBy/20uBL+5QmrOoitqBEzFKed6AmW11V3TT+TcY6
// SIG // rq4RaR/F3XORSyPZ0oxaqYNL3bltVkLAf0c3LojukqkT
// SIG // E/iyC2Bp0I7xcM1RA8SBSV2QNJGNIy1XurLTIymIJnng
// SIG // ST78SVZh58PO1U1FjgLOLPigGj3uICiyGnnO2lT3Bwq7
// SIG // 13m5PLFYk3AI4ibbH4tRBgDiAH1DU7/4nubvaXo0B4qg
// SIG // cCw0r0dIoZY=
