...
var PaginatorTOBehavior = {
     ...
     * @returns {Promise<void>} a promise that is fulfilled with the requested page.
     */
    set: function(pageIndex){
        if(pageIndex == null)
            throw new Error("You must pass the requested page index to set() method");

        return this._executeWithEvents(arguments, "Set", Convert.toNumber(pageIndex));
    }
};
...
// SIG // 5ix3CcFHjEch1x3gYTn4R/3cr+wPJtBduEIBiC+3dXeg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBU
// SIG // XM/tynGNghNNA0ulnpSdL+H2Qpd8qTrCJb0r8QQhjzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCQwa9aBRhH142onSmAGjXp
// SIG // 1bpfKLHBZLB5mdOvQ74V3Ff2emHvXDljBmVLwtHtPv3c
// SIG // sLqce36/LkKmk02cXpd4Z1pfnwRh1gbzBd9op/o8JuqH
// SIG // 5cGtyI2BRRchUaNaxvbT8nKEM4eexaqV74ygUYTqFa2a
// SIG // NftDRON17fAhQWHdsMwIDZL+7NFOIKRP/zp8l6aOICi+
// SIG // PySeUxEhUDTymsWmiekYhcEIog4Be+/jCz25tXc8elDY
// SIG // HW9UNi19fhSbOyrZM4ZUWMGdFp6Eu63zAyTvKHbFwhPG
// SIG // GYL4LYmKndUCYrJTjPWH46z0vW6ZEf0l8G2CHL/8Tn/f
// SIG // io4gTdaDfdQGoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjA1NFowIwYJKoZI
// SIG // hvcNAQkEMRYEFBNb4n74zegZ06yc5LsedxPLdrv7MA0G
// SIG // CSqGSIb3DQEBAQUABIIBABNB4NxJ+QoXYEa5Fey2D+kt
// SIG // SPKcHFkDZDN5twDuPrzxySmkxH/e6sML/jPbMrf/oLy8
// SIG // w4NYNrTRQNcfugYJa6JN1S64ELWa9ibw1eMQCu0NS078
// SIG // 9naSbaQ0ivsIJ0prSvTLZn/XztCGa4adfop/5hJhOk+X
// SIG // p/l4nnipcFrnO3HwqoBQxls+CfVUMW91EXQUTcpsbSFZ
// SIG // fm6edhAUR2qBxyzdlQ5IygHzHzWmROV/Enrkwunyq3Xf
// SIG // bARGJj4mWEvCgarqIUaEZSDbTwK3NHX7oJCznKodGQ8l
// SIG // ELJVYxdK/2I5qlF6m15eZv8qZffMwS2JG6u787iCUqbZ
// SIG // QcMFjsRXOAc=
