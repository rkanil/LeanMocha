...
ObjectUtils.inherit(ApplicationDescription,DescriptionBase,{
     ...
     * @param {bool} [packaged] When provided, this method acts as a setter and sets the packaged value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored packaged value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
    packaged: function(packaged){
...
ObjectUtils.inherit(ApplicationTO,TestObjectBase, {
     ...
     */
    identifier: function() {
        return this._getROProperty("identifier", arguments);
    },
     ...
     */
    version: function() {
        return this._getROProperty("version", arguments);
    },
     ...
     */
    launch: function() {
        return this._executeWithEvents(arguments,"Launch", InstallBehavior.doNotInstall, RestartBehavior.doNotRestart);
    },
     ...
     */
    restart: function() {
        return this._executeWithEvents(arguments,"Launch", InstallBehavior.doNotInstall, RestartBehavior.restart);
    },
     ...
     */
    install: function() {
        return this._executeWithEvents(arguments,"Launch", InstallBehavior.install);
    }
});
...
// SIG // qeSP8b02L0YRbfiSY6iAXceqOaTX2sjvk84ff4LV4Qmg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAr
// SIG // /Qj9Y8OlbKei7NrdNGyFveOMXTvxtIxH5z5LuAwhNDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBYyvoHF/BQeLhc1wpodzPG
// SIG // brjmuF3D6EIA25H7gRG3zYkOExkarfAd2S+6KDy/5PHY
// SIG // 0gsCy/GE+HmMDx6Awu+17LH4GB9ER7rZmmUateHRP4qf
// SIG // qAyysp3yEkyR7sQ3OwluQcSbU4tYaryCL+Zbp0gSeMSP
// SIG // p83Ln3bFeQnoilBGiy5+7Vy4/4DJY6W1Npymhto7zCr9
// SIG // 7lk3O0kgg45WrslkeJpW5E17+UI6RjKn4vZkNkNdofjL
// SIG // WCgJVgprTUBNv9THpFkgS1pQaaPASb+Mo+fSrYh4Xgec
// SIG // 9+6+PpM4IGrjkhtRqqJJxlDIF1SvXrBan73LgxuQAJ4L
// SIG // fPnqD0x34aJioYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // hvcNAQkEMRYEFO3RPvpIC16JZPgMIPtR5qg1moW0MA0G
// SIG // CSqGSIb3DQEBAQUABIIBABjljfG0kWcKNPqpiAKc1yxi
// SIG // fBUSOO0ESz3es22n98cX9Ign8Sj6qnQXDJbNUATlQYfR
// SIG // xTEWT9sOe/bF4RkuvDMExRYBkg9JKjikZCzDTkT4JkwR
// SIG // g3xx1wVwz8ky8Dte9x09SWVlyYVf7VQbccECiQTv8FyY
// SIG // L6tPg8JL1NiOpPIotZulc67ZkqvX22cFRXIuYamd2pDr
// SIG // Mv6BStBsjrjyc2LyLQL5574kgwEBPiFieWK4+N7fR546
// SIG // V+EYSec9DEbpsQDAQCUWhorraSoopGXN+WV+K9HMXZkY
// SIG // /zXksQWwHZ7GaXqXCgbelMgWUhCRxqqOQ5X8FePTVrXH
// SIG // Buna2CIDc+Q=
