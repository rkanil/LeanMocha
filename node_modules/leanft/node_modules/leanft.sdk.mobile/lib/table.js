 ...
 * @mixes Mobile.ScrollableTOBehavior
 * @mixes Mobile.TableTOBehavior
 */
function TableTO(session, description) {
    var tableTO = new UiObjectBase("MobileList", session, description);

    ObjUtils.extend(tableTO, Behaviors.ScrollableTOBehavior);
    ObjUtils.extend(tableTO, TableTOBehavior);
...
var TableTOBehavior = {
     ...
     * @returns {Promise<void>} fulfilled after scrolling to the specified item in the table.
     */
    scroll: function(item){
        return this._executeWithEvents(arguments, "Scroll", Convert.toNumber(item));
    },
    /**
     ...
     * @param {number} item The numeric index of the item to scroll to.
     * @returns {Promise<void>} fulfilled after scrolling to the specified item in the specified section of the table.
     */
    scrollBySection: function(section, item){
        return this._executeWithEvents(arguments, "Scroll", Convert.toNumber(item), Convert.toNumber(section));
    },
    /**
     * Selects an item in the table.
     * @param {number} item The numeric index of the item to select.
     * @returns {Promise<void>} fulfilled after selecting the specified item in the table.
     */
    select: function(item){
        return this._executeWithEvents(arguments, "Select", Convert.toNumber(item));
    },
    /**
     * Selects an item in a section of the table.
     * @param section The numeric index of the section containing the item to select.
     * @param {number} item The numeric index of the item to select.
     * @returns {Promise<void>} fulfilled after selecting the specified item in the specified section of the table.
     */
    selectBySection: function(section, item){
        return this._executeWithEvents(arguments, "Select", Convert.toNumber(item), Convert.toNumber(section));
    },
    /**
     ...
     * @returns {Promise<void>} fulfilled after the item is inserted.
     */
    insert: function(item){
        return this._executeWithEvents(arguments, "Insert", Convert.toNumber(item));
    },
    /**
     ...
     * @returns {Promise<void>} fulfilled after inserting the specified item into the specified section of the table.
     */
    insertBySection: function(section, item){
        return this._executeWithEvents(arguments, "Insert", Convert.toNumber(item), Convert.toNumber(section));
    },
    /**
     * Deletes a specified item from the table (iOS only).
     * @param {number} item The numeric index of the item to delete.
     * @returns {Promise<void>} fulfilled after the item is deleted.
     */
    remove: function(item){
        return this._executeWithEvents(arguments, "Delete", Convert.toNumber(item));
    },
    /**
     ...
     * @param {number} item The numeric index of the item to delete.
     * @returns {Promise<void>} fulfilled after deleting the specified item from the specified section of the table.
     */
    removeBySection: function(section, item){
        return this._executeWithEvents(arguments, "Delete", Convert.toNumber(item), Convert.toNumber(section));
    },
    /**
     ...
     * @returns {Promise<void>} fulfilled after the item has moved.
     */
    moveItem: function(srcItem, destItem){
        return this._executeWithEvents(arguments, "MoveItem", Convert.toNumber(srcItem), Convert.toNumber(destItem));
    },
    /**
     * Moves an item or section in the table (iOS only).
     ...
     * @param {number} destItem The numeric index of the new location for the item.
     * @returns {Promise<void>} fulfilled after the item or section has moved.
     */
    moveItemBySection: function(srcSection, srcItem, destSection, destItem){
        return this._executeWithEvents(arguments, "MoveItem", Convert.toNumber(srcItem), Convert.toNumber(destItem), Convert.toNumber(srcSection), Convert.toNumber(destSection));
    }
};
...
// SIG // XprnowsyC2G9+60WDnu6ljfIepbDHbPbu/L/mlm5Wsag
...
// SIG // pZ/hL/V5WSX7cDfIDjmM3QSDLAfj/19I3NgbjnfZfzAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBUaHrZUJmWOHZoJPAcayFI
// SIG // sHKxCx77yntXvXLnyCe4WnAyyNTpZbGYrCb8tEEBL0HY
// SIG // aKguXC4v86b/GMV3w3W4TI/DaFwJrSq9M8Jfbjg3Bmlg
// SIG // FodF8ceWIr2yIzqQ3aXiB1bjDtYVm7yYINMDfrcBo6yZ
// SIG // OWqde6cYTtmfUJzA/P/Dv82RvFY1zyz/D8YeEb3+a2xA
// SIG // IgUieMkv4Vo+6MBLjxYluODiZBC8YRriV2RLxtBCtzdK
// SIG // 9uUEV6dAmDABEWQ3qKKK98RcIGBHn+gEJh3A1mCU2Tij
// SIG // 6gS+WQKQ0jqoWX9V2TwZnN9AB6E6cEqC9ofHvVU/apod
// SIG // 3V2LVz1jLj+1oYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjAxNFowIwYJKoZI
// SIG // hvcNAQkEMRYEFF9U10TZRLjyNkHNaL3+RAlJuZEwMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAAmmsIChDXefqKl9iqGaflsP
// SIG // SdtOd81PDbDDb4vjMaSBMWD8UaptE5ZNmMszpnEBZxp1
// SIG // f7olnWAKVTkcta53gqtiTxb/g1Gd+CBqDU1xoYyd0nE5
// SIG // b000k8689PgRm9OYR7Hb5kGJS6TtbJRn4yr1XmE8PGDT
// SIG // 5YgTLnd+5DIua1tXrD+Zy7zM1q59lkW5MPq2cdhjyERx
// SIG // I6ADYNWhy03um0k7BgvMFuJKrNEkaNyM1yUN5DTuIq/m
// SIG // +z+3IAfTBDMFv1oq4ZrT3UG2LmQT4KnW7QUujp1OdLey
// SIG // qdU4VNoB5BE0XvfL1PRYtfBvi3CPWvORsCb2ArN8Goj3
// SIG // /iEzUorm0Vw=
