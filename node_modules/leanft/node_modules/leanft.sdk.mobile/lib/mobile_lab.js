 ...
 * @property {string} id The device ID used by Mobile Center.
 ...
 * @property {string} osVersion The operating system version currently running on the device.
 * @property {string} name The logical name that Mobile Center uses to identify the device.
 * @memberof Mobile
 *
 */
 ...
 * @property {string} username The Mobile Center username used to log in.
 * @property {string} address The Mobile Center server address.
 * @memberof Mobile
 */
...
/**
 * The Mobile Center lab, where you manage users, applications, and devices.
 * @memberof Mobile
 * @constructor Lab
 */
function MobileLab(session) {
...
MobileLab.prototype = {
    ...
    /**
     * Obtains a device from the Mobile Center lab and locks it, so that only LeanFT can perform actions on it.
     ...
     * @memberof Mobile.Lab#
     */
    lockDevice: function(description) {
        var func = function() {
            description = description || Device();
            var deviceDesc = description instanceof DeviceDescription ? description : Device(description);

            var launchData = {
                "type": "Device",
                "launch info": deviceDesc._properties
            };
            ...
            return this._session._communication.send("LaunchApplication", launchData).then(function (launchResult) {
                    ...
                    return new DeviceTO(launchResult["AUT cookie"], this._session);
                }.bind(this),
    ...
    /**
     * Obtains a device from the Mobile Center lab by deviceID and locks it, so that only LeanFT can perform actions on it.
     * @param {string} deviceID The device ID used by Mobile Center.
     * @returns {Promise<Mobile.DeviceTO>} a promise that is fulfilled with the locked device.
     * @memberof Mobile.Lab#
     */
    ...
    /**
     * Obtains a device from the Mobile Center lab by device name and locks it, so that only LeanFT can perform actions on it.
     * @param {string} deviceName The logical name that Mobile Center uses to identify the device.
     * @returns {Promise<Mobile.DeviceTO>} a promise that is fulfilled with the locked device.
     * @memberof Mobile.Lab#
     */
    ...
    /*jshint eqnull:true */
    /**
     * Obtains a device from the Mobile Center lab by device information and locks it, so that only LeanFT can perform actions on it. <br/>
    ...
    /**
     * Returns a list of all devices with open viewer.
     * @returns {Promise<Mobile.DeviceTO>} a promise that is fulfilled with the list of all devices with open viewer.
     * @memberof Mobile.Lab#
     */
    getDevicesWithOpenViewers: function() {
            return this._session._communication.send("GetDevicesWithOpenViewer", null).then(function (result) {
                    ...
                    return result.Result.map(function (deviceInfo) {
                        return new DeviceTO(deviceInfo.ServerCookie, this._session);
                    }, this);
                }.bind(this),
                this.handleReplayError.bind(this));
    },
    ...
    /**
     * Returns an array of device information describing all the devices in the Mobile Center lab.
     * The device information can be passed to the lockDeviceByInfo function, in order to lock the appropriate device.
     * @returns {Promise<Mobile.DeviceInfo[]>} a promise that is fulfilled with an array of device information describing all the devices in the Mobile Center lab.
     * @memberof Mobile.Lab#
     */
     ...
     * @returns {Promise<Mobile.MobileCenterConfiguration>} a promise that is fulfilled with the Mobile Center connection configuration.
     * @memberof Mobile.Lab#
     */
    getConfig: function() {
...
// SIG // HvDTxyGEpaOGx4+W5v1mPkNOExNY5be5fALVaAFkw5Cg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAh
// SIG // RNxbYcHSe3LeXk7Czt7qrTXyf1n2L9NOHG5NvqPsDDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQCS0uMhFAkMjt6bwrYCaIBl
// SIG // XcKQD2KBKr9zzM116/BYIaafDbtCrzyldHV+Xcgxz0gO
// SIG // Ptxs18fjGGOgLHTD94bIsuL7q+63r+PAovIRxw1c1kBQ
// SIG // LlNa/PRussEhMHakYYGmEbv7iCk13s0esxW1jrto+cad
// SIG // 0dg2t0C8/ieRZuw31tIxDLpsZuHWN4wrSXfmA9EP+KQ0
// SIG // oHM66/tE+tTojHnkOC+uTlrfnbTGa21v6RKjKUPV6NT+
// SIG // qLHyq9lWEW4pRFsNkRyPdfoUZOrvXNjJRr161lZt9sTx
// SIG // 9wHqF1cffUy+I/gp5/Ui6wBFXpPjnf3rGE3lU320X/Jh
// SIG // Cne22M3mqJ0xoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTg0MlowIwYJKoZI
// SIG // hvcNAQkEMRYEFCDNdQ6sy79Fp0FonjkKyIcgN0PKMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAC7dVCrD3UCFhSPyf/CvtsMw
// SIG // hwY035WqjgqaYIDyktluob2bMIBuCE8+pAYPuxYx7kAM
// SIG // THU6l+kvBmPQCQL4XSOuovob4HTMxbBE+JlqDTWLks5B
// SIG // GgPoFHEKaUoXh/l1fzlCfVRn2qH/y6IhvzgNZ377Rda9
// SIG // 6U2QHXGfJECP4roN7d900kZ3NmuQl5uRtTqYE8VZMyo2
// SIG // 4J27RxvGMNQMqa1OmnBw+O/1cH3kmAqewSrVvIjX58b3
// SIG // gwGEGYIneaWJfx5HqpfW1V/YA93DfSk3yvL+bmCcSzdE
// SIG // vsVXPwI9V+s4M++jO0ihrKSyFLsqJwdKtCXUDg7KoSG3
// SIG // ntxfqfIECWk=
