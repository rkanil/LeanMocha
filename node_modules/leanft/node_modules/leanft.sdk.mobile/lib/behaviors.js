...
var CheckedDescriptionBehavior = {
     ...
     * @param {bool} [state] When provided, this method acts as a setter and sets the isCheckable value.
     * @returns {bool | Description} If no parameter is provided, the method acts as a getter and returns the current stored isCheckable value; 
     ...
     * @param {bool} [state] When provided, this method acts as a setter and sets the isChecked value.
...
var CheckedTOBehavior = {
    /**
     * Indicates whether the mobile object can be checked.
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the mobile object can be checked.
     */
    isCheckable: function(){
        return this._getROProperty("isCheckable", arguments);
    },
    /**
     * Indicates whether the mobile object is checked. (Relevant for objects that can have a check mark.)
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether the mobile object is checked. (Relevant for objects that can have a check mark.)
     */
    isChecked: function(){
        return this._getROProperty("isChecked", arguments);
    }
};
...
var TextDescriptionBehavior = {
     ...
     */
    text: function(text){
        return this._propertyHandler("text", text, Convert.toString);
    }
};
...
var ScrollableTOBehavior = {
    ...
    scrollToOffset: function(x, y){
        return this._executeWithEvents(arguments, "ScrollToOffset", Convert.toNumber(x), Convert.toNumber(y));
    },
    /*jshint eqnull:true */
    /**
     ...
     */
    scrollOnePage: function(pageDirection){
        if(pageDirection == null)
            throw new Error("You must pass pageDirection to scrollOnePage() method");

        return this._executeWithEvents(arguments, "ScrollOnePage", ScrollDirection._convert(pageDirection));
    }
};
...
// SIG // wEfL0AwXKYkAixgQOa8IsqjxCqsWYUStxF9N1h79D6Kg
...
// SIG // YxyWh83932YUpPCYJxsVDLMcpxV8aGb9G11R73mJ8DAN
// SIG // BgkqhkiG9w0BAQEFAASCAQB68VVfhhxKWTvTPrCV/2RK
// SIG // hQaCaGXPUrR+C1Mx0Im1mQ/oLMUqMCR8gsLAWP2erOf3
// SIG // iLSuDTDVYdeLuSJrpd1LIer4eAiunZ/9qMEhea7W/QlV
// SIG // llW0QvmV1tLuSpUb9Nd19xk+H4m8KvGq+LJ45gsFOXs2
// SIG // dGM71l9zOiM0KoecQgaO6vML+l1+S6EPqmTZ5+kZ2T0A
// SIG // oFfhN4ALyRzpSM0/dzbbXRzBXYjMi7UsPfmQZCXdojrc
// SIG // IC8io2UTPH3kcRcxFRTAhLv7Z3wJ5RDqRnghfcBNgVD/
// SIG // iZhZWtxRkv/+lJyLu4b5l2AkNrmVcM2iS60qdGHLJlHC
// SIG // gOdrtTxHctftoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjAzNVowIwYJKoZI
// SIG // hvcNAQkEMRYEFC7U9dWFrfv9kz9JjCR7J7hmsLuJMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAB6pI5AaRbApLbZryXuvYZWR
// SIG // T7wgVi4SacctrPOm7XdOYIQqNlft36E9VPHdq0vy+Nzz
// SIG // 2sLi9iqKom2kQQzd05NMLIhu91tHlNMnXicLWwS62Mp7
// SIG // NxTS2kD6BYIq0dTh/YMsA/ycIMqpFPKRJipbBEI/fefg
// SIG // +QAUD6AGCPQl07VBVNtUAmXK5bp3cNDuT7nrFSQbtwH/
// SIG // Tu7ikf0KZToPAiyMRWKgXe0zSgs8KL2GljPqvmTIJpJl
// SIG // ZyQwor1V+rwcMKUtEv9x8craj8+g1azSnU2FM28/cLCm
// SIG // oAzOBKidL0wNEczH6As5z3p/DATZ0IdPgI7+qGqkw0mp
// SIG // 0cCVQj/gzs4=
