 ...
 * @mixes Mobile.ViewTOBehavior
 */
function ViewTO(session, description) {
    var viewTO = new UiObjectBase("MobileView", session, description);

    ObjUtils.extend(viewTO, Behaviors.ScrollableTOBehavior);
    ObjUtils.extend(viewTO, ViewTOBehavior);
...
var ViewTOBehavior = {
     ...
     * @returns {Promise<void>} fulfilled after the zoom occurred.
     */
    zoom: function(focalPoint, scale){
        if(focalPoint == null || scale == null)
            throw new Error("You must pass focalPoint and scale to zoom() method");

        return this._executeWithEvents(arguments, "Zoom", Location(focalPoint), Convert.toNumber(scale));
    }
};
...
// SIG // iLdpOlwzTL49YC3gQ1Z7H99smfDpF+gIGdRzumTtRsqg
...
// SIG // rv0GgI+cdRrBYsUFkSiDcO0UU4de0E35XD9G1THb9zAN
// SIG // BgkqhkiG9w0BAQEFAASCAQB11HBz4b97A9tAZnUQ69Zh
// SIG // efstBH2Y0DhCIqqL4uUn/8N+TUZoxWveEvIzaV3CmmOF
// SIG // SH0Uj+yK8aigp5FVXFeJnTHlASjIt9yFkiQ/11cumH/Z
// SIG // lytm0OeNuTrswYbn3/NdrGw9OGcHV/yNZCA/fb3Nsi+/
// SIG // hx0uUbqm5u5mvn4OcuY5Cg82DvFMCToCfDugu86zBNEP
// SIG // UcJUzuP+RDgJMky9c7THLTQq41FPKgq0HB6FH8ALGfhs
// SIG // ummSs44kLG3ArG+m9k4IvaVbdq69//DeBxTdL1TmE+Z2
// SIG // uhb1zg/466nTWrVUxFDMd9YcBMa8Gxmp1O8Tq9bScf8Q
// SIG // S8mbj2RrNZpIoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTkwMFowIwYJKoZI
// SIG // hvcNAQkEMRYEFF/A0fhMR/b7ayGGU8BNFcMsrUi4MA0G
// SIG // CSqGSIb3DQEBAQUABIIBACDizkihv5j0dcymHlu++ae5
// SIG // 4r8Kn0m44PhZ6J0qfwIj/5iyhAalis0od+kAfIwbEE2D
// SIG // t2idlzxq6X9lAe4yaOc7aw2ysPG5+Fa0DLgo+LAIhoo/
// SIG // phV+mzJiafwxwp4KcoaNRLCEk+zhptQJSB8nqUc66SQs
// SIG // 38IXrqtKbREDU4JTD1/zXfLk8Z59BQKF/KhrNUi6gE0H
// SIG // dXJUOBYFSM/HdFi+zR8jD7JyzK8wOJTVHP4HwY6dfqEV
// SIG // OnrC+XxxBTR3+ydFhiYYfcpZ1JcT+AXZhxG2QKGMb1U2
// SIG // FA0y9Ga+AW8rDs7FWt1iFI44xqa2DcDC35YqVzBZhD3F
// SIG // gBpIo85Mujc=
