...
var EditDescriptionBehavior = {
     ...
     */
    hint: function(hint){
        return this._propertyHandler("hint", hint, Convert.toString);
    }
};
 ...
 * @mixes Mobile.TextTOBehavior
 * @mixes Mobile.SetFocusTOBehavior
 * @mixes Mobile.EditFieldTOBehavior
 */
function EditFieldTO(session, description) {
    var editFieldTO = new UiObjectBase("MobileEdit", session, description);

    ObjUtils.extend(editFieldTO, Behaviors.TextTOBehavior);
    ObjUtils.extend(editFieldTO, Behaviors.SetFocusTOBehavior);
    ObjUtils.extend(editFieldTO, EditFieldTOBehavior);
...
var EditFieldTOBehavior = {
     ...
     */
    hint: function(){
        return this._getROProperty("hint", arguments);
    },

    /**
     * Indicates whether this mobile edit object is a password box (Android only).
     * @returns {Promise<bool>} a promise that is fulfilled with an indication of whether this mobile edit object is a password box (Android only).
     */
    isPassword: function(){
        return this._getROProperty("isPassword", arguments);
    },
    ...
    setText: function(text){
        ...
        return this._executeWithEvents(arguments, "Set", Convert.toString(text));
    },
    ...
    setSecure: function(encodedText){
        ...
        return this._executeWithEvents(arguments, "SetSecure", Convert.toString(encodedText));
    }
...
// SIG // s4YPNI/bJ16LLBpT4XwRBKqJbbezCK2SAGqhgppQ3hqg
...
// SIG // DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDR
// SIG // 9xDmm150HzWKPXORZ+RRFT5qqijnPAHDiTQZhLkijDAN
// SIG // BgkqhkiG9w0BAQEFAASCAQA5p7V/3ePJigfYGdsuyonm
// SIG // BPgjg8bb6s1QSFs9t/lgJY/pzcGzaohpIRangIwirgQt
// SIG // pcuxnMK10orwSgrjeYmFfy/T0X6+sa/9kphQT/Rfaun8
// SIG // 7pSJEGkrs7KUGl7C1cWDqDfIKEKtMIVdXQl7iin9H9bG
// SIG // Cn0/ueT+pU6eqc+MxdvCZY07uqj6qsmC8XtBqpNhfZls
// SIG // pxFxWa2AML3rmH7Hn5aOizERpatFVdNqXTRqwP8A0InQ
// SIG // +JK9JUMmSd0yLY3m2ffYYanpB/S9nf5tP+mXhCq7oiwi
// SIG // XZugwTgMD31xbSebOJ7J2aanqxSi8ENLZ+2tSO4u+OSd
// SIG // kKfd1boKBCVtoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTY0MVowIwYJKoZI
// SIG // hvcNAQkEMRYEFNVkdGexNW9HVJjpRmch+iOHtsQMMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAHxmqJqLkxQQ19UrnhCARpYP
// SIG // 7mY6J5qRmYVrP8EuOYXESCWnUg6q8kmMLFxrNFLW82bv
// SIG // 4JCp/OW2B54G1Tb985yMDS9gAkJRSt0mhRZG2uRei9dF
// SIG // mYbw8eI0rbFCgE7bLkrxfQ453HrSpd7zEM82bM/2XgcT
// SIG // lQgoNxVOIWlheicCjfjxn8g7Kihf7WRaBfexVarI5GnE
// SIG // pdq4v1j07qzn7Tbh/R8zFN5gxbapHMzNc6AepFa8Ah3l
// SIG // ddnh7pUrRT5DqIpK+5N0IoG+g0QaLXMVFaSfeSLAvTuD
// SIG // L6ctIHm7jzkyF7u02jC7VUUR1vgLljzqKfD9HGZt3flm
// SIG // 4HMm1iBQ/+s=
