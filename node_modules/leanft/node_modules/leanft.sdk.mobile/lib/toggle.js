 ...
 * @mixes Mobile.CheckedTOBehavior
 * @mixes Mobile.ToggleTOBehavior
 */
function ToggleTO(session, description) {
    var toggleTO = new UiObjectBase("MobileToggle", session, description);

    ObjUtils.extend(toggleTO, Behaviors.CheckedTOBehavior);
    ObjUtils.extend(toggleTO, ToggleTOBehavior);
...
var ToggleTOBehavior = {
     ...
     * @param {bool} state Indicates whether this toggle will be checked.
     * @returns {Promise<void>} fulfilled after the toggle operation has occurred.
     */
    set: function(state){
        if(state == null)
    ...
    setByName: function(name){
        ...
        return this._executeWithEvents(arguments, "Set", Convert.toString(name));
    }
};
...
// SIG // pJTA+y69FGouyyGb4ZtaoCQEgsvotOqS0c4n3PA4nhWg
...
// SIG // XM3e6DHHfAI+v7ZnuNvwUAFLiQSPnuCM31ws+PGJbTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBMxW7QpvKV3k4+c6tFlh4V
// SIG // B60PQ9MFY4RRgHeEIfMgonhaqgCjp78PW1NS9h5ooD44
// SIG // uus3SmgCF2g59C0anWlzjMMbd+PjK65aU7bK03YqKagT
// SIG // FZkvrmc4xfXMxb/7hMxbE8N2bIR77fT+kAcNGYUPi1fr
// SIG // 7kvvOjooej0lvCuFGmzYm4mgCFtcMJfTDb3OgEZyIEae
// SIG // pfN1LHDwPWIyNAsPGhH4h0MlEHLVVCP/sHiXO/Hxd3XM
// SIG // hfSJwUepVh6niQs25wzmMEHHtnT/xpulyFMfar1ZGLLE
// SIG // +epttN9auv+27QhW8Im6A7kf64XaMKlSr9CCMZnbXO9Q
// SIG // b+/VLrKJ7QBroYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MjI0NlowIwYJKoZI
// SIG // hvcNAQkEMRYEFC3TrllwjUcpLJpVNULIqbFUCQGzMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAAC2LELuVJMFCnvVtryiMwnV
// SIG // pS3Swe71/HA01zN1jbGW7deS3GlSWJky00itMN8XcPDd
// SIG // WKCyz6Gkww7YvG5MMznw/GVwuRLf6r1kPGeI8NR44X2x
// SIG // Bbb1Z96texgts5uLytmyXgkZKA8J41i9g8Qt7j7uI24T
// SIG // eZBStQbHyn9LujUD6xWRljL8hVjgoqU0w0Xdm2g0Vw5x
// SIG // sRUsU5XwiAwq+7Yb3oBE5A81Od6WT0D4DJB8Ux8XAtIa
// SIG // /aloGmFu1W6yapZxdKwYeTEGXPq5FDB9PQcfpBepZmbA
// SIG // OFau73V3jSKZaiUqH67L/PI3oF3vaY8R4BYDt9v0LYlA
// SIG // P00Ii0yfNOQ=
