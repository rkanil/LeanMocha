...
describe("Application Test Object unit tests", function() {
    ...
    describe("unsupported methods", function() {
        it("should not support snapshot",function() {
            assert.strictEqual(appUnderTest.snapshot, undefined);
        });

        it("should not support exists",function() {
            assert.strictEqual(appUnderTest.exists, undefined);
        });

        it("should not support highlight",function() {
            assert.strictEqual(appUnderTest.highlight, undefined);
        });
    });
});
...
// SIG // jAvhQladTQ0AtPwbMkIqRTGcFcUjo0zSXQ9u995k3Oqg
...
// SIG // t5zbWebtT34MlR4ZkwHoax0iPnPk8lr8YyRMLaxG0zAN
// SIG // BgkqhkiG9w0BAQEFAASCAQBjGYqVzhhHrr84D1GX8POQ
// SIG // /IbP5+eViYSgpxB7q0oMdkG/BiQqLfWdFKZ53IbvGiwr
// SIG // wSIqslLYybQEj7hL2doQxwFXzudAd0Dgb4FiMjVXGEjt
// SIG // NaajDxyHPhFZ6qi9VTxxGiBV877+D4pywzGnpyYUGSzU
// SIG // DDftTpnZr1cJtkxu9p8aPbYWt87iTymJ8D78sxFQOUYo
// SIG // x+hUfHWx+D+p4f1lr/dKURpy3OFyIyVL+Gph0IJd7DTf
// SIG // XPJVznBMCZu8bKL7mNh1+XWwF0GzKZFaiySuDUlbetF9
// SIG // 5KmQjgDsTPkAS6eCB/hw4SXHHeUqpDrrJzEvWbXximcC
// SIG // M70aLLFePYnCoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgw
...
// SIG // KoZIhvcNAQkFMQ8XDTE2MDUyNjE0MTUxMFowIwYJKoZI
// SIG // hvcNAQkEMRYEFJ3Ocobsxyzf1fOSxNtvNuW0dFfLMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAERyKnpQV4ENQKgh5LnxBwt8
// SIG // X8akk2S8bqclIX/eUnlTS/75Vl1onDQJPU1lT/RKA/lL
// SIG // O795VgAGhoj8dIPrlPxOAIPPyVA8L0+Lk0Uh9er9qBPq
// SIG // ySQITWV8upxMwi61DO737xzX4RhYN4ROCsPaRw1SCR74
// SIG // SIryxwKjB/mmNInT67sEnXtzKV7V//KgTf48Sw/+4wJ+
// SIG // ccLVVD5s35l9BzRkzFR4IBmQr/epLCvJnZVaiT8l3asS
// SIG // hTpmT/8sYQPr6PrqQEcF3JbVMpVb0QKl+CJ7CPbrJm73
// SIG // bbln12z3HJA6mzxSg3Y3sbj5Meq8acvmQJQ9qr+6FLrd
// SIG // aEgvvmOeQtU=
