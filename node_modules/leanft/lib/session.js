...
Session.prototype = {
    ...
    init: function (config){
        ...
        this._communication = new CommunicationClient(config.address, this._promiseManager);
    ...
    _buildConfig: function(config){
        ...
        if(config) { //configuration was set in code
            return ObjectUtils.extend(defaultConfig, config);
        }
        ...
        //if path is given, load the file
        if(configFilePath) {
            var configFile = nconf.file(configFilePath);
            config = ObjectUtils.extend(config, {
                address: configFile.get('address'),
                mode: configFile.get('mode')
            });
        }

        //see if lft_address CMD arg was set
        var cmdAddress = nconf.argv().get("lft_address");

        //if address was set, override the address loaded from the config.
        if(cmdAddress) {
            config.address = cmdAddress;
        }
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFLhl6nqFxP+G
// SIG // rPTL5RNytln4NVQDoIIYtjCCA+4wggNXoAMCAQICEH6T
...
// SIG // DQEJBDEWBBRz6owJDK64YNmiIP4YyR4FFg+mdDANBgkq
// SIG // hkiG9w0BAQEFAASCAQAcFpt44LXMRseRRB87554+wF2Y
// SIG // J1EsbYssrU4o7QYPMvwQdns9ybv+yUiY5dir2MIBCEzW
// SIG // WcMNt+m+srELfxTxVjxBmwH4l3BwjNZid3/YcGrYxW9m
// SIG // DIhYZHSSN2v+im/1+83nUJj0k4o5DLP0EzfuPMhsRoQo
// SIG // lYO0eoqfH3Vp6iaRfDBn5GDWxpqpgCk2bWKEIHKUeL2R
// SIG // RvhfPiXD2v4ce2srNJyhr770LbtwYLLixXsR0EG9b4YR
// SIG // 4QVSqbOHEm4SWDTHjTZ9Vqdhwf5IbtpxCcnwIaVJ5BM/
// SIG // tfheBm57Ymz9zXQMdf+NfqAcwU9NQpDjl9UviPvQ7DiT
// SIG // Vvj9qR7qoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0
...
// SIG // hvcNAQkFMQ8XDTE2MDUyMDIyMjgwMlowIwYJKoZIhvcN
// SIG // AQkEMRYEFAoZ7JYuXee6HbwZgdpn9UW5oiOaMA0GCSqG
// SIG // SIb3DQEBAQUABIIBAI2QJzt7BKTlvkgaUthWQ3+5MPUJ
// SIG // qAJwaBBn9xGlwmV3ku7lLGrnue6cuNfQey+P5mhtZD0o
// SIG // gFmGAfm/9XuVlZxSsnAFSafFxA+TqQWnTbPgypE2aRRp
// SIG // Tz2Rv773X8sLAgOqHvK046s10kmd8M9h8P85HqGSNi17
// SIG // /Yw/tbVwwen4ODBtIBXEkd6fSypwqWZazaa7u5LFWzXB
// SIG // 0lJpXApekG5RxAuCM2yCmlxah0GgDI/VoHW9H2Sae9L7
// SIG // LiUgqJ2VbNtU2LJePizkkT67G3Hv+oNrrDeRrQxP3Y93
// SIG // BURuNxzEOjBOoRvrMvHFl/KYL+5c67IBPuna0y3MYd9z
// SIG // MCpFCSg=
