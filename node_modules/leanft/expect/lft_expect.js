...
ExpectWrapper.prototype = {
    ...
    _execute : function(funcName, args, exp) {
        var argumentsForReport = [exp.value].concat(args[0]);
        try {
            if(this._hasNot) {
            ...
            if (reporter){
                reporter._reportExpectEvent(funcName, this._hasNot, argumentsForReport, this._shouldThrow);
            }
            return true;
        } catch(e) {
            this._logger.info(e);
            ...
            if (reporter){
                reporter._reportExpectEvent(funcName, this._hasNot, argumentsForReport, this._shouldThrow, e);
            }
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFGkCQ/EohaAV
// SIG // tThJT6AzsCeVthKpoIIYtjCCA+4wggNXoAMCAQICEH6T
...
// SIG // DQEJBDEWBBS/F7ygWehHI1gUn/3eKKMdDI5MbDANBgkq
// SIG // hkiG9w0BAQEFAASCAQCwg2P+9jPEU0IlRvLFhqU5DArG
// SIG // EEK3C8j2Xw5Az+G9LkuieLWGXC+hjqH2GeFFNzXGBxGK
// SIG // qqd5faaBxq6V+4x6Gakr1lN34UzysNk6GIpJnD8PpoYC
// SIG // FddI1TtSQG3pkoIPtZWCY0GtKOSdc9mUuvVIjBvMWoC8
// SIG // 5fJcEpRO/2pC2uQq48Ue0Smo2z4fcft4HsmkCuVlz0px
// SIG // PrYP+7xXFUpWFRc4Ckq+JSIjfZpjSgGkrxcZ3nXFx/IH
// SIG // /0ehwBjxjfCH+A1z7N1QcDVWoIO5W92iJbCt2C+bHCSF
// SIG // C7geiVgQqHb1wV85HrMoqs+JKSyQHf0bXda1+WlR0kn5
// SIG // C0OKK2tmoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0
...
// SIG // hvcNAQkFMQ8XDTE2MDUyMDIyMjcwMFowIwYJKoZIhvcN
// SIG // AQkEMRYEFMREa21brCMaSKgA2ldx+UHwWmnJMA0GCSqG
// SIG // SIb3DQEBAQUABIIBADpY4R22fd4jeNyDzyeLkhS16R1P
// SIG // fKTGI5qMSKnru0/5Z5/BA4WxY3ZY8cq7+sL8ktt/uxZf
// SIG // ZO3poaqUDZNXf5xk3wJPDQSI1FzivlHAXdJSuklqWSPN
// SIG // Vbj9KW45S1as1rin7qeUD8if0IddwoS8gt0lxfepbKYJ
// SIG // b+YCvOsgFjLfZlcKtCBbYyVEgRE/U+J9jVrhXQkqWSFi
// SIG // hfhkCRk2ylQ+zPRDiujQ9OhAdAkIGE4l1pIPVJCH+y+h
// SIG // L7KtQETpuejbolss8dXULL9x3WNFyDskN/3eMwj2u0cG
// SIG // YyjwKJ5WIBfHGWxvFl8Ch/HdIgFP45IoxJU9fAl5H4GL
// SIG // BRRvmN8=
